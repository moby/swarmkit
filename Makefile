...
# the variable SWARMKIT_USE_CONTAINER, then we do all of the making inside of
# a container. We will default to using no container, to avoid breaking
# anyone's workflow
ifndef SWARMKIT_USE_CONTAINER
include direct.mk
else
