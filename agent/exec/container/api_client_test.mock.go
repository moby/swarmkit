...
// Source: github.com/docker/engine-api/client (interfaces: APIClient)
...
func (_m *MockAPIClient) ContainerStart(_param0 context.Context, _param1 string) error {
	ret := _m.ctrl.Call(_m, "ContainerStart", _param0, _param1)
	ret0, _ := ret[0].(error)
	return ret0
}

func (_mr *_MockAPIClientRecorder) ContainerStart(arg0, arg1 interface{}) *gomock.Call {
	return _mr.mock.ctrl.RecordCall(_mr.mock, "ContainerStart", arg0, arg1)
}
...
func (_m *MockAPIClient) ContainerStop(_param0 context.Context, _param1 string, _param2 int) error {
...
func (_m *MockAPIClient) ImageInspectWithRaw(_param0 context.Context, _param1 string, _param2 bool) (types.ImageInspect, []byte, error) {
	ret := _m.ctrl.Call(_m, "ImageInspectWithRaw", _param0, _param1, _param2)
...
func (_mr *_MockAPIClientRecorder) ImageInspectWithRaw(arg0, arg1, arg2 interface{}) *gomock.Call {
	return _mr.mock.ctrl.RecordCall(_mr.mock, "ImageInspectWithRaw", arg0, arg1, arg2)
}
...
func (_m *MockAPIClient) VolumeRemove(_param0 context.Context, _param1 string) error {
	ret := _m.ctrl.Call(_m, "VolumeRemove", _param0, _param1)
	ret0, _ := ret[0].(error)
	return ret0
}

func (_mr *_MockAPIClientRecorder) VolumeRemove(arg0, arg1 interface{}) *gomock.Call {
	return _mr.mock.ctrl.RecordCall(_mr.mock, "VolumeRemove", arg0, arg1)
}
