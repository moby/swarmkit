...
func extensionToGoStringApi(e map[int32]github_com_gogo_protobuf_proto.Extension) string {
	if e == nil {
		return "nil"
	}
...
func (m *RegisterNodeResponse) MarshalTo(data []byte) (int, error) {
	...
	if m.HeartbeatTtl != 0 {
		data[i] = 0x8
		i++
		i = encodeVarintApi(data, i, uint64(m.HeartbeatTtl))
	}
	return i, nil
}
...
func (m *GetJobResponse) MarshalTo(data []byte) (int, error) {
	...
	if m.Job != nil {
		data[i] = 0xa
		i++
		i = encodeVarintApi(data, i, uint64(m.Job.Size()))
...
func (m *RegisterNodeResponse) Size() (n int) {
	...
	_ = l
	if m.HeartbeatTtl != 0 {
		n += 1 + sovApi(uint64(m.HeartbeatTtl))
	}
	return n
}
