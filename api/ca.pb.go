...
func (*NodeCertificateStatusRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_ca_0135a18c181fdf00, []int{0}
}
...
func (dst *NodeCertificateStatusRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_NodeCertificateStatusRequest.Merge(dst, src)
}
...
func (*NodeCertificateStatusResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_ca_0135a18c181fdf00, []int{1}
}
...
func (dst *NodeCertificateStatusResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_NodeCertificateStatusResponse.Merge(dst, src)
}
...
func (*IssueNodeCertificateRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_ca_0135a18c181fdf00, []int{2}
}
...
func (dst *IssueNodeCertificateRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_IssueNodeCertificateRequest.Merge(dst, src)
}
...
func (*IssueNodeCertificateResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_ca_0135a18c181fdf00, []int{3}
}
...
func (dst *IssueNodeCertificateResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_IssueNodeCertificateResponse.Merge(dst, src)
}
...
func (*GetRootCACertificateRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_ca_0135a18c181fdf00, []int{4}
}
...
func (dst *GetRootCACertificateRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GetRootCACertificateRequest.Merge(dst, src)
}
...
func (*GetRootCACertificateResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_ca_0135a18c181fdf00, []int{5}
}
...
func (dst *GetRootCACertificateResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GetRootCACertificateResponse.Merge(dst, src)
}
...
func (*GetUnlockKeyRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_ca_0135a18c181fdf00, []int{6}
}
...
func (dst *GetUnlockKeyRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GetUnlockKeyRequest.Merge(dst, src)
}
...
func (*GetUnlockKeyResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_ca_0135a18c181fdf00, []int{7}
}
...
func (dst *GetUnlockKeyResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GetUnlockKeyResponse.Merge(dst, src)
}
...
func init() {
	proto.RegisterFile("github.com/docker/swarmkit/api/ca.proto", fileDescriptor_ca_0135a18c181fdf00)
}

var fileDescriptor_ca_0135a18c181fdf00 = []byte{
