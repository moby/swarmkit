...
type ListNodesRequest_Filters struct {
	...
	NodeLabels   map[string]string     `protobuf:"bytes,3,rep,name=node_labels,json=nodeLabels" json:"node_labels,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	EngineLabels map[string]string     `protobuf:"bytes,4,rep,name=engine_labels,json=engineLabels" json:"engine_labels,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	Memberships  []NodeSpec_Membership `protobuf:"varint,5,rep,packed,name=memberships,enum=docker.swarmkit.v1.NodeSpec_Membership" json:"memberships,omitempty"`
	Roles        []NodeRole            `protobuf:"varint,6,rep,packed,name=roles,enum=docker.swarmkit.v1.NodeRole" json:"roles,omitempty"`
...
func (m *ListNodesRequest_Filters) CopyFrom(src interface{}) {
	...
	*m = *o
	...
	if o.EngineLabels != nil {
		m.EngineLabels = make(map[string]string, len(o.EngineLabels))
		for k, v := range o.EngineLabels {
			m.EngineLabels[k] = v
		}
	}
...
func (m *ListNodesRequest_Filters) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.EngineLabels) > 0 {
		for k, _ := range m.EngineLabels {
			dAtA[i] = 0x22
			i++
			v := m.EngineLabels[k]
			mapSize := 1 + len(k) + sovControl(uint64(len(k))) + 1 + len(v) + sovControl(uint64(len(v)))
...
func (this *ListNodesRequest_Filters) String() string {
	...
	keysForEngineLabels := make([]string, 0, len(this.EngineLabels))
	for k, _ := range this.EngineLabels {
		keysForEngineLabels = append(keysForEngineLabels, k)
	}
	github_com_gogo_protobuf_sortkeys.Strings(keysForEngineLabels)
	mapStringForEngineLabels := "map[string]string{"
	for _, k := range keysForEngineLabels {
		mapStringForEngineLabels += fmt.Sprintf("%v: %v,", k, this.EngineLabels[k])
	}
	mapStringForEngineLabels += "}"
	s := strings.Join([]string{`&ListNodesRequest_Filters{`,
		...
		`EngineLabels:` + mapStringForEngineLabels + `,`,
...
func (m *ListNodesRequest_Filters) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field EngineLabels", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			mapkey := string(dAtA[iNdEx:postStringIndexmapkey])
			iNdEx = postStringIndexmapkey
			if m.EngineLabels == nil {
				m.EngineLabels = make(map[string]string)
			}
			if iNdEx < postIndex {
				var valuekey uint64
				for shift := uint(0); ; shift += 7 {
				...
				mapvalue := string(dAtA[iNdEx:postStringIndexmapvalue])
				iNdEx = postStringIndexmapvalue
				m.EngineLabels[mapkey] = mapvalue
			} else {
				var mapvalue string
				m.EngineLabels[mapkey] = mapvalue
			}
...
var fileDescriptorControl = []byte{
	...
	,
}
