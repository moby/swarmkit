...
type UpdateSecretRequest struct {
	...
	BasicSpec *BasicSecretSpec `protobuf:"bytes,3,opt,name=basic_spec,json=basicSpec" json:"basic_spec,omitempty"`
	// Types that are valid to be assigned to Spec:
	//	*UpdateSecretRequest_Basic
	//	*UpdateSecretRequest_PKI
	//	*UpdateSecretRequest_SecviceIdentity
	Spec isUpdateSecretRequest_Spec `protobuf_oneof:"spec"`
}
...
type isUpdateSecretRequest_Spec interface {
	isUpdateSecretRequest_Spec()
	MarshalTo([]byte) (int, error)
	Size() int
}

type UpdateSecretRequest_Basic struct {
	Basic *BasicSecretSpec `protobuf:"bytes,4,opt,name=basic,oneof"`
}
type UpdateSecretRequest_PKI struct {
	PKI *PKISpec `protobuf:"bytes,5,opt,name=pki,oneof"`
}
type UpdateSecretRequest_SecviceIdentity struct {
	SecviceIdentity *ServiceIdentitySpec `protobuf:"bytes,6,opt,name=secvice_identity,json=secviceIdentity,oneof"`
}

func (*UpdateSecretRequest_Basic) isUpdateSecretRequest_Spec()           {}
func (*UpdateSecretRequest_PKI) isUpdateSecretRequest_Spec()             {}
func (*UpdateSecretRequest_SecviceIdentity) isUpdateSecretRequest_Spec() {}

func (m *UpdateSecretRequest) GetSpec() isUpdateSecretRequest_Spec {
	if m != nil {
		return m.Spec
	}
	return nil
...
func (m *UpdateSecretRequest) GetBasic() *BasicSecretSpec {
	if x, ok := m.GetSpec().(*UpdateSecretRequest_Basic); ok {
		return x.Basic
	}
	return nil
}

func (m *UpdateSecretRequest) GetPKI() *PKISpec {
	if x, ok := m.GetSpec().(*UpdateSecretRequest_PKI); ok {
		return x.PKI
	}
	return nil
}

func (m *UpdateSecretRequest) GetSecviceIdentity() *ServiceIdentitySpec {
	if x, ok := m.GetSpec().(*UpdateSecretRequest_SecviceIdentity); ok {
		return x.SecviceIdentity
	}
	return nil
}
...
func (*UpdateSecretRequest) XXX_OneofFuncs() (func(msg proto.Message, b *proto.Buffer) error, func(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error), func(msg proto.Message) (n int), []interface{}) {
	return _UpdateSecretRequest_OneofMarshaler, _UpdateSecretRequest_OneofUnmarshaler, _UpdateSecretRequest_OneofSizer, []interface{}{
		(*UpdateSecretRequest_Basic)(nil),
		(*UpdateSecretRequest_PKI)(nil),
		(*UpdateSecretRequest_SecviceIdentity)(nil),
	}
}
...
func _UpdateSecretRequest_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	...
	case *UpdateSecretRequest_Basic:
		_ = b.EncodeVarint(4<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.Basic); err != nil {
			return err
		}
	case *UpdateSecretRequest_PKI:
		_ = b.EncodeVarint(5<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.PKI); err != nil {
			return err
		}
	case *UpdateSecretRequest_SecviceIdentity:
		_ = b.EncodeVarint(6<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.SecviceIdentity); err != nil {
			return err
		}
	case nil:
	default:
		return fmt.Errorf("UpdateSecretRequest.Spec has unexpected type %T", x)
	}
	return nil
}
...
func _UpdateSecretRequest_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	...
	case 4: // spec.basic
		...
		msg := new(BasicSecretSpec)
		err := b.DecodeMessage(msg)
		m.Spec = &UpdateSecretRequest_Basic{msg}
		return true, err
	case 5: // spec.pki
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		...
		msg := new(PKISpec)
		err := b.DecodeMessage(msg)
		m.Spec = &UpdateSecretRequest_PKI{msg}
		return true, err
	case 6: // spec.secvice_identity
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(ServiceIdentitySpec)
		err := b.DecodeMessage(msg)
		m.Spec = &UpdateSecretRequest_SecviceIdentity{msg}
		return true, err
	default:
		return false, nil
	}
...
func _UpdateSecretRequest_OneofSizer(msg proto.Message) (n int) {
	...
	case *UpdateSecretRequest_PKI:
		...
		n += s
	case *UpdateSecretRequest_SecviceIdentity:
		s := proto.Size(x.SecviceIdentity)
...
type CreateSecretRequest struct {
	BasicSpec *BasicSecretSpec `protobuf:"bytes,1,opt,name=basic_spec,json=basicSpec" json:"basic_spec,omitempty"`
	// Types that are valid to be assigned to Spec:
	//	*CreateSecretRequest_Basic
	//	*CreateSecretRequest_PKI
	//	*CreateSecretRequest_SecviceIdentity
	Spec isCreateSecretRequest_Spec `protobuf_oneof:"spec"`
}
...
type isCreateSecretRequest_Spec interface {
	isCreateSecretRequest_Spec()
	MarshalTo([]byte) (int, error)
	Size() int
}

type CreateSecretRequest_Basic struct {
	Basic *BasicSecretSpec `protobuf:"bytes,2,opt,name=basic,oneof"`
}
type CreateSecretRequest_PKI struct {
	PKI *PKISpec `protobuf:"bytes,3,opt,name=pki,oneof"`
}
type CreateSecretRequest_SecviceIdentity struct {
	SecviceIdentity *ServiceIdentitySpec `protobuf:"bytes,4,opt,name=secvice_identity,json=secviceIdentity,oneof"`
}

func (*CreateSecretRequest_Basic) isCreateSecretRequest_Spec()           {}
func (*CreateSecretRequest_PKI) isCreateSecretRequest_Spec()             {}
func (*CreateSecretRequest_SecviceIdentity) isCreateSecretRequest_Spec() {}

func (m *CreateSecretRequest) GetSpec() isCreateSecretRequest_Spec {
	if m != nil {
		return m.Spec
	}
	return nil
...
func (m *CreateSecretRequest) GetBasic() *BasicSecretSpec {
	if x, ok := m.GetSpec().(*CreateSecretRequest_Basic); ok {
		return x.Basic
	}
	return nil
}

func (m *CreateSecretRequest) GetPKI() *PKISpec {
	if x, ok := m.GetSpec().(*CreateSecretRequest_PKI); ok {
		return x.PKI
	}
	return nil
}

func (m *CreateSecretRequest) GetSecviceIdentity() *ServiceIdentitySpec {
	if x, ok := m.GetSpec().(*CreateSecretRequest_SecviceIdentity); ok {
		return x.SecviceIdentity
	}
	return nil
}
...
func (*CreateSecretRequest) XXX_OneofFuncs() (func(msg proto.Message, b *proto.Buffer) error, func(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error), func(msg proto.Message) (n int), []interface{}) {
	return _CreateSecretRequest_OneofMarshaler, _CreateSecretRequest_OneofUnmarshaler, _CreateSecretRequest_OneofSizer, []interface{}{
		(*CreateSecretRequest_Basic)(nil),
		(*CreateSecretRequest_PKI)(nil),
		(*CreateSecretRequest_SecviceIdentity)(nil),
	}
}
...
func _CreateSecretRequest_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	...
	// spec
	switch x := m.Spec.(type) {
	case *CreateSecretRequest_Basic:
		_ = b.EncodeVarint(2<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.Basic); err != nil {
			return err
		}
	case *CreateSecretRequest_PKI:
		_ = b.EncodeVarint(3<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.PKI); err != nil {
			return err
		}
	case *CreateSecretRequest_SecviceIdentity:
		_ = b.EncodeVarint(4<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.SecviceIdentity); err != nil {
			return err
		}
	case nil:
	default:
		return fmt.Errorf("CreateSecretRequest.Spec has unexpected type %T", x)
	}
	return nil
}
...
func _CreateSecretRequest_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	...
	case 2: // spec.basic
		...
		msg := new(BasicSecretSpec)
		err := b.DecodeMessage(msg)
		m.Spec = &CreateSecretRequest_Basic{msg}
		return true, err
	case 3: // spec.pki
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		...
		msg := new(PKISpec)
		err := b.DecodeMessage(msg)
		m.Spec = &CreateSecretRequest_PKI{msg}
		return true, err
	case 4: // spec.secvice_identity
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(ServiceIdentitySpec)
		err := b.DecodeMessage(msg)
		m.Spec = &CreateSecretRequest_SecviceIdentity{msg}
		return true, err
	default:
		return false, nil
	}
...
func (m *UpdateSecretRequest) CopyFrom(src interface{}) {
	...
	*m = *o
	...
	if o.BasicSpec != nil {
		m.BasicSpec = &BasicSecretSpec{}
		github_com_docker_swarmkit_api_deepcopy.Copy(m.BasicSpec, o.BasicSpec)
	}
	if o.Spec != nil {
		switch o.Spec.(type) {
		case *UpdateSecretRequest_Basic:
			v := UpdateSecretRequest_Basic{
				Basic: &BasicSecretSpec{},
			}
			github_com_docker_swarmkit_api_deepcopy.Copy(v.Basic, o.GetBasic())
			m.Spec = &v
		case *UpdateSecretRequest_PKI:
			v := UpdateSecretRequest_PKI{
				PKI: &PKISpec{},
			}
			github_com_docker_swarmkit_api_deepcopy.Copy(v.PKI, o.GetPKI())
			m.Spec = &v
		case *UpdateSecretRequest_SecviceIdentity:
			v := UpdateSecretRequest_SecviceIdentity{
				SecviceIdentity: &ServiceIdentitySpec{},
			}
			github_com_docker_swarmkit_api_deepcopy.Copy(v.SecviceIdentity, o.GetSecviceIdentity())
			m.Spec = &v
		}
	}
...
func (m *CreateSecretRequest) CopyFrom(src interface{}) {
	...
	*m = *o
	...
	if o.Spec != nil {
		switch o.Spec.(type) {
		case *CreateSecretRequest_Basic:
			v := CreateSecretRequest_Basic{
				Basic: &BasicSecretSpec{},
			}
			github_com_docker_swarmkit_api_deepcopy.Copy(v.Basic, o.GetBasic())
			m.Spec = &v
		case *CreateSecretRequest_PKI:
			v := CreateSecretRequest_PKI{
				PKI: &PKISpec{},
			}
			github_com_docker_swarmkit_api_deepcopy.Copy(v.PKI, o.GetPKI())
			m.Spec = &v
		case *CreateSecretRequest_SecviceIdentity:
			v := CreateSecretRequest_SecviceIdentity{
				SecviceIdentity: &ServiceIdentitySpec{},
			}
			github_com_docker_swarmkit_api_deepcopy.Copy(v.SecviceIdentity, o.GetSecviceIdentity())
			m.Spec = &v
...
func (m *UpdateSecretRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.BasicSpec != nil {
		dAtA[i] = 0x1a
		i++
		i = encodeVarintControl(dAtA, i, uint64(m.BasicSpec.Size()))
		n27, err := m.BasicSpec.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n27
	...
	if m.Spec != nil {
		nn28, err := m.Spec.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += nn28
...
func (m *UpdateSecretRequest_Basic) MarshalTo(dAtA []byte) (int, error) {
	i := 0
	if m.Basic != nil {
		dAtA[i] = 0x22
		i++
		i = encodeVarintControl(dAtA, i, uint64(m.Basic.Size()))
		n29, err := m.Basic.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n29
...
func (m *UpdateSecretRequest_PKI) MarshalTo(dAtA []byte) (int, error) {
	i := 0
	if m.PKI != nil {
		dAtA[i] = 0x2a
		i++
		i = encodeVarintControl(dAtA, i, uint64(m.PKI.Size()))
		n30, err := m.PKI.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n30
...
func (m *UpdateSecretRequest_SecviceIdentity) MarshalTo(dAtA []byte) (int, error) {
	i := 0
	if m.SecviceIdentity != nil {
		dAtA[i] = 0x32
		i++
		i = encodeVarintControl(dAtA, i, uint64(m.SecviceIdentity.Size()))
		n31, err := m.SecviceIdentity.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n31
...
func (m *CreateSecretRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.BasicSpec != nil {
		...
		i++
		i = encodeVarintControl(dAtA, i, uint64(m.BasicSpec.Size()))
		n34, err := m.BasicSpec.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n34
	...
	if m.Spec != nil {
		nn35, err := m.Spec.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += nn35
...
func (m *CreateSecretRequest_Basic) MarshalTo(dAtA []byte) (int, error) {
	i := 0
	if m.Basic != nil {
		dAtA[i] = 0x12
		i++
		i = encodeVarintControl(dAtA, i, uint64(m.Basic.Size()))
		n36, err := m.Basic.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n36
...
func (m *CreateSecretRequest_PKI) MarshalTo(dAtA []byte) (int, error) {
	i := 0
	if m.PKI != nil {
		dAtA[i] = 0x1a
		i++
		i = encodeVarintControl(dAtA, i, uint64(m.PKI.Size()))
		n37, err := m.PKI.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n37
...
func (m *CreateSecretRequest_SecviceIdentity) MarshalTo(dAtA []byte) (int, error) {
	i := 0
	if m.SecviceIdentity != nil {
		dAtA[i] = 0x22
		i++
		i = encodeVarintControl(dAtA, i, uint64(m.SecviceIdentity.Size()))
		n38, err := m.SecviceIdentity.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n38
...
func (m *CreateSecretResponse) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Secret != nil {
		...
		i++
		i = encodeVarintControl(dAtA, i, uint64(m.Secret.Size()))
		n39, err := m.Secret.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n39
...
func (m *GetConfigResponse) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Config != nil {
		...
		n40, err := m.Config.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n40
...
func (m *UpdateConfigRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.ConfigVersion != nil {
		...
		n41, err := m.ConfigVersion.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n41
...
func (m *UpdateSecretRequest_Basic) Size() (n int) {
	var l int
	_ = l
	if m.Basic != nil {
		l = m.Basic.Size()
...
func (m *UpdateSecretRequest_PKI) Size() (n int) {
	var l int
	_ = l
	if m.PKI != nil {
		l = m.PKI.Size()
...
func (m *UpdateSecretRequest_SecviceIdentity) Size() (n int) {
	var l int
	_ = l
	if m.SecviceIdentity != nil {
		l = m.SecviceIdentity.Size()
		n += 1 + l + sovControl(uint64(l))
	}
	return n
}
...
func (m *CreateSecretRequest_Basic) Size() (n int) {
	var l int
	_ = l
	if m.Basic != nil {
		l = m.Basic.Size()
...
func (m *CreateSecretRequest_PKI) Size() (n int) {
	var l int
	_ = l
	if m.PKI != nil {
		l = m.PKI.Size()
...
func (m *CreateSecretRequest_SecviceIdentity) Size() (n int) {
	var l int
	_ = l
	if m.SecviceIdentity != nil {
		l = m.SecviceIdentity.Size()
...
func (this *UpdateSecretRequest) String() string {
	...
	s := strings.Join([]string{`&UpdateSecretRequest{`,
		...
		`BasicSpec:` + strings.Replace(fmt.Sprintf("%v", this.BasicSpec), "BasicSecretSpec", "BasicSecretSpec", 1) + `,`,
		`Spec:` + fmt.Sprintf("%v", this.Spec) + `,`,
		`}`,
	}, "")
	return s
}
func (this *UpdateSecretRequest_Basic) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&UpdateSecretRequest_Basic{`,
		`Basic:` + strings.Replace(fmt.Sprintf("%v", this.Basic), "BasicSecretSpec", "BasicSecretSpec", 1) + `,`,
		`}`,
	}, "")
	return s
}
func (this *UpdateSecretRequest_PKI) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&UpdateSecretRequest_PKI{`,
		`PKI:` + strings.Replace(fmt.Sprintf("%v", this.PKI), "PKISpec", "PKISpec", 1) + `,`,
		`}`,
	}, "")
	return s
}
func (this *UpdateSecretRequest_SecviceIdentity) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&UpdateSecretRequest_SecviceIdentity{`,
		`SecviceIdentity:` + strings.Replace(fmt.Sprintf("%v", this.SecviceIdentity), "ServiceIdentitySpec", "ServiceIdentitySpec", 1) + `,`,
		`}`,
	}, "")
	return s
}
...
func (this *CreateSecretRequest_Basic) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&CreateSecretRequest_Basic{`,
		`Basic:` + strings.Replace(fmt.Sprintf("%v", this.Basic), "BasicSecretSpec", "BasicSecretSpec", 1) + `,`,
		`}`,
	}, "")
	return s
}
func (this *CreateSecretRequest_PKI) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&CreateSecretRequest_PKI{`,
		`PKI:` + strings.Replace(fmt.Sprintf("%v", this.PKI), "PKISpec", "PKISpec", 1) + `,`,
		`}`,
	}, "")
	return s
}
func (this *CreateSecretRequest_SecviceIdentity) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&CreateSecretRequest_SecviceIdentity{`,
		`SecviceIdentity:` + strings.Replace(fmt.Sprintf("%v", this.SecviceIdentity), "ServiceIdentitySpec", "ServiceIdentitySpec", 1) + `,`,
		`}`,
	}, "")
	return s
...
func (m *UpdateSecretRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field BasicSpec", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.BasicSpec.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 4:
			...
			m.Spec = &UpdateSecretRequest_Basic{v}
			iNdEx = postIndex
		case 5:
			if wireType != 2 {
			...
			m.Spec = &UpdateSecretRequest_PKI{v}
			iNdEx = postIndex
		case 6:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field SecviceIdentity", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			v := &ServiceIdentitySpec{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.Spec = &UpdateSecretRequest_SecviceIdentity{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipControl(dAtA[iNdEx:])
...
func (m *CreateSecretRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			m.Spec = &CreateSecretRequest_Basic{v}
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field PKI", wireType)
			...
			m.Spec = &CreateSecretRequest_PKI{v}
			iNdEx = postIndex
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field SecviceIdentity", wireType)
			...
			m.Spec = &CreateSecretRequest_SecviceIdentity{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipControl(dAtA[iNdEx:])
...
var fileDescriptorControl = []byte{
	...
	,
}
