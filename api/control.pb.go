...
type ListNodesRequest_Filters struct {
	...
	Roles       []NodeSpec_Role       `protobuf:"varint,4,rep,name=roles,enum=docker.cluster.api.NodeSpec_Role" json:"roles,omitempty"`
	Acceptances []NodeSpec_Acceptance `protobuf:"varint,5,rep,name=acceptances,enum=docker.cluster.api.NodeSpec_Acceptance" json:"acceptances,omitempty"`
}
...
type ListTasksRequest_Filters struct {
	...
	DesiredStates []TaskState       `protobuf:"varint,6,rep,name=desired_states,json=desiredStates,enum=docker.cluster.api.TaskState" json:"desired_states,omitempty"`
}
...
func (m *ListNodesRequest_Filters) Copy() *ListNodesRequest_Filters {
	...
	if m.Roles != nil {
		o.Roles = make([]NodeSpec_Role, 0, len(m.Roles))
	...
	if m.Acceptances != nil {
		o.Acceptances = make([]NodeSpec_Acceptance, 0, len(m.Acceptances))
		for _, v := range m.Acceptances {
			o.Acceptances = append(o.Acceptances, v)
		}
	}
...
func (this *ListNodesRequest_Filters) GoString() string {
	...
	s = append(s, "Acceptances: "+fmt.Sprintf("%#v", this.Acceptances)+",\n")
	s = append(s, "}")
	return strings.Join(s, "")
}
...
func (this *ListNodesRequest_Filters) String() string {
	...
	s := strings.Join([]string{`&ListNodesRequest_Filters{`,
		...
		`Acceptances:` + fmt.Sprintf("%v", this.Acceptances) + `,`,
		`}`,
	}, "")
	return s
}
	...
	for iNdEx < l {
		...
		case 5:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := data[iNdEx]
				iNdEx++
				v |= (NodeSpec_Acceptance(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
			m.Acceptances = append(m.Acceptances, v)
		default:
			iNdEx = preIndex
			skippy, err := skipControl(data[iNdEx:])
			if err != nil {
...
var fileDescriptorControl = []byte{
	...
	,
}
