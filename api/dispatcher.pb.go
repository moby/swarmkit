...
type Assignment_Resource struct {
	Resource *Resource `protobuf:"bytes,3,opt,name=resource,oneof"`
}

func (*Assignment_Task) isAssignment_Item()     {}
func (*Assignment_Secret) isAssignment_Item()   {}
func (*Assignment_Resource) isAssignment_Item() {}
...
func (m *Assignment) GetResource() *Resource {
	if x, ok := m.GetItem().(*Assignment_Resource); ok {
		return x.Resource
	}
	return nil
}
...
func _Assignment_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	...
	case 2: // item.secret
		...
		return true, err
	case 3: // item.resource
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(Resource)
		err := b.DecodeMessage(msg)
		m.Item = &Assignment_Resource{msg}
		return true, err
	default:
		return false, nil
	}
...
func (m *Assignment_Resource) MarshalTo(dAtA []byte) (int, error) {
	i := 0
	if m.Resource != nil {
		dAtA[i] = 0x1a
		i++
		i = encodeVarintDispatcher(dAtA, i, uint64(m.Resource.Size()))
...
func (m *Assignment_Resource) Size() (n int) {
	var l int
	_ = l
	if m.Resource != nil {
		l = m.Resource.Size()
...
func (this *Assignment_Resource) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&Assignment_Resource{`,
...
var fileDescriptorDispatcher = []byte{
	...
	,
}
