...
func (AssignmentChange_AssignmentAction) EnumDescriptor() ([]byte, []int) {
	return fileDescriptorDispatcher, []int{12, 0}
}
...
func (AssignmentsMessage_Type) EnumDescriptor() ([]byte, []int) {
	return fileDescriptorDispatcher, []int{13, 0}
}
...
type GossipStatusRequest struct {
	SessionID    string        `protobuf:"bytes,1,opt,name=session_id,json=sessionId,proto3" json:"session_id,omitempty"`
	GossipStatus *GossipStatus `protobuf:"bytes,2,opt,name=gossip_status,json=gossipStatus" json:"gossip_status,omitempty"`
}

func (m *GossipStatusRequest) Reset()                    { *m = GossipStatusRequest{} }
func (*GossipStatusRequest) ProtoMessage()               {}
func (*GossipStatusRequest) Descriptor() ([]byte, []int) { return fileDescriptorDispatcher, []int{6} }
...
func (*GossipStatusResponse) Descriptor() ([]byte, []int) { return fileDescriptorDispatcher, []int{7} }
...
func (*AssignmentsRequest) Descriptor() ([]byte, []int) { return fileDescriptorDispatcher, []int{10} }
...
func (*Assignment) Descriptor() ([]byte, []int) { return fileDescriptorDispatcher, []int{11} }
...
func (*AssignmentChange) Descriptor() ([]byte, []int) { return fileDescriptorDispatcher, []int{12} }
...
func (*AssignmentsMessage) Descriptor() ([]byte, []int) { return fileDescriptorDispatcher, []int{13} }
...
func init() {
	...
	proto.RegisterType((*GossipStatusRequest)(nil), "docker.swarmkit.v1.GossipStatusRequest")
	proto.RegisterType((*GossipStatusResponse)(nil), "docker.swarmkit.v1.GossipStatusResponse")
...
func (p *authenticatedWrapperDispatcherServer) UpdateGossipStatus(ctx context.Context, r *GossipStatusRequest) (*GossipStatusResponse, error) {

	if err := p.authorize(ctx, []string{"swarm-worker", "swarm-manager"}); err != nil {
		return nil, err
	}
	return p.local.UpdateGossipStatus(ctx, r)
}
...
func (m *GossipStatusRequest) Copy() *GossipStatusRequest {
	if m == nil {
		return nil
	}

	o := &GossipStatusRequest{
		SessionID:    m.SessionID,
		GossipStatus: m.GossipStatus.Copy(),
	}

	return o
}

func (m *GossipStatusResponse) Copy() *GossipStatusResponse {
	if m == nil {
		return nil
	}

	o := &GossipStatusResponse{}
...
func (this *GossipStatusRequest) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 6)
	s = append(s, "&api.GossipStatusRequest{")
	s = append(s, "SessionID: "+fmt.Sprintf("%#v", this.SessionID)+",\n")
	if this.GossipStatus != nil {
		s = append(s, "GossipStatus: "+fmt.Sprintf("%#v", this.GossipStatus)+",\n")
	}
	s = append(s, "}")
	return strings.Join(s, "")
}
func (this *GossipStatusResponse) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 4)
	s = append(s, "&api.GossipStatusResponse{")
	s = append(s, "}")
	return strings.Join(s, "")
}
...
type DispatcherClient interface {
	...
	// UpdateGossipStatus updates the gossip cluster status as seen by a node. Agent
	// polls the executor periodidically for gossip status and sends an update if the
	// state has changed since the last update.
	//
	// When the gossip cluster is in a healthy state across all the nodes the member
	// count should be consistent in the gossip status from every node.
	UpdateGossipStatus(ctx context.Context, in *GossipStatusRequest, opts ...grpc.CallOption) (*GossipStatusResponse, error)
...
func (c *dispatcherClient) UpdateGossipStatus(ctx context.Context, in *GossipStatusRequest, opts ...grpc.CallOption) (*GossipStatusResponse, error) {
	out := new(GossipStatusResponse)
	err := grpc.Invoke(ctx, "/docker.swarmkit.v1.Dispatcher/UpdateGossipStatus", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type DispatcherServer interface {
	...
	// When the gossip cluster is in a healthy state across all the nodes the member
	// count should be consistent in the gossip status from every node.
	UpdateGossipStatus(context.Context, *GossipStatusRequest) (*GossipStatusResponse, error)
	// Tasks is a stream of tasks state for node. Each message contains full list
	// of tasks which should be run on node, if task is not present in that list,
	// it should be terminated.
...
func _Dispatcher_UpdateGossipStatus_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GossipStatusRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DispatcherServer).UpdateGossipStatus(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/docker.swarmkit.v1.Dispatcher/UpdateGossipStatus",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DispatcherServer).UpdateGossipStatus(ctx, req.(*GossipStatusRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Dispatcher_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "UpdateGossipStatus",
			Handler:    _Dispatcher_UpdateGossipStatus_Handler,
		},
	},
...
func (m *GossipStatusRequest) Marshal() (data []byte, err error) {
	size := m.Size()
	data = make([]byte, size)
	n, err := m.MarshalTo(data)
	if err != nil {
...
func (m *GossipStatusRequest) MarshalTo(data []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	...
	if m.GossipStatus != nil {
		data[i] = 0x12
		i++
		i = encodeVarintDispatcher(data, i, uint64(m.GossipStatus.Size()))
		n5, err := m.GossipStatus.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n5
...
func (m *GossipStatusResponse) Marshal() (data []byte, err error) {
	size := m.Size()
	data = make([]byte, size)
	n, err := m.MarshalTo(data)
	if err != nil {
...
func (m *GossipStatusResponse) MarshalTo(data []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *Assignment) MarshalTo(data []byte) (int, error) {
	...
	_ = l
	if m.Item != nil {
		nn6, err := m.Item.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += nn6
...
func (m *Assignment_Secret) MarshalTo(data []byte) (int, error) {
	...
	if m.Secret != nil {
		...
		n8, err := m.Secret.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n8
...
func (p *raftProxyDispatcherServer) UpdateGossipStatus(ctx context.Context, r *GossipStatusRequest) (*GossipStatusResponse, error) {
	...
	resp, err := NewDispatcherClient(conn).UpdateGossipStatus(modCtx, r)
	if err != nil {
		if !strings.Contains(err.Error(), "is closing") && !strings.Contains(err.Error(), "the connection is unavailable") && !strings.Contains(err.Error(), "connection error") {
			return resp, err
		}
		...
		return NewDispatcherClient(conn).UpdateGossipStatus(modCtx, r)
	}
	return resp, err
}
...
func (m *GossipStatusRequest) Size() (n int) {
	var l int
	_ = l
	l = len(m.SessionID)
	if l > 0 {
	...
	if m.GossipStatus != nil {
		l = m.GossipStatus.Size()
		n += 1 + l + sovDispatcher(uint64(l))
	}
	return n
}

func (m *GossipStatusResponse) Size() (n int) {
	var l int
	_ = l
	return n
}
...
func (this *GossipStatusRequest) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&GossipStatusRequest{`,
		`SessionID:` + fmt.Sprintf("%v", this.SessionID) + `,`,
		`GossipStatus:` + strings.Replace(fmt.Sprintf("%v", this.GossipStatus), "GossipStatus", "GossipStatus", 1) + `,`,
		`}`,
	}, "")
	return s
}
func (this *GossipStatusResponse) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&GossipStatusResponse{`,
		`}`,
	}, "")
	return s
}
...
func (m *GossipStatusRequest) Unmarshal(data []byte) error {
	l := len(data)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: GossipStatusRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: GossipStatusRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field GossipStatus", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.GossipStatus == nil {
				m.GossipStatus = &GossipStatus{}
			}
			if err := m.GossipStatus.Unmarshal(data[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *GossipStatusResponse) Unmarshal(data []byte) error {
	l := len(data)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: GossipStatusResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: GossipStatusResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		default:
			iNdEx = preIndex
...
var fileDescriptorDispatcher = []byte{
	...
	,
}
