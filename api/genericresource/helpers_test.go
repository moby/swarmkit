...
func TestConsumeResourcesSingle(t *testing.T) {
	...
	assert.Equal(t, int64(3), nodeAvailableResources[2].GetDiscreteResourceSpec().GetValue())
}
...
func TestConsumeResourcesMultiple(t *testing.T) {
	...
	assert.Equal(t, int64(5), oranges[0].GetDiscreteResourceSpec().GetValue())
	assert.Equal(t, int64(1), bananas[0].GetDiscreteResourceSpec().GetValue())
}
