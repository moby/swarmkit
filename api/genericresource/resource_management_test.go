...
func TestClaimSingleDiscrete(t *testing.T) {
	...
	assert.Equal(t, int64(1), nodeRes[0].GetDiscreteResourceSpec().GetValue())
	assert.Equal(t, int64(2), taskAssigned[0].GetDiscreteResourceSpec().GetValue())
}
...
func TestClaimMultipleDiscrete(t *testing.T) {
	...
	assert.Equal(t, int64(2), apples[0].GetDiscreteResourceSpec().GetValue())
	assert.Equal(t, int64(4), oranges[0].GetDiscreteResourceSpec().GetValue())
}
...
func TestReclaimSingleDiscrete(t *testing.T) {
	...
	assert.Len(t, nodeRes, 1)
	assert.Equal(t, int64(2), nodeRes[0].GetDiscreteResourceSpec().GetValue())

	err = reclaimResources(&nodeRes, taskAssigned)
	assert.NoError(t, err)

	assert.Len(t, nodeRes, 1)
	assert.Equal(t, int64(4), nodeRes[0].GetDiscreteResourceSpec().GetValue())
}
...
func TestReclaimMultipleDiscrete(t *testing.T) {
	...
	assert.Equal(t, int64(5), apples[0].GetDiscreteResourceSpec().GetValue())
	assert.Equal(t, int64(4), oranges[0].GetDiscreteResourceSpec().GetValue())
	assert.Equal(t, int64(2), bananas[0].GetDiscreteResourceSpec().GetValue())
}
...
func TestReclaimResources(t *testing.T) {
	...
	assert.Equal(t, int64(2), cakes[0].GetDiscreteResourceSpec().GetValue())
	assert.Equal(t, int64(2), coffe[0].GetDiscreteResourceSpec().GetValue())
...
func TestSanitizeDiscrete(t *testing.T) {
	...
	assert.Equal(t, int64(4), nodeAvailableResources[0].GetDiscreteResourceSpec().GetValue())
	...
	sanitize(nodeRes, &nodeAvailableResources)
	assert.Len(t, nodeAvailableResources, 1)
	assert.Equal(t, int64(2), nodeAvailableResources[0].GetDiscreteResourceSpec().GetValue())
	...
	assert.Equal(t, int64(2), nodeAvailableResources[0].GetDiscreteResourceSpec().GetValue()) // oranges
	assert.Equal(t, int64(2), nodeAvailableResources[1].GetDiscreteResourceSpec().GetValue()) // cake
	assert.Equal(t, int64(6), nodeAvailableResources[2].GetDiscreteResourceSpec().GetValue()) // banana
}
...
func TestSanitizeChangeDiscreteToSet(t *testing.T) {
	...
	sanitize(nodeRes, &nodeAvailableResources)
	assert.Len(t, nodeAvailableResources, 1)
	assert.Equal(t, "red", nodeAvailableResources[0].GetNamedResourceSpec().GetValue())
...
func TestSanitizeChangeSetToDiscrete(t *testing.T) {
	...
	sanitize(nodeRes, &nodeAvailableResources)
	assert.Len(t, nodeAvailableResources, 1)
	assert.Equal(t, int64(5), nodeAvailableResources[0].GetDiscreteResourceSpec().GetValue())
	...
	assert.Equal(t, int64(5), apples[0].GetDiscreteResourceSpec().GetValue())
	assert.Equal(t, int64(3), oranges[0].GetDiscreteResourceSpec().GetValue())
	assert.Equal(t, int64(1), cakes[0].GetDiscreteResourceSpec().GetValue())
}
