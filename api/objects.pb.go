...
type CNMState struct {
	// Driver specific operational state provided by the network driver.
	DriverState *Driver `protobuf:"bytes,1,opt,name=driver_state,json=driverState" json:"driver_state,omitempty"`
	// Runtime state of IPAM options. This may not reflect the
	// ipam options from NetworkSpec.
	IPAM *IPAMOptions `protobuf:"bytes,2,opt,name=ipam" json:"ipam,omitempty"`
}

func (m *CNMState) Reset()                    { *m = CNMState{} }
func (*CNMState) ProtoMessage()               {}
func (*CNMState) Descriptor() ([]byte, []int) { return fileDescriptorObjects, []int{6} }

// All fields with a cnm_compat_ (CNMCompat in go) prefix are
// deprecated and the contents of the `state` oneof will be preferred
// if present.  Network.state and Network.spec.Backend must be
// consistent WRT the use of their respective compat fields.
type Network struct {
	ID   string      `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"`
	Meta Meta        `protobuf:"bytes,2,opt,name=meta" json:"meta"`
	Spec NetworkSpec `protobuf:"bytes,3,opt,name=spec" json:"spec"`
	// CNMCompatDriverState (deprecated) specific operational
	// state provided by the network driver.
	CNMCompatDriverState *Driver `protobuf:"bytes,4,opt,name=cnm_compat_driver_state,json=cnmCompatDriverState" json:"cnm_compat_driver_state,omitempty"`
	// CNMCompatIPAM (deprecated) state of IPAM options. This may
	// not reflect the ipam options from NetworkSpec.
	CNMCompatIPAM *IPAMOptions `protobuf:"bytes,5,opt,name=cnm_compat_ipam,json=cnmCompatIpam" json:"cnm_compat_ipam,omitempty"`
	// State which is specific to the Network.Spec.Backend.
	//
	// Types that are valid to be assigned to State:
	//	*Network_CNM
	State isNetwork_State `protobuf_oneof:"state"`
}
...
type isNetwork_State interface {
	isNetwork_State()
	MarshalTo([]byte) (int, error)
	Size() int
}

type Network_CNM struct {
	CNM *CNMState `protobuf:"bytes,6,opt,name=cnm,oneof"`
}

func (*Network_CNM) isNetwork_State() {}

func (m *Network) GetState() isNetwork_State {
	if m != nil {
		return m.State
	}
	return nil
...
func (m *Network) GetCNM() *CNMState {
	if x, ok := m.GetState().(*Network_CNM); ok {
		return x.CNM
	}
	return nil
}
...
func _Network_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	...
	case nil:
	default:
		return fmt.Errorf("Network.State has unexpected type %T", x)
	}
	return nil
}
...
func init() {
	...
	proto.RegisterType((*CNMState)(nil), "docker.swarmkit.v1.CNMState")
...
func (m *CNMState) CopyFrom(src interface{}) {
...
func (m *Network) CopyFrom(src interface{}) {
	...
	*m = *o
	github_com_docker_swarmkit_api_deepcopy.Copy(&m.Meta, &o.Meta)
	github_com_docker_swarmkit_api_deepcopy.Copy(&m.Spec, &o.Spec)
	if o.CNMCompatDriverState != nil {
		m.CNMCompatDriverState = &Driver{}
		github_com_docker_swarmkit_api_deepcopy.Copy(m.CNMCompatDriverState, o.CNMCompatDriverState)
	}
...
func (m *CNMState) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *CNMState) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *Network) MarshalTo(dAtA []byte) (int, error) {
	...
	i += n31
	if m.CNMCompatDriverState != nil {
		dAtA[i] = 0x22
		i++
		i = encodeVarintObjects(dAtA, i, uint64(m.CNMCompatDriverState.Size()))
		n32, err := m.CNMCompatDriverState.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n32
	...
	if m.CNMCompatIPAM != nil {
		dAtA[i] = 0x2a
		i++
		i = encodeVarintObjects(dAtA, i, uint64(m.CNMCompatIPAM.Size()))
		n33, err := m.CNMCompatIPAM.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n33
	...
	if m.State != nil {
		nn34, err := m.State.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += nn34
...
func (m *Network_CNM) MarshalTo(dAtA []byte) (int, error) {
	i := 0
	if m.CNM != nil {
		dAtA[i] = 0x32
		i++
		i = encodeVarintObjects(dAtA, i, uint64(m.CNM.Size()))
		n35, err := m.CNM.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n35
...
func (this *CNMState) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&CNMState{`,
...
func (this *Network) String() string {
	...
	s := strings.Join([]string{`&Network{`,
		...
		`CNMCompatDriverState:` + strings.Replace(fmt.Sprintf("%v", this.CNMCompatDriverState), "Driver", "Driver", 1) + `,`,
...
func (this *Network_CNM) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&Network_CNM{`,
		`CNM:` + strings.Replace(fmt.Sprintf("%v", this.CNM), "CNMState", "CNMState", 1) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *CNMState) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: CNMState: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: CNMState: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *Network) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field CNMCompatDriverState", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.CNMCompatDriverState.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 5:
...
var fileDescriptorObjects = []byte{
	...
	,
}
