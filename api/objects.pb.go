...
// Secret represents a conceptual secret that should be passed to either a
// container a node. It can contain many versions of secret data, since
// conceptually secret credentials can be rotated.
type Secret struct {
	ID   string `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"`
	Meta Meta   `protobuf:"bytes,2,opt,name=meta" json:"meta"`
	// A secret has multiple versions, and each version is represented by a
	// `SecretValue` object and referenced by the `SecretValue`'s ID.  This
	// list is kept sorted by version creation date.
	SecretValues []*SecretValue `protobuf:"bytes,3,rep,name=secret_values,json=secretValues" json:"secret_values,omitempty"`
	// Name of the secret, so that we can use it easily for lookups.  This is
	// just a copy of the data in `SecretValue.Spec.Annotations.Name`.
...
// SecretValue is represents a specific version of a secret, and is immutable;
...
type SecretValue struct {
	ID        string                       `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"`
	CreatedAt docker_swarmkit_v1.Timestamp `protobuf:"bytes,2,opt,name=created_at,json=createdAt" json:"created_at"`
	...
	// spec must match the name of the `Secret` object this `SecretValue` belongs
	// to.
	Spec SecretValueSpec `protobuf:"bytes,3,opt,name=spec" json:"spec"`
	...
	// is calculated from the data contained in `SecretValue.Spec.data`.
	Digest string `protobuf:"bytes,4,opt,name=digest,proto3" json:"digest,omitempty"`
	// Size represents the size (number of bytes) of the secret data, and is
	// calculated from the data contained in `SecretValue.Spec.data`..
...
func (*SecretValue) Descriptor() ([]byte, []int) { return fileDescriptorObjects, []int{9} }
...
func init() {
	...
	proto.RegisterType((*SecretValue)(nil), "docker.swarmkit.v1.SecretValue")
}
...
func (m *Secret) Copy() *Secret {
	...
	if m.SecretValues != nil {
		o.SecretValues = make([]*SecretValue, 0, len(m.SecretValues))
		for _, v := range m.SecretValues {
			o.SecretValues = append(o.SecretValues, v.Copy())
		}
	}
...
func (m *SecretValue) Copy() *SecretValue {
	if m == nil {
		return nil
	}
...
func (this *Secret) GoString() string {
	...
	s = append(s, "ID: "+fmt.Sprintf("%#v", this.ID)+",\n")
	s = append(s, "Meta: "+strings.Replace(this.Meta.GoString(), `&`, ``, 1)+",\n")
	if this.SecretValues != nil {
		s = append(s, "SecretValues: "+fmt.Sprintf("%#v", this.SecretValues)+",\n")
	}
...
func (this *SecretValue) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 9)
	s = append(s, "&api.SecretValue{")
	s = append(s, "ID: "+fmt.Sprintf("%#v", this.ID)+",\n")
...
func (m *Secret) MarshalTo(data []byte) (int, error) {
	...
	if len(m.SecretValues) > 0 {
		for _, msg := range m.SecretValues {
			data[i] = 0x1a
			i++
			i = encodeVarintObjects(data, i, uint64(msg.Size()))
			n, err := msg.MarshalTo(data[i:])
...
func (m *SecretValue) Marshal() (data []byte, err error) {
	size := m.Size()
	data = make([]byte, size)
	n, err := m.MarshalTo(data)
	if err != nil {
...
func (m *SecretValue) MarshalTo(data []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (this *Secret) String() string {
	...
	s := strings.Join([]string{`&Secret{`,
		`ID:` + fmt.Sprintf("%v", this.ID) + `,`,
		`Meta:` + strings.Replace(strings.Replace(this.Meta.String(), "Meta", "Meta", 1), `&`, ``, 1) + `,`,
		`SecretValues:` + strings.Replace(fmt.Sprintf("%v", this.SecretValues), "SecretValue", "SecretValue", 1) + `,`,
...
func (this *SecretValue) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&SecretValue{`,
		`ID:` + fmt.Sprintf("%v", this.ID) + `,`,
		`CreatedAt:` + strings.Replace(strings.Replace(this.CreatedAt.String(), "Timestamp", "docker_swarmkit_v1.Timestamp", 1), `&`, ``, 1) + `,`,
		`Spec:` + strings.Replace(strings.Replace(this.Spec.String(), "SecretValueSpec", "SecretValueSpec", 1), `&`, ``, 1) + `,`,
...
func (m *Secret) Unmarshal(data []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field SecretValues", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.SecretValues = append(m.SecretValues, &SecretValue{})
			if err := m.SecretValues[len(m.SecretValues)-1].Unmarshal(data[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 4:
...
func (m *SecretValue) Unmarshal(data []byte) error {
	l := len(data)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
...
var fileDescriptorObjects = []byte{
	...
	,
}
