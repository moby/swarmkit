...
type Cluster struct {
	...
	// Logical clock used to timestamp every secret.  It allows other managers
	// and agents to unambiguously identify the newest secret to be used when
	// requesting the latest version of a secret.
	SecretLamportClock uint64 `protobuf:"varint,7,opt,name=secret_lamport_clock,json=secretLamportClock,proto3" json:"secret_lamport_clock,omitempty"`
}
...
type Secret struct {
	...
	// spec must match the name of the `Secret` object this `SecretSpec` belongs
	// to.
	...
	// Timestamp from the lamport clock to identify the relative age of the secret.
...
func (m *Cluster) Copy() *Cluster {
	...
	o := &Cluster{
		...
		SecretLamportClock:        m.SecretLamportClock,
	}
...
func (m *Cluster) MarshalTo(data []byte) (int, error) {
	...
	if m.SecretLamportClock != 0 {
		data[i] = 0x38
		i++
		i = encodeVarintObjects(data, i, uint64(m.SecretLamportClock))
	}
	return i, nil
}
...
func (m *Secret) MarshalTo(data []byte) (int, error) {
	...
	if m.LamportTime != 0 {
		data[i] = 0x38
		i++
		i = encodeVarintObjects(data, i, uint64(m.LamportTime))
	}
	return i, nil
}
...
func (m *Cluster) Size() (n int) {
	...
	if m.SecretLamportClock != 0 {
		n += 1 + sovObjects(uint64(m.SecretLamportClock))
	}
	return n
}
...
func (m *Secret) Size() (n int) {
	...
	if m.LamportTime != 0 {
		n += 1 + sovObjects(uint64(m.LamportTime))
	}
	return n
}
...
func (this *Cluster) String() string {
	...
	s := strings.Join([]string{`&Cluster{`,
		...
		`SecretLamportClock:` + fmt.Sprintf("%v", this.SecretLamportClock) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *Cluster) Unmarshal(data []byte) error {
	...
	for iNdEx < l {
		...
		case 7:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field SecretLamportClock", wireType)
			}
			m.SecretLamportClock = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowObjects
				}
				...
				b := data[iNdEx]
				iNdEx++
				m.SecretLamportClock |= (uint64(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
var fileDescriptorObjects = []byte{
	...
	,
}
