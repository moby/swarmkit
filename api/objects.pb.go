...
type Meta struct {
	...
	// SpecVersion tracks the current version of the spec.
	SpecVersion Version `protobuf:"bytes,4,opt,name=spec_version,json=specVersion" json:"spec_version"`
	// Object timestamps.
...
func (this *Meta) GoString() string {
	...
	s = append(s, "SpecVersion: "+strings.Replace(this.SpecVersion.GoString(), `&`, ``, 1)+",\n")
...
func (m *Meta) MarshalTo(data []byte) (int, error) {
	...
	n4, err := m.SpecVersion.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n4
...
func (m *Node) MarshalTo(data []byte) (int, error) {
	...
	if m.Description != nil {
		...
		n7, err := m.Description.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n7
	...
	if m.ManagerStatus != nil {
		...
		n9, err := m.ManagerStatus.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n9
	...
	n11, err := m.Certificate.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n11
...
func (this *Meta) String() string {
	...
	s := strings.Join([]string{`&Meta{`,
		...
		`SpecVersion:` + strings.Replace(strings.Replace(this.SpecVersion.String(), "Version", "Version", 1), `&`, ``, 1) + `,`,
		`}`,
	}, "")
	return s
}
...
var fileDescriptorObjects = []byte{
	...
	,
}
