...
type Node struct {
	...
	Network *NetworkAttachment `protobuf:"bytes,6,opt,name=network" json:"network,omitempty"`
}
...
func (*RegisteredCertificate) Descriptor() ([]byte, []int) { return fileDescriptorObjects, []int{10} }
...
func (*Cluster) Descriptor() ([]byte, []int) { return fileDescriptorObjects, []int{11} }
...
func (this *Node) String() string {
	...
	s := strings.Join([]string{`&Node{`,
		...
		`Network:` + strings.Replace(fmt.Sprintf("%v", this.Network), "NetworkAttachment", "NetworkAttachment", 1) + `,`,
		`}`,
	}, "")
	return s
}
...
var fileDescriptorObjects = []byte{
	...
	,
}
