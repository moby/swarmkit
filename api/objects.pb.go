...
type Service struct {
	...
	// MarkedForRemoval indicates whether a service has been marked for
	// removal. This happens when a service rm comes in from the
	// API, and the orchestrator is waiting for all the tasks to
	// be properly shut down before removing the service object
	// from the store.
	MarkedForRemoval bool `protobuf:"varint,7,opt,name=marked_for_removal,json=markedForRemoval,proto3" json:"marked_for_removal,omitempty"`
}
...
func (this *Service) String() string {
	...
	s := strings.Join([]string{`&Service{`,
		...
		`MarkedForRemoval:` + fmt.Sprintf("%v", this.MarkedForRemoval) + `,`,
...
func (m *Service) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 7:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field MarkedForRemoval", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
...
var fileDescriptorObjects = []byte{
	...
	,
}
