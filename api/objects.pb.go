...
type Secret struct {
	...
	Spec *BasicSecretSpec `protobuf:"bytes,3,opt,name=spec" json:"spec,omitempty"`
	// Whether the secret is an internal secret (not set by a user) or not.
	Internal bool `protobuf:"varint,4,opt,name=internal,proto3" json:"internal,omitempty"`
	// Types that are valid to be assigned to SecretType:
	//	*Secret_Basic
	//	*Secret_PKI
	//	*Secret_ServiceIdentity
	SecretType isSecret_SecretType `protobuf_oneof:"secret_type"`
}
...
type isSecret_SecretType interface {
	isSecret_SecretType()
	MarshalTo([]byte) (int, error)
	Size() int
}

type Secret_Basic struct {
	Basic *BasicSecret `protobuf:"bytes,5,opt,name=basic,oneof"`
}
type Secret_PKI struct {
	PKI *PKISecret `protobuf:"bytes,6,opt,name=pki,oneof"`
}
type Secret_ServiceIdentity struct {
	ServiceIdentity *ServiceIdentitySecret `protobuf:"bytes,7,opt,name=service_identity,json=serviceIdentity,oneof"`
}

func (*Secret_Basic) isSecret_SecretType()           {}
func (*Secret_PKI) isSecret_SecretType()             {}
func (*Secret_ServiceIdentity) isSecret_SecretType() {}

func (m *Secret) GetSecretType() isSecret_SecretType {
	if m != nil {
		return m.SecretType
	}
	return nil
...
func (m *Secret) GetBasic() *BasicSecret {
	if x, ok := m.GetSecretType().(*Secret_Basic); ok {
		return x.Basic
	}
	return nil
}

func (m *Secret) GetPKI() *PKISecret {
	if x, ok := m.GetSecretType().(*Secret_PKI); ok {
		return x.PKI
	}
	return nil
}

func (m *Secret) GetServiceIdentity() *ServiceIdentitySecret {
	if x, ok := m.GetSecretType().(*Secret_ServiceIdentity); ok {
...
func _Secret_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	...
	case *Secret_ServiceIdentity:
		_ = b.EncodeVarint(7<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.ServiceIdentity); err != nil {
			return err
		}
	case nil:
	default:
		return fmt.Errorf("Secret.SecretType has unexpected type %T", x)
	}
	return nil
}
...
func _Secret_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	m := msg.(*Secret)
	switch tag {
	case 5: // secret_type.basic
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(BasicSecret)
		err := b.DecodeMessage(msg)
		m.SecretType = &Secret_Basic{msg}
		return true, err
	case 6: // secret_type.pki
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(PKISecret)
		err := b.DecodeMessage(msg)
		m.SecretType = &Secret_PKI{msg}
		return true, err
	case 7: // secret_type.service_identity
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(ServiceIdentitySecret)
		err := b.DecodeMessage(msg)
		m.SecretType = &Secret_ServiceIdentity{msg}
		return true, err
	default:
		return false, nil
	}
...
func _Secret_OneofSizer(msg proto.Message) (n int) {
	...
	case *Secret_PKI:
		...
		n += s
	case *Secret_ServiceIdentity:
		s := proto.Size(x.ServiceIdentity)
...
type BasicSecret struct {
	// Spec contains the actual secret data, as well as any context around the
	// secret data that the user provides.
	Spec BasicSecretSpec `protobuf:"bytes,1,opt,name=spec" json:"spec"`
}

func (m *BasicSecret) Reset()                    { *m = BasicSecret{} }
func (*BasicSecret) ProtoMessage()               {}
func (*BasicSecret) Descriptor() ([]byte, []int) { return fileDescriptorObjects, []int{12} }

// ServiceIdentitySecret specifies a certificate and private key pair
type ServiceIdentitySecret struct {
	Spec        ServiceIdentitySpec `protobuf:"bytes,1,opt,name=spec" json:"spec"`
...
func (*ServiceIdentitySecret) Descriptor() ([]byte, []int) { return fileDescriptorObjects, []int{13} }

// PKISecret specifies a PKI (CA) issuer
type PKISecret struct {
	Spec   PKISpec `protobuf:"bytes,1,opt,name=spec" json:"spec"`
	RootCA RootCA  `protobuf:"bytes,2,opt,name=root_ca,json=rootCa" json:"root_ca"`
}

func (m *PKISecret) Reset()                    { *m = PKISecret{} }
func (*PKISecret) ProtoMessage()               {}
func (*PKISecret) Descriptor() ([]byte, []int) { return fileDescriptorObjects, []int{14} }
...
func init() {
	...
	proto.RegisterType((*BasicSecret)(nil), "docker.swarmkit.v1.BasicSecret")
...
func (m *Secret) CopyFrom(src interface{}) {
	...
	*m = *o
	github_com_docker_swarmkit_api_deepcopy.Copy(&m.Meta, &o.Meta)
	if o.Spec != nil {
		m.Spec = &BasicSecretSpec{}
		github_com_docker_swarmkit_api_deepcopy.Copy(m.Spec, o.Spec)
	}
	if o.SecretType != nil {
		switch o.SecretType.(type) {
		case *Secret_Basic:
			v := Secret_Basic{
				Basic: &BasicSecret{},
			}
		...
		case *Secret_PKI:
			...
			m.SecretType = &v
		case *Secret_ServiceIdentity:
			v := Secret_ServiceIdentity{
				ServiceIdentity: &ServiceIdentitySecret{},
			}
			github_com_docker_swarmkit_api_deepcopy.Copy(v.ServiceIdentity, o.GetServiceIdentity())
			m.SecretType = &v
		}
	}
...
func (m *BasicSecret) Copy() *BasicSecret {
	if m == nil {
		return nil
	}
	o := &BasicSecret{}
...
func (m *BasicSecret) CopyFrom(src interface{}) {
...
func (m *ServiceIdentitySecret) CopyFrom(src interface{}) {
	...
	*m = *o
	github_com_docker_swarmkit_api_deepcopy.Copy(&m.Spec, &o.Spec)
	if o.PrivateKey != nil {
		m.PrivateKey = make([]byte, len(o.PrivateKey))
		copy(m.PrivateKey, o.PrivateKey)
	}
...
func (m *Secret) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.SecretType != nil {
		nn38, err := m.SecretType.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += nn38
...
func (m *Secret_Basic) MarshalTo(dAtA []byte) (int, error) {
	i := 0
	if m.Basic != nil {
		dAtA[i] = 0x2a
		i++
		i = encodeVarintObjects(dAtA, i, uint64(m.Basic.Size()))
		n39, err := m.Basic.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n39
...
func (m *Secret_PKI) MarshalTo(dAtA []byte) (int, error) {
	i := 0
	if m.PKI != nil {
		dAtA[i] = 0x32
		i++
		i = encodeVarintObjects(dAtA, i, uint64(m.PKI.Size()))
		n40, err := m.PKI.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n40
...
func (m *Secret_ServiceIdentity) MarshalTo(dAtA []byte) (int, error) {
	i := 0
	if m.ServiceIdentity != nil {
		dAtA[i] = 0x3a
		i++
		i = encodeVarintObjects(dAtA, i, uint64(m.ServiceIdentity.Size()))
		n41, err := m.ServiceIdentity.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n41
...
func (m *BasicSecret) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *BasicSecret) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *ServiceIdentitySecret) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.PrivateKey) > 0 {
		dAtA[i] = 0x12
		i++
		i = encodeVarintObjects(dAtA, i, uint64(len(m.PrivateKey)))
...
func (m *PKISecret) MarshalTo(dAtA []byte) (int, error) {
	...
	i++
	i = encodeVarintObjects(dAtA, i, uint64(m.RootCA.Size()))
	n52, err := m.RootCA.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n52
...
func (m *Secret_Basic) Size() (n int) {
	var l int
	_ = l
	if m.Basic != nil {
		l = m.Basic.Size()
...
func (m *Secret_ServiceIdentity) Size() (n int) {
	var l int
	_ = l
	if m.ServiceIdentity != nil {
		l = m.ServiceIdentity.Size()
		n += 1 + l + sovObjects(uint64(l))
	}
	return n
}
...
func (this *Secret) String() string {
	...
	s := strings.Join([]string{`&Secret{`,
		`ID:` + fmt.Sprintf("%v", this.ID) + `,`,
		`Meta:` + strings.Replace(strings.Replace(this.Meta.String(), "Meta", "Meta", 1), `&`, ``, 1) + `,`,
		`Spec:` + strings.Replace(fmt.Sprintf("%v", this.Spec), "BasicSecretSpec", "BasicSecretSpec", 1) + `,`,
...
func (this *Secret_Basic) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&Secret_Basic{`,
		`Basic:` + strings.Replace(fmt.Sprintf("%v", this.Basic), "BasicSecret", "BasicSecret", 1) + `,`,
		`}`,
	}, "")
	return s
}
func (this *Secret_PKI) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&Secret_PKI{`,
		`PKI:` + strings.Replace(fmt.Sprintf("%v", this.PKI), "PKISecret", "PKISecret", 1) + `,`,
		`}`,
	}, "")
	return s
}
func (this *Secret_ServiceIdentity) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&Secret_ServiceIdentity{`,
		`ServiceIdentity:` + strings.Replace(fmt.Sprintf("%v", this.ServiceIdentity), "ServiceIdentitySecret", "ServiceIdentitySecret", 1) + `,`,
		`}`,
	}, "")
	return s
}
...
func (this *BasicSecret) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&BasicSecret{`,
		`Spec:` + strings.Replace(strings.Replace(this.Spec.String(), "BasicSecretSpec", "BasicSecretSpec", 1), `&`, ``, 1) + `,`,
		`}`,
	}, "")
	return s
}
func (this *ServiceIdentitySecret) String() string {
	...
	s := strings.Join([]string{`&ServiceIdentitySecret{`,
		`Spec:` + strings.Replace(strings.Replace(this.Spec.String(), "ServiceIdentitySpec", "ServiceIdentitySpec", 1), `&`, ``, 1) + `,`,
...
func (this *PKISecret) String() string {
	...
	s := strings.Join([]string{`&PKISecret{`,
		`Spec:` + strings.Replace(strings.Replace(this.Spec.String(), "PKISpec", "PKISpec", 1), `&`, ``, 1) + `,`,
		`RootCA:` + strings.Replace(strings.Replace(this.RootCA.String(), "RootCA", "RootCA", 1), `&`, ``, 1) + `,`,
		`}`,
	}, "")
	return s
...
func (m *Secret) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			...
			m.SecretType = &Secret_PKI{v}
			iNdEx = postIndex
		case 7:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ServiceIdentity", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			v := &ServiceIdentitySecret{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.SecretType = &Secret_ServiceIdentity{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipObjects(dAtA[iNdEx:])
...
func (m *BasicSecret) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: BasicSecret: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: BasicSecret: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
var fileDescriptorObjects = []byte{
	...
	,
}
