...
type Node struct {
	...
	// GossipStatus is the status of gossip cluster as seen by a node
	GossipStatus *GossipStatus `protobuf:"bytes,9,opt,name=gossip_status,json=gossipStatus" json:"gossip_status,omitempty"`
}
...
func (m *Node) MarshalTo(data []byte) (int, error) {
	...
	if m.GossipStatus != nil {
		data[i] = 0x4a
		i++
		i = encodeVarintObjects(data, i, uint64(m.GossipStatus.Size()))
		n11, err := m.GossipStatus.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n11
...
var fileDescriptorObjects = []byte{
	...
	,
}
