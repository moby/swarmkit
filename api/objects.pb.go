...
type Member struct {
	...
	Description MemberDescription `protobuf:"bytes,4,opt,name=description" json:"description"`
...
func (this *Member) GoString() string {
	...
	s = append(s, "Description: "+strings.Replace(this.Description.GoString(), `&`, ``, 1)+",\n")
	s = append(s, "Status: "+strings.Replace(this.Status.GoString(), `&`, ``, 1)+",\n")
	s = append(s, "}")
	return strings.Join(s, "")
}
...
func (this *Member) String() string {
	...
	s := strings.Join([]string{`&Member{`,
		...
		`Description:` + strings.Replace(strings.Replace(this.Description.String(), "MemberDescription", "MemberDescription", 1), `&`, ``, 1) + `,`,
...
var fileDescriptorObjects = []byte{
	...
	,
}
