...
type Secret struct {
	...
	// Whether the secret is an internal secret (not set by a user, not visible to user) or not.
	Internal bool `protobuf:"varint,4,opt,name=internal,proto3" json:"internal,omitempty"`
	// Types that are valid to be assigned to Special:
	//	*Secret_PKI
	//	*Secret_ServiceIdentity
	Special isSecret_Special `protobuf_oneof:"special"`
}
...
type isSecret_Special interface {
	isSecret_Special()
...
type Secret_PKI struct {
	PKI *PKISecret `protobuf:"bytes,5,opt,name=PKI,oneof"`
}
type Secret_ServiceIdentity struct {
	ServiceIdentity *ServiceIdentitySecret `protobuf:"bytes,6,opt,name=service_identity,json=serviceIdentity,oneof"`
}

func (*Secret_PKI) isSecret_Special()             {}
func (*Secret_ServiceIdentity) isSecret_Special() {}

func (m *Secret) GetSpecial() isSecret_Special {
	if m != nil {
		return m.Special
	}
	return nil
...
func (m *Secret) GetPKI() *PKISecret {
	if x, ok := m.GetSpecial().(*Secret_PKI); ok {
		return x.PKI
	}
	return nil
}
...
func (m *Secret) GetServiceIdentity() *ServiceIdentitySecret {
	if x, ok := m.GetSpecial().(*Secret_ServiceIdentity); ok {
...
func _Secret_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	...
	case nil:
	default:
		return fmt.Errorf("Secret.Special has unexpected type %T", x)
	}
	return nil
}
...
func _Secret_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	...
	case 5: // special.PKI
		...
		m.Special = &Secret_PKI{msg}
		return true, err
	case 6: // special.service_identity
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(ServiceIdentitySecret)
		err := b.DecodeMessage(msg)
		m.Special = &Secret_ServiceIdentity{msg}
		return true, err
	default:
		return false, nil
	}
...
func (m *Secret) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Special != nil {
		nn38, err := m.Special.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += nn38
...
func (m *Secret_PKI) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.PKI != nil {
		...
		n39, err := m.PKI.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n39
...
func (m *Secret_ServiceIdentity) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.ServiceIdentity != nil {
		...
		n40, err := m.ServiceIdentity.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n40
...
func (m *Secret) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			...
			m.Special = &Secret_ServiceIdentity{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipObjects(dAtA[iNdEx:])
...
var fileDescriptorObjects = []byte{
	...
	,
}
