...
type Node struct {
	...
	AvailableResources *Resources `protobuf:"bytes,11,opt,name=available_resources,json=availableResources" json:"available_resources,omitempty"`
}
...
func (m *Node) CopyFrom(src interface{}) {
	...
	*m = *o
	...
	if o.AvailableResources != nil {
		m.AvailableResources = &Resources{}
		github_com_docker_swarmkit_api_deepcopy.Copy(m.AvailableResources, o.AvailableResources)
	}
}
...
func (m *Node) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.AvailableResources != nil {
		dAtA[i] = 0x5a
		i++
		i = encodeVarintObjects(dAtA, i, uint64(m.AvailableResources.Size()))
		n11, err := m.AvailableResources.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n11
...
func (this *Node) String() string {
	...
	s := strings.Join([]string{`&Node{`,
		...
		`AvailableResources:` + strings.Replace(fmt.Sprintf("%v", this.AvailableResources), "Resources", "Resources", 1) + `,`,
		`}`,
	}, "")
	return s
}
...
var fileDescriptorObjects = []byte{
	...
	,
}
