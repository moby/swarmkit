...
func NodeCheckName(v1, v2 *Node) bool {
	...
	return v1.GetDescription().GetHostname() == v2.GetDescription().GetHostname()
}
...
func NodeCheckNamePrefix(v1, v2 *Node) bool {
	...
	return strings.HasPrefix(v2.GetDescription().GetHostname(), v1.GetDescription().GetHostname())
}
