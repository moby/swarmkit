...
func _Raft_ResolveAddress_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error) (interface{}, error) {
	in := new(ResolveAddressRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	out, err := srv.(RaftServer).ResolveAddress(ctx, in)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var fileDescriptorRaft = []byte{
	...
	,
}
