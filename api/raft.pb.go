...
type RaftMember struct {
	...
	// BackupAddrs provides addresses which might be used if main address is
	// unreachable. This is needed mostly for environments where there might be
	// short paths with different addresses (nat or whatever).
	BackupAddrs map[string]*google_protobuf.Timestamp `protobuf:"bytes,5,rep,name=backup_addrs,json=backupAddrs" json:"backup_addrs,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value"`
}
...
func (m *RaftMember) CopyFrom(src interface{}) {
	...
	*m = *o
	...
	if o.BackupAddrs != nil {
		m.BackupAddrs = make(map[string]*google_protobuf.Timestamp, len(o.BackupAddrs))
		for k, v := range o.BackupAddrs {
			m.BackupAddrs[k] = &google_protobuf.Timestamp{}
			github_com_docker_swarmkit_api_deepcopy.Copy(m.BackupAddrs[k], v)
		}
	}
...
func (m *RaftMember) MarshalTo(dAtA []byte) (int, error) {
	...
	i += n1
	if len(m.BackupAddrs) > 0 {
		for k, _ := range m.BackupAddrs {
			dAtA[i] = 0x2a
			i++
			v := m.BackupAddrs[k]
			msgSize := 0
			if v != nil {
				msgSize = v.Size()
				msgSize += 1 + sovRaft(uint64(msgSize))
			}
			mapSize := 1 + len(k) + sovRaft(uint64(len(k))) + msgSize
			...
			if v != nil {
				dAtA[i] = 0x12
				i++
				i = encodeVarintRaft(dAtA, i, uint64(v.Size()))
...
func (m *JoinResponse) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.RemovedMembers) > 0 {
		dAtA4 := make([]byte, len(m.RemovedMembers)*10)
		var j3 int
		...
		dAtA[i] = 0x1a
		i++
		i = encodeVarintRaft(dAtA, i, uint64(j3))
...
func (m *StoreAction) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Target != nil {
		nn7, err := m.Target.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += nn7
...
func (m *RaftMember) Size() (n int) {
	...
	n += 1 + l + sovRaft(uint64(l))
	if len(m.BackupAddrs) > 0 {
		for k, v := range m.BackupAddrs {
			_ = k
			_ = v
			l = 0
			if v != nil {
				l = v.Size()
				l += 1 + sovRaft(uint64(l))
			}
...
func (this *RaftMember) String() string {
	...
	keysForBackupAddrs := make([]string, 0, len(this.BackupAddrs))
	for k, _ := range this.BackupAddrs {
		keysForBackupAddrs = append(keysForBackupAddrs, k)
	}
	github_com_gogo_protobuf_sortkeys.Strings(keysForBackupAddrs)
	mapStringForBackupAddrs := "map[string]*google_protobuf.Timestamp{"
	for _, k := range keysForBackupAddrs {
		mapStringForBackupAddrs += fmt.Sprintf("%v: %v,", k, this.BackupAddrs[k])
	}
	mapStringForBackupAddrs += "}"
	s := strings.Join([]string{`&RaftMember{`,
		...
		`BackupAddrs:` + mapStringForBackupAddrs + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *RaftMember) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field BackupAddrs", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.BackupAddrs == nil {
				m.BackupAddrs = make(map[string]*google_protobuf.Timestamp)
			}
			if iNdEx < postIndex {
				var valuekey uint64
				for shift := uint(0); ; shift += 7 {
...
var fileDescriptorRaft = []byte{
	...
	,
}
