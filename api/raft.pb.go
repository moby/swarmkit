...
type StoreAction_DeviceClass struct {
	DeviceClass *DeviceClass `protobuf:"bytes,11,opt,name=deviceClass,oneof"`
}
...
func (*StoreAction_DeviceClass) isStoreAction_Target() {}
...
func (m *StoreAction) GetDeviceClass() *DeviceClass {
	if x, ok := m.GetTarget().(*StoreAction_DeviceClass); ok {
...
func _StoreAction_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	...
	case 10: // target.config
		...
		return true, err
	case 11: // target.deviceClass
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(DeviceClass)
		err := b.DecodeMessage(msg)
		m.Target = &StoreAction_DeviceClass{msg}
		return true, err
	default:
		return false, nil
	}
...
func (m *StoreAction_DeviceClass) MarshalTo(dAtA []byte) (int, error) {
	i := 0
	if m.DeviceClass != nil {
		dAtA[i] = 0x5a
		i++
		i = encodeVarintRaft(dAtA, i, uint64(m.DeviceClass.Size()))
		n15, err := m.DeviceClass.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n15
...
func (m *StoreAction_DeviceClass) Size() (n int) {
	var l int
	_ = l
	if m.DeviceClass != nil {
...
func (this *StoreAction_DeviceClass) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&StoreAction_DeviceClass{`,
...
func (m *StoreAction) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 11:
			...
			m.Target = &StoreAction_DeviceClass{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipRaft(dAtA[iNdEx:])
...
var fileDescriptorRaft = []byte{
	...
	,
}
