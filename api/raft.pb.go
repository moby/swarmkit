...
// skipping weak import docker_protobuf_plugin "plugin"
...
type LeaveRequest struct {
	Node RaftMember `protobuf:"bytes,1,opt,name=node" json:"node"`
}
...
type StoreAction struct {
	...
	//	*StoreAction_Network
	//	*StoreAction_Volume
	//	*StoreAction_RegisteredCertificate
	//	*StoreAction_Cluster
...
type StoreAction_RegisteredCertificate struct {
	RegisteredCertificate *RegisteredCertificate `protobuf:"bytes,7,opt,name=registered_certificate,json=registeredCertificate,oneof"`
}
type StoreAction_Cluster struct {
	Cluster *Cluster `protobuf:"bytes,8,opt,name=cluster,oneof"`
}
...
func (*StoreAction_RegisteredCertificate) isStoreAction_Target() {}
...
func (m *StoreAction) GetRegisteredCertificate() *RegisteredCertificate {
	if x, ok := m.GetTarget().(*StoreAction_RegisteredCertificate); ok {
		return x.RegisteredCertificate
	}
	return nil
}
...
func (*StoreAction) XXX_OneofFuncs() (func(msg proto.Message, b *proto.Buffer) error, func(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error), func(msg proto.Message) (n int), []interface{}) {
	return _StoreAction_OneofMarshaler, _StoreAction_OneofUnmarshaler, _StoreAction_OneofSizer, []interface{}{
		...
		(*StoreAction_RegisteredCertificate)(nil),
...
func _StoreAction_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	...
	case *StoreAction_RegisteredCertificate:
		_ = b.EncodeVarint(7<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.RegisteredCertificate); err != nil {
			return err
		}
...
func _StoreAction_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	...
	case 6: // target.volume
		...
		return true, err
	case 7: // target.registered_certificate
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(RegisteredCertificate)
		err := b.DecodeMessage(msg)
		m.Target = &StoreAction_RegisteredCertificate{msg}
		return true, err
	case 8: // target.cluster
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(Cluster)
...
func _StoreAction_OneofSizer(msg proto.Message) (n int) {
	...
	case *StoreAction_Volume:
		...
		n += s
	case *StoreAction_RegisteredCertificate:
		s := proto.Size(x.RegisteredCertificate)
...
func (m *StoreAction) Copy() *StoreAction {
	...
	case *StoreAction_Volume:
		...
		o.Target = i
	case *StoreAction_RegisteredCertificate:
		i := &StoreAction_RegisteredCertificate{
			RegisteredCertificate: m.GetRegisteredCertificate().Copy(),
		}
...
func (this *StoreAction_RegisteredCertificate) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&api.StoreAction_RegisteredCertificate{` +
		`RegisteredCertificate:` + fmt.Sprintf("%#v", this.RegisteredCertificate) + `}`}, ", ")
	return s
}
...
func (m *StoreAction_Volume) MarshalTo(data []byte) (int, error) {
	...
	if m.Volume != nil {
		...
		n8, err := m.Volume.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n8
...
func (m *StoreAction_RegisteredCertificate) MarshalTo(data []byte) (int, error) {
	i := 0
	if m.RegisteredCertificate != nil {
		data[i] = 0x3a
		i++
		i = encodeVarintRaft(data, i, uint64(m.RegisteredCertificate.Size()))
		n9, err := m.RegisteredCertificate.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n9
...
func NewRaftProxyRaftServer(local RaftServer, connSelector *raftpicker.ConnSelector, cluster raftpicker.RaftCluster, ctxMods ...func(context.Context) (context.Context, error)) RaftServer {
...
func (m *StoreAction_RegisteredCertificate) Size() (n int) {
	var l int
	_ = l
	if m.RegisteredCertificate != nil {
...
func (this *LeaveRequest) String() string {
	...
	s := strings.Join([]string{`&LeaveRequest{`,
		`Node:` + strings.Replace(strings.Replace(this.Node.String(), "RaftMember", "RaftMember", 1), `&`, ``, 1) + `,`,
		`}`,
	}, "")
	return s
}
...
func (this *StoreAction_RegisteredCertificate) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&StoreAction_RegisteredCertificate{`,
...
func (m *StoreAction) Unmarshal(data []byte) error {
	...
	for iNdEx < l {
		...
		case 7:
			...
			v := &RegisteredCertificate{}
			if err := v.Unmarshal(data[iNdEx:postIndex]); err != nil {
				return err
			}
			m.Target = &StoreAction_RegisteredCertificate{v}
			iNdEx = postIndex
		case 8:
			if wireType != 2 {
...
var fileDescriptorRaft = []byte{
	...
	,
}
