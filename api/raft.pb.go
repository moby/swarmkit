...
type JoinRequest struct {
	Node *Member `protobuf:"bytes,1,opt,name=node" json:"node,omitempty"`
}
...
func (m *JoinResponse) Copy() *JoinResponse {
	...
	if m.Members != nil {
		o.Members = make([]*Member, 0, len(m.Members))
...
func (m *StoreAction_RegisteredCertificate) MarshalTo(data []byte) (int, error) {
	...
	if m.RegisteredCertificate != nil {
		...
		n10, err := m.RegisteredCertificate.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n10
...
func (this *JoinRequest) String() string {
	...
	s := strings.Join([]string{`&JoinRequest{`,
		`Node:` + strings.Replace(fmt.Sprintf("%v", this.Node), "Member", "Member", 1) + `,`,
		`}`,
	}, "")
	return s
}
...
var fileDescriptorRaft = []byte{
	...
	,
}
