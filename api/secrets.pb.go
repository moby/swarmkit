...
type ListSecretsRequest_Filters struct {
	...
	Types        []SecretType `protobuf:"varint,5,rep,name=types,enum=docker.swarmkit.v1.SecretType" json:"types,omitempty"`
}
...
func (m *ListSecretsRequest_Filters) Copy() *ListSecretsRequest_Filters {
	...
	if m.Types != nil {
		o.Types = make([]SecretType, 0, len(m.Types))
...
func (m *ListSecretsRequest_Filters) MarshalTo(data []byte) (int, error) {
	...
	if len(m.Types) > 0 {
		for _, num := range m.Types {
			data[i] = 0x28
			i++
			i = encodeVarintSecrets(data, i, uint64(num))
		}
	}
	return i, nil
}
...
var fileDescriptorSecrets = []byte{
	...
	,
}
