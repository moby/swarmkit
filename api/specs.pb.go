...
type TaskSpec_Process struct {
	Process *ProcessSpec `protobuf:"bytes,10,opt,name=process,oneof"`
}

func (*TaskSpec_Attachment) isTaskSpec_Runtime() {}
func (*TaskSpec_Container) isTaskSpec_Runtime()  {}
func (*TaskSpec_Process) isTaskSpec_Runtime()    {}
...
func (m *TaskSpec) GetProcess() *ProcessSpec {
	if x, ok := m.GetRuntime().(*TaskSpec_Process); ok {
		return x.Process
	}
	return nil
}
...
func _TaskSpec_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	...
	case 1: // runtime.container
		...
		return true, err
	case 10: // runtime.process
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(ProcessSpec)
		err := b.DecodeMessage(msg)
		m.Runtime = &TaskSpec_Process{msg}
		return true, err
	default:
		return false, nil
	}
...
func (*ProcessSpec) Descriptor() ([]byte, []int) { return fileDescriptorSpecs, []int{7} }
...
func init() {
	...
	proto.RegisterType((*ProcessSpec)(nil), "docker.swarmkit.v1.ProcessSpec")
...
func (m *ProcessSpec) Copy() *ProcessSpec {
	if m == nil {
		return nil
	}
	...
	if m.Argv != nil {
		o.Argv = make([]string, 0, len(m.Argv))
		o.Argv = append(o.Argv, m.Argv...)
	}
...
func (this *TaskSpec_Process) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&api.TaskSpec_Process{` +
...
func (this *ProcessSpec) GoString() string {
	...
	s := make([]string, 0, 6)
	s = append(s, "&api.ProcessSpec{")
	s = append(s, "Annotations: "+strings.Replace(this.Annotations.GoString(), `&`, ``, 1)+",\n")
	s = append(s, "Argv: "+fmt.Sprintf("%#v", this.Argv)+",\n")
	s = append(s, "}")
	return strings.Join(s, "")
}
...
func (m *TaskSpec_Process) MarshalTo(data []byte) (int, error) {
	i := 0
	if m.Process != nil {
		data[i] = 0x52
		i++
		i = encodeVarintSpecs(data, i, uint64(m.Process.Size()))
		n16, err := m.Process.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n16
...
func (m *TaskSpec_Process) Size() (n int) {
	var l int
	_ = l
	if m.Process != nil {
		l = m.Process.Size()
...
func (this *TaskSpec_Process) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&TaskSpec_Process{`,
...
var fileDescriptorSpecs = []byte{
	...
	,
}
