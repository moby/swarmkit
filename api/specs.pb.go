...
// Templating controls whether the payload of a config or secret is evaluated
// as a template.
type Templating int32

const (
	Templating_NONE        Templating = 0
	Templating_GO_TEMPLATE Templating = 1
)

var Templating_name = map[int32]string{
	0: "NONE",
	1: "GO_TEMPLATE",
}
var Templating_value = map[string]int32{
	"NONE":        0,
	"GO_TEMPLATE": 1,
}

func (x Templating) String() string {
	return proto.EnumName(Templating_name, int32(x))
}
func (Templating) EnumDescriptor() ([]byte, []int) { return fileDescriptorSpecs, []int{0} }
...
type SecretSpec struct {
	...
	// a template.
	Templating Templating `protobuf:"varint,3,opt,name=templating,proto3,enum=docker.swarmkit.v1.Templating" json:"templating,omitempty"`
}
...
func init() {
	...
	proto.RegisterEnum("docker.swarmkit.v1.Templating", Templating_name, Templating_value)
...
func (m *SecretSpec) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Templating != 0 {
		dAtA[i] = 0x18
		i++
		i = encodeVarintSpecs(dAtA, i, uint64(m.Templating))
	}
	return i, nil
}
...
func (m *SecretSpec) Size() (n int) {
	...
	if m.Templating != 0 {
		n += 1 + sovSpecs(uint64(m.Templating))
	}
	return n
}
...
func (this *SecretSpec) String() string {
	...
	s := strings.Join([]string{`&SecretSpec{`,
		...
		`Templating:` + fmt.Sprintf("%v", this.Templating) + `,`,
		`}`,
	}, "")
	return s
}
	...
	for iNdEx < l {
		...
		case 3:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Templating |= (Templating(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
var fileDescriptorSpecs = []byte{
	...
	,
}
