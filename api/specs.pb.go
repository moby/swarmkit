...
func (m *TaskSpec) MarshalTo(data []byte) (int, error) {
	...
	_ = l
	if m.Runtime != nil {
		nn5, err := m.Runtime.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += nn5
...
func (m *VolumeSpec) MarshalTo(data []byte) (int, error) {
	...
	i++
	i = encodeVarintSpecs(data, i, uint64(m.Annotations.Size()))
	n7, err := m.Annotations.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n7
	if m.DriverConfiguration != nil {
		...
		n8, err := m.DriverConfiguration.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n8
...
func (m *NetworkSpec) MarshalTo(data []byte) (int, error) {
	...
	if m.DriverConfiguration != nil {
		...
		i++
		i = encodeVarintSpecs(data, i, uint64(m.DriverConfiguration.Size()))
		n10, err := m.DriverConfiguration.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n10
	...
	if m.IPAM != nil {
		...
		n11, err := m.IPAM.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n11
...
var fileDescriptorSpecs = []byte{
	...
	,
}
