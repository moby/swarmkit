...
import docker_swarmkit_v1_descriptor "github.com/docker/swarmkit/api/descriptor"
...
type IndexDeclaration struct {
	// Key is the name of this index. It can be chosen arbitrarily.
	Key string `protobuf:"bytes,1,opt,name=key,proto3" json:"key,omitempty"`
	// Field is the dot-separated field path which should be used to find
	// the value corresponding to this index.
	// TODO(aaronl): Ideally, this should be expressed with Go templates,
	// potentially allowing multiple extracted values to be combined as
	// an index value.
	Field string `protobuf:"bytes,2,opt,name=field,proto3" json:"field,omitempty"`
}

func (m *IndexDeclaration) Reset()                    { *m = IndexDeclaration{} }
func (*IndexDeclaration) ProtoMessage()               {}
func (*IndexDeclaration) Descriptor() ([]byte, []int) { return fileDescriptorSpecs, []int{13} }

// IndexSpec provides instructions for automatically indexing stored objects.
type IndexSpec struct {
	// Indices
	// In each entry, Key is the index key, and Val is
	// TODO(aaronl): Express the values as Go templates instead of just a
	// fully-qualified field path.
	Indices []*IndexDeclaration `protobuf:"bytes,1,rep,name=indices" json:"indices,omitempty"`
	// Types that are valid to be assigned to Schema:
	//	*IndexSpec_Protobuf
	Schema isIndexSpec_Schema `protobuf_oneof:"Schema"`
}

func (m *IndexSpec) Reset()                    { *m = IndexSpec{} }
func (*IndexSpec) ProtoMessage()               {}
func (*IndexSpec) Descriptor() ([]byte, []int) { return fileDescriptorSpecs, []int{14} }

type isIndexSpec_Schema interface {
	isIndexSpec_Schema()
	MarshalTo([]byte) (int, error)
	Size() int
}

type IndexSpec_Protobuf struct {
	Protobuf *IndexSpec_ProtobufSchema `protobuf:"bytes,2,opt,name=protobuf,oneof"`
}

func (*IndexSpec_Protobuf) isIndexSpec_Schema() {}

func (m *IndexSpec) GetSchema() isIndexSpec_Schema {
	if m != nil {
		return m.Schema
	}
	return nil
...
func (m *IndexSpec) GetProtobuf() *IndexSpec_ProtobufSchema {
	if x, ok := m.GetSchema().(*IndexSpec_Protobuf); ok {
		return x.Protobuf
	}
	return nil
}
...
// XXX_OneofFuncs is for the internal use of the proto package.
func (*IndexSpec) XXX_OneofFuncs() (func(msg proto.Message, b *proto.Buffer) error, func(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error), func(msg proto.Message) (n int), []interface{}) {
	return _IndexSpec_OneofMarshaler, _IndexSpec_OneofUnmarshaler, _IndexSpec_OneofSizer, []interface{}{
		(*IndexSpec_Protobuf)(nil),
	}
}

func _IndexSpec_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	m := msg.(*IndexSpec)
	// Schema
	switch x := m.Schema.(type) {
	case *IndexSpec_Protobuf:
		_ = b.EncodeVarint(2<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.Protobuf); err != nil {
			return err
		}
	case nil:
	default:
		return fmt.Errorf("IndexSpec.Schema has unexpected type %T", x)
	}
	return nil
}

func _IndexSpec_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	m := msg.(*IndexSpec)
	switch tag {
	case 2: // Schema.protobuf
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(IndexSpec_ProtobufSchema)
		err := b.DecodeMessage(msg)
		m.Schema = &IndexSpec_Protobuf{msg}
		return true, err
	default:
		return false, nil
	}
...
func _IndexSpec_OneofSizer(msg proto.Message) (n int) {
	m := msg.(*IndexSpec)
	// Schema
	switch x := m.Schema.(type) {
	case *IndexSpec_Protobuf:
		s := proto.Size(x.Protobuf)
...
type IndexSpec_ProtobufSchema struct {
	// FIXME(aaronl): Forking this is highly unfortunate, but gogo
	// internals import the original version, and trying to import
	// our own copy under the same name would cause duplicate
	// registrations.
	DescriptorSet *docker_swarmkit_v1_descriptor.FileDescriptorSet `protobuf:"bytes,1,opt,name=descriptor_set,json=descriptorSet" json:"descriptor_set,omitempty"`
	// Fully qualified type name
	Type string `protobuf:"bytes,2,opt,name=type,proto3" json:"type,omitempty"`
}

func (m *IndexSpec_ProtobufSchema) Reset()      { *m = IndexSpec_ProtobufSchema{} }
func (*IndexSpec_ProtobufSchema) ProtoMessage() {}
func (*IndexSpec_ProtobufSchema) Descriptor() ([]byte, []int) {
	return fileDescriptorSpecs, []int{14, 0}
}
...
func init() {
	...
	proto.RegisterType((*IndexDeclaration)(nil), "docker.swarmkit.v1.IndexDeclaration")
	proto.RegisterType((*IndexSpec)(nil), "docker.swarmkit.v1.IndexSpec")
	proto.RegisterType((*IndexSpec_ProtobufSchema)(nil), "docker.swarmkit.v1.IndexSpec.ProtobufSchema")
...
func (m *IndexDeclaration) Copy() *IndexDeclaration {
	if m == nil {
		return nil
	}
	o := &IndexDeclaration{}
...
func (m *IndexDeclaration) CopyFrom(src interface{}) {

	o := src.(*IndexDeclaration)
	*m = *o
}

func (m *IndexSpec) Copy() *IndexSpec {
	if m == nil {
		return nil
	}
	o := &IndexSpec{}
...
func (m *IndexSpec) CopyFrom(src interface{}) {

	o := src.(*IndexSpec)
	*m = *o
	if o.Indices != nil {
		m.Indices = make([]*IndexDeclaration, len(o.Indices))
		for i := range m.Indices {
			m.Indices[i] = &IndexDeclaration{}
	...
	if o.Schema != nil {
		...
		case *IndexSpec_Protobuf:
			v := IndexSpec_Protobuf{
				Protobuf: &IndexSpec_ProtobufSchema{},
			}
			github_com_docker_swarmkit_api_deepcopy.Copy(v.Protobuf, o.GetProtobuf())
			m.Schema = &v
		}
	}
...
func (m *IndexSpec_ProtobufSchema) Copy() *IndexSpec_ProtobufSchema {
	if m == nil {
		return nil
	}
	o := &IndexSpec_ProtobufSchema{}
	o.CopyFrom(m)
	return o
}

func (m *IndexSpec_ProtobufSchema) CopyFrom(src interface{}) {

	o := src.(*IndexSpec_ProtobufSchema)
	*m = *o
	if o.DescriptorSet != nil {
		m.DescriptorSet = &docker_swarmkit_v1_descriptor.FileDescriptorSet{}
		github_com_docker_swarmkit_api_deepcopy.Copy(m.DescriptorSet, o.DescriptorSet)
	}
}
...
func (m *IndexDeclaration) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *IndexDeclaration) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	...
	if len(m.Field) > 0 {
		dAtA[i] = 0x12
		i++
		i = encodeVarintSpecs(dAtA, i, uint64(len(m.Field)))
...
func (m *IndexSpec) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Schema != nil {
		nn38, err := m.Schema.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += nn38
...
func (m *IndexSpec_Protobuf) MarshalTo(dAtA []byte) (int, error) {
	i := 0
	if m.Protobuf != nil {
		dAtA[i] = 0x12
		i++
		i = encodeVarintSpecs(dAtA, i, uint64(m.Protobuf.Size()))
		n39, err := m.Protobuf.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n39
...
func (m *IndexSpec_ProtobufSchema) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *IndexSpec_ProtobufSchema) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	if m.DescriptorSet != nil {
		dAtA[i] = 0xa
		i++
		i = encodeVarintSpecs(dAtA, i, uint64(m.DescriptorSet.Size()))
		n40, err := m.DescriptorSet.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n40
	...
	if len(m.Type) > 0 {
		dAtA[i] = 0x12
		i++
		i = encodeVarintSpecs(dAtA, i, uint64(len(m.Type)))
...
func (m *IndexDeclaration) Size() (n int) {
	var l int
	_ = l
	l = len(m.Key)
	if l > 0 {
...
func (m *IndexSpec_Protobuf) Size() (n int) {
	var l int
	_ = l
	if m.Protobuf != nil {
		l = m.Protobuf.Size()
...
func (m *IndexSpec_ProtobufSchema) Size() (n int) {
	var l int
	_ = l
	if m.DescriptorSet != nil {
		l = m.DescriptorSet.Size()
		n += 1 + l + sovSpecs(uint64(l))
	}
	l = len(m.Type)
	if l > 0 {
...
func (this *IndexDeclaration) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&IndexDeclaration{`,
...
func (this *IndexSpec) String() string {
	...
	s := strings.Join([]string{`&IndexSpec{`,
		`Indices:` + strings.Replace(fmt.Sprintf("%v", this.Indices), "IndexDeclaration", "IndexDeclaration", 1) + `,`,
		`Schema:` + fmt.Sprintf("%v", this.Schema) + `,`,
		`}`,
	}, "")
	return s
}
func (this *IndexSpec_Protobuf) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&IndexSpec_Protobuf{`,
		`Protobuf:` + strings.Replace(fmt.Sprintf("%v", this.Protobuf), "IndexSpec_ProtobufSchema", "IndexSpec_ProtobufSchema", 1) + `,`,
		`}`,
	}, "")
	return s
}
func (this *IndexSpec_ProtobufSchema) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&IndexSpec_ProtobufSchema{`,
		`DescriptorSet:` + strings.Replace(fmt.Sprintf("%v", this.DescriptorSet), "FileDescriptorSet", "docker_swarmkit_v1_descriptor.FileDescriptorSet", 1) + `,`,
...
func (m *IndexDeclaration) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: IndexDeclaration: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: IndexDeclaration: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *IndexSpec) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.Indices = append(m.Indices, &IndexDeclaration{})
		...
		case 2:
			...
			v := &IndexSpec_ProtobufSchema{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.Schema = &IndexSpec_Protobuf{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipSpecs(dAtA[iNdEx:])
...
func (m *IndexSpec_ProtobufSchema) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		case 1:
			...
			if err := m.DescriptorSet.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 2:
...
var fileDescriptorSpecs = []byte{
	...
	,
}
