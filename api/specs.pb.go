...
type ContainerSpec struct {
	...
	CredentialSpec *ContainerSpec_CredentialSpec `protobuf:"bytes,21,opt,name=credential_spec,json=credentialSpec" json:"credential_spec,omitempty"`
...
type ContainerSpec_CredentialSpec struct {
	// Types that are valid to be assigned to Source:
	//	*ContainerSpec_CredentialSpec_File
	//	*ContainerSpec_CredentialSpec_Registry
	Source isContainerSpec_CredentialSpec_Source `protobuf_oneof:"source"`
}

func (m *ContainerSpec_CredentialSpec) Reset()      { *m = ContainerSpec_CredentialSpec{} }
func (*ContainerSpec_CredentialSpec) ProtoMessage() {}
func (*ContainerSpec_CredentialSpec) Descriptor() ([]byte, []int) {
	return fileDescriptorSpecs, []int{7, 1}
}

type isContainerSpec_CredentialSpec_Source interface {
	isContainerSpec_CredentialSpec_Source()
	MarshalTo([]byte) (int, error)
	Size() int
}

type ContainerSpec_CredentialSpec_File struct {
	File *ContainerSpec_CredentialSpec_FileCredentialSpec `protobuf:"bytes,1,opt,name=file,oneof"`
}
type ContainerSpec_CredentialSpec_Registry struct {
	Registry *ContainerSpec_CredentialSpec_RegistryCredentialSpec `protobuf:"bytes,2,opt,name=registry,oneof"`
}

func (*ContainerSpec_CredentialSpec_File) isContainerSpec_CredentialSpec_Source()     {}
func (*ContainerSpec_CredentialSpec_Registry) isContainerSpec_CredentialSpec_Source() {}

func (m *ContainerSpec_CredentialSpec) GetSource() isContainerSpec_CredentialSpec_Source {
	if m != nil {
		return m.Source
	}
	return nil
...
func (m *ContainerSpec_CredentialSpec) GetFile() *ContainerSpec_CredentialSpec_FileCredentialSpec {
	if x, ok := m.GetSource().(*ContainerSpec_CredentialSpec_File); ok {
		return x.File
	}
	return nil
}

func (m *ContainerSpec_CredentialSpec) GetRegistry() *ContainerSpec_CredentialSpec_RegistryCredentialSpec {
	if x, ok := m.GetSource().(*ContainerSpec_CredentialSpec_Registry); ok {
		return x.Registry
	}
	return nil
}
...
// XXX_OneofFuncs is for the internal use of the proto package.
func (*ContainerSpec_CredentialSpec) XXX_OneofFuncs() (func(msg proto.Message, b *proto.Buffer) error, func(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error), func(msg proto.Message) (n int), []interface{}) {
	return _ContainerSpec_CredentialSpec_OneofMarshaler, _ContainerSpec_CredentialSpec_OneofUnmarshaler, _ContainerSpec_CredentialSpec_OneofSizer, []interface{}{
		(*ContainerSpec_CredentialSpec_File)(nil),
		(*ContainerSpec_CredentialSpec_Registry)(nil),
	}
}

func _ContainerSpec_CredentialSpec_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	m := msg.(*ContainerSpec_CredentialSpec)
	// source
	switch x := m.Source.(type) {
	case *ContainerSpec_CredentialSpec_File:
		_ = b.EncodeVarint(1<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.File); err != nil {
			return err
		}
	case *ContainerSpec_CredentialSpec_Registry:
		_ = b.EncodeVarint(2<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.Registry); err != nil {
			return err
		}
	case nil:
	default:
		return fmt.Errorf("ContainerSpec_CredentialSpec.Source has unexpected type %T", x)
	}
	return nil
}

func _ContainerSpec_CredentialSpec_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	m := msg.(*ContainerSpec_CredentialSpec)
	switch tag {
	case 1: // source.file
		if wire != proto.WireBytes {
		...
		msg := new(ContainerSpec_CredentialSpec_FileCredentialSpec)
		err := b.DecodeMessage(msg)
		m.Source = &ContainerSpec_CredentialSpec_File{msg}
		return true, err
	case 2: // source.registry
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(ContainerSpec_CredentialSpec_RegistryCredentialSpec)
		err := b.DecodeMessage(msg)
		m.Source = &ContainerSpec_CredentialSpec_Registry{msg}
		return true, err
	default:
		return false, nil
	}
...
func _ContainerSpec_CredentialSpec_OneofSizer(msg proto.Message) (n int) {
	m := msg.(*ContainerSpec_CredentialSpec)
	// source
	switch x := m.Source.(type) {
	case *ContainerSpec_CredentialSpec_File:
...
type ContainerSpec_CredentialSpec_FileCredentialSpec struct {
	Path string `protobuf:"bytes,1,opt,name=path,proto3" json:"path,omitempty"`
}

func (m *ContainerSpec_CredentialSpec_FileCredentialSpec) Reset() {
	*m = ContainerSpec_CredentialSpec_FileCredentialSpec{}
}
func (*ContainerSpec_CredentialSpec_FileCredentialSpec) ProtoMessage() {}
func (*ContainerSpec_CredentialSpec_FileCredentialSpec) Descriptor() ([]byte, []int) {
	return fileDescriptorSpecs, []int{7, 1, 0}
}

type ContainerSpec_CredentialSpec_RegistryCredentialSpec struct {
	Key string `protobuf:"bytes,1,opt,name=key,proto3" json:"key,omitempty"`
}

func (m *ContainerSpec_CredentialSpec_RegistryCredentialSpec) Reset() {
	*m = ContainerSpec_CredentialSpec_RegistryCredentialSpec{}
}
func (*ContainerSpec_CredentialSpec_RegistryCredentialSpec) ProtoMessage() {}
func (*ContainerSpec_CredentialSpec_RegistryCredentialSpec) Descriptor() ([]byte, []int) {
	return fileDescriptorSpecs, []int{7, 1, 1}
}
...
func (*ContainerSpec_PullOptions) Descriptor() ([]byte, []int) {
	return fileDescriptorSpecs, []int{7, 2}
}
...
func (*ContainerSpec_DNSConfig) Descriptor() ([]byte, []int) { return fileDescriptorSpecs, []int{7, 3} }
...
func init() {
	...
	proto.RegisterType((*ContainerSpec_CredentialSpec)(nil), "docker.swarmkit.v1.ContainerSpec.CredentialSpec")
	proto.RegisterType((*ContainerSpec_CredentialSpec_FileCredentialSpec)(nil), "docker.swarmkit.v1.ContainerSpec.CredentialSpec.FileCredentialSpec")
	proto.RegisterType((*ContainerSpec_CredentialSpec_RegistryCredentialSpec)(nil), "docker.swarmkit.v1.ContainerSpec.CredentialSpec.RegistryCredentialSpec")
...
func (m *ContainerSpec) CopyFrom(src interface{}) {
	...
	*m = *o
	...
	if o.CredentialSpec != nil {
		m.CredentialSpec = &ContainerSpec_CredentialSpec{}
...
func (m *ContainerSpec_CredentialSpec) Copy() *ContainerSpec_CredentialSpec {
	if m == nil {
		return nil
	}
	o := &ContainerSpec_CredentialSpec{}
	o.CopyFrom(m)
	return o
}

func (m *ContainerSpec_CredentialSpec) CopyFrom(src interface{}) {

	o := src.(*ContainerSpec_CredentialSpec)
	*m = *o
	if o.Source != nil {
		switch o.Source.(type) {
		case *ContainerSpec_CredentialSpec_File:
			v := ContainerSpec_CredentialSpec_File{
				File: &ContainerSpec_CredentialSpec_FileCredentialSpec{},
			}
			github_com_docker_swarmkit_api_deepcopy.Copy(v.File, o.GetFile())
			m.Source = &v
		case *ContainerSpec_CredentialSpec_Registry:
			v := ContainerSpec_CredentialSpec_Registry{
				Registry: &ContainerSpec_CredentialSpec_RegistryCredentialSpec{},
			}
			github_com_docker_swarmkit_api_deepcopy.Copy(v.Registry, o.GetRegistry())
			m.Source = &v
		}
	}
...
func (m *ContainerSpec_CredentialSpec_FileCredentialSpec) Copy() *ContainerSpec_CredentialSpec_FileCredentialSpec {
	if m == nil {
		return nil
	}
	o := &ContainerSpec_CredentialSpec_FileCredentialSpec{}
	o.CopyFrom(m)
	return o
}

func (m *ContainerSpec_CredentialSpec_FileCredentialSpec) CopyFrom(src interface{}) {

	o := src.(*ContainerSpec_CredentialSpec_FileCredentialSpec)
	*m = *o
}

func (m *ContainerSpec_CredentialSpec_RegistryCredentialSpec) Copy() *ContainerSpec_CredentialSpec_RegistryCredentialSpec {
	if m == nil {
		return nil
	}
	o := &ContainerSpec_CredentialSpec_RegistryCredentialSpec{}
	o.CopyFrom(m)
	return o
}

func (m *ContainerSpec_CredentialSpec_RegistryCredentialSpec) CopyFrom(src interface{}) {

	o := src.(*ContainerSpec_CredentialSpec_RegistryCredentialSpec)
	*m = *o
}
...
func (m *ContainerSpec) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.CredentialSpec != nil {
		...
		dAtA[i] = 0x1
		i++
		i = encodeVarintSpecs(dAtA, i, uint64(m.CredentialSpec.Size()))
		n23, err := m.CredentialSpec.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n23
...
func (m *ContainerSpec_CredentialSpec) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *ContainerSpec_CredentialSpec) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	if m.Source != nil {
		nn24, err := m.Source.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += nn24
...
func (m *ContainerSpec_CredentialSpec_File) MarshalTo(dAtA []byte) (int, error) {
	i := 0
	if m.File != nil {
		dAtA[i] = 0xa
		i++
		i = encodeVarintSpecs(dAtA, i, uint64(m.File.Size()))
		n25, err := m.File.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n25
...
func (m *ContainerSpec_CredentialSpec_Registry) MarshalTo(dAtA []byte) (int, error) {
	i := 0
	if m.Registry != nil {
		dAtA[i] = 0x12
		i++
		i = encodeVarintSpecs(dAtA, i, uint64(m.Registry.Size()))
		n26, err := m.Registry.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n26
...
func (m *ContainerSpec_CredentialSpec_FileCredentialSpec) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *ContainerSpec_CredentialSpec_FileCredentialSpec) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	if len(m.Path) > 0 {
		dAtA[i] = 0xa
		i++
		i = encodeVarintSpecs(dAtA, i, uint64(len(m.Path)))
		i += copy(dAtA[i:], m.Path)
	}
	return i, nil
}

func (m *ContainerSpec_CredentialSpec_RegistryCredentialSpec) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *ContainerSpec_CredentialSpec_RegistryCredentialSpec) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	if len(m.Key) > 0 {
		dAtA[i] = 0xa
		i++
		i = encodeVarintSpecs(dAtA, i, uint64(len(m.Key)))
		i += copy(dAtA[i:], m.Key)
	}
	return i, nil
}
...
func (m *ContainerSpec_CredentialSpec) Size() (n int) {
	var l int
	_ = l
	if m.Source != nil {
		n += m.Source.Size()
...
func (m *ContainerSpec_CredentialSpec_File) Size() (n int) {
	var l int
	_ = l
	if m.File != nil {
		l = m.File.Size()
...
func (m *ContainerSpec_CredentialSpec_Registry) Size() (n int) {
	var l int
	_ = l
	if m.Registry != nil {
		l = m.Registry.Size()
...
func (m *ContainerSpec_CredentialSpec_FileCredentialSpec) Size() (n int) {
	var l int
	_ = l
	l = len(m.Path)
	if l > 0 {
...
func (m *ContainerSpec_CredentialSpec_RegistryCredentialSpec) Size() (n int) {
	var l int
	_ = l
	l = len(m.Key)
	if l > 0 {
...
func (this *ContainerSpec) String() string {
	...
	s := strings.Join([]string{`&ContainerSpec{`,
		...
		`CredentialSpec:` + strings.Replace(fmt.Sprintf("%v", this.CredentialSpec), "ContainerSpec_CredentialSpec", "ContainerSpec_CredentialSpec", 1) + `,`,
		`}`,
	}, "")
	return s
}
func (this *ContainerSpec_CredentialSpec) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&ContainerSpec_CredentialSpec{`,
		`Source:` + fmt.Sprintf("%v", this.Source) + `,`,
		`}`,
	}, "")
	return s
}
func (this *ContainerSpec_CredentialSpec_File) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&ContainerSpec_CredentialSpec_File{`,
		`File:` + strings.Replace(fmt.Sprintf("%v", this.File), "ContainerSpec_CredentialSpec_FileCredentialSpec", "ContainerSpec_CredentialSpec_FileCredentialSpec", 1) + `,`,
		`}`,
	}, "")
	return s
}
func (this *ContainerSpec_CredentialSpec_Registry) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&ContainerSpec_CredentialSpec_Registry{`,
		`Registry:` + strings.Replace(fmt.Sprintf("%v", this.Registry), "ContainerSpec_CredentialSpec_RegistryCredentialSpec", "ContainerSpec_CredentialSpec_RegistryCredentialSpec", 1) + `,`,
		`}`,
	}, "")
	return s
}
func (this *ContainerSpec_CredentialSpec_FileCredentialSpec) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&ContainerSpec_CredentialSpec_FileCredentialSpec{`,
		`Path:` + fmt.Sprintf("%v", this.Path) + `,`,
		`}`,
	}, "")
	return s
}
func (this *ContainerSpec_CredentialSpec_RegistryCredentialSpec) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&ContainerSpec_CredentialSpec_RegistryCredentialSpec{`,
...
func (m *ContainerSpec_CredentialSpec) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		case 1:
			...
			v := &ContainerSpec_CredentialSpec_FileCredentialSpec{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.Source = &ContainerSpec_CredentialSpec_File{v}
			iNdEx = postIndex
		case 2:
			if wireType != 2 {
			...
			v := &ContainerSpec_CredentialSpec_RegistryCredentialSpec{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.Source = &ContainerSpec_CredentialSpec_Registry{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipSpecs(dAtA[iNdEx:])
...
func (m *ContainerSpec_CredentialSpec_FileCredentialSpec) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: FileCredentialSpec: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: FileCredentialSpec: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *ContainerSpec_CredentialSpec_RegistryCredentialSpec) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: RegistryCredentialSpec: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: RegistryCredentialSpec: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
var fileDescriptorSpecs = []byte{
	...
	,
}
