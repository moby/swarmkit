...
type TaskSpec struct {
	...
	//
	// ResourceReferences is a list of Resource IDs used by the task.
	ResourceReferences []string `protobuf:"bytes,11,rep,name=resource_references,json=resourceReferences" json:"resource_references,omitempty"`
}
...
func (m *TaskSpec) CopyFrom(src interface{}) {
	...
	*m = *o
	...
	if o.ResourceReferences != nil {
		m.ResourceReferences = make([]string, len(o.ResourceReferences))
		copy(m.ResourceReferences, o.ResourceReferences)
	}
...
func (m *TaskSpec) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.ResourceReferences) > 0 {
		for _, s := range m.ResourceReferences {
			dAtA[i] = 0x5a
			i++
			l = len(s)
			for l >= 1<<7 {
...
func (this *TaskSpec) String() string {
	...
	s := strings.Join([]string{`&TaskSpec{`,
		...
		`ResourceReferences:` + fmt.Sprintf("%v", this.ResourceReferences) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *TaskSpec) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 11:
			...
			m.ResourceReferences = append(m.ResourceReferences, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipSpecs(dAtA[iNdEx:])
...
var fileDescriptorSpecs = []byte{
	...
	,
}
