...
type ServiceSpec struct {
	...
	Update *UpdateConfiguration `protobuf:"bytes,7,opt,name=update" json:"update,omitempty"`
...
func (this *ServiceSpec) String() string {
	...
	s := strings.Join([]string{`&ServiceSpec{`,
		...
		`Update:` + strings.Replace(fmt.Sprintf("%v", this.Update), "UpdateConfiguration", "UpdateConfiguration", 1) + `,`,
...
var fileDescriptorSpecs = []byte{
	...
	,
}
