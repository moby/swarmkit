...
// CNMNetworkSpec specifies user defined network parameters for CNM networks
type CNMNetworkSpec struct {
	// DriverConfig specific configuration consumed by the network driver.
	DriverConfig *Driver `protobuf:"bytes,1,opt,name=driver_config,json=driverConfig" json:"driver_config,omitempty"`
	...
	IPAM     *IPAMOptions `protobuf:"bytes,4,opt,name=ipam" json:"ipam,omitempty"`
...
func (m *CNMNetworkSpec) Reset()                    { *m = CNMNetworkSpec{} }
func (*CNMNetworkSpec) ProtoMessage()               {}
func (*CNMNetworkSpec) Descriptor() ([]byte, []int) { return fileDescriptorSpecs, []int{9} }

// NetworkSpec specifies user defined network parameters.  All fields
// with a cnm_compat_ (CNMCompat in go) prefix are deprecated and the
// contents of the `backend` oneof will be preferred if present.
type NetworkSpec struct {
	Annotations Annotations `protobuf:"bytes,1,opt,name=annotations" json:"annotations"`
	// CNMCompatDriverConfig (deprecated) specific configuration consumed by the network driver.
	CNMCompatDriverConfig *Driver `protobuf:"bytes,2,opt,name=cnm_compat_driver_config,json=cnmCompatDriverConfig" json:"cnm_compat_driver_config,omitempty"`
	// CNMCompatIpv6Enabled (deprecated) enables support for IPv6 on the network.
	CNMCompatIpv6Enabled bool `protobuf:"varint,3,opt,name=cnm_compat_ipv6_enabled,json=cnmCompatIpv6Enabled,proto3" json:"cnm_compat_ipv6_enabled,omitempty"`
	// CNMCompatInternal (deprecated) restricts external access to
	// the network. This may be accomplished by disabling the
	// default gateway or through other means.
	CNMCompatInternal bool `protobuf:"varint,4,opt,name=cnm_compat_internal,json=cnmCompatInternal,proto3" json:"cnm_compat_internal,omitempty"`
	// CNMCompatIPAM (deprecated)
	CNMCompatIPAM *IPAMOptions `protobuf:"bytes,5,opt,name=cnm_compat_ipam,json=cnmCompatIpam" json:"cnm_compat_ipam,omitempty"`
	// CNMCompatAttachable (deprecated) allows external(to swarm)
	// entities to manually attach to this network. With this flag
	// enabled, external entities such as containers running in an
	// worker node in the cluster can manually attach to this
	// network and access the services attached to this
	// network. If this flag is not enabled(default case) no
	// manual attachment to this network can happen.
	CNMCompatAttachable bool `protobuf:"varint,6,opt,name=cnm_compat_attachable,json=cnmCompatAttachable,proto3" json:"cnm_compat_attachable,omitempty"`
	// CNMCompatIngress (deprecated) indicates this network will
	// provide the routing-mesh.  In older versions, the network
	// providing the routing mesh was swarm internally created
	// only and it was identified by the name "ingress" and the
	// label "com.docker.swarm.internal": "true".
	CNMCompatIngress bool `protobuf:"varint,7,opt,name=cnm_compat_ingress,json=cnmCompatIngress,proto3" json:"cnm_compat_ingress,omitempty"`
	// Backend specific options
	//
	// Types that are valid to be assigned to Backend:
	//	*NetworkSpec_CNM
	Backend isNetworkSpec_Backend `protobuf_oneof:"backend"`
}
...
type isNetworkSpec_Backend interface {
	isNetworkSpec_Backend()
	MarshalTo([]byte) (int, error)
	Size() int
}

type NetworkSpec_CNM struct {
	CNM *CNMNetworkSpec `protobuf:"bytes,8,opt,name=cnm,oneof"`
}

func (*NetworkSpec_CNM) isNetworkSpec_Backend() {}

func (m *NetworkSpec) GetBackend() isNetworkSpec_Backend {
	if m != nil {
		return m.Backend
	}
	return nil
...
func (m *NetworkSpec) GetCNM() *CNMNetworkSpec {
	if x, ok := m.GetBackend().(*NetworkSpec_CNM); ok {
		return x.CNM
	}
	return nil
}
...
func _NetworkSpec_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	...
	case *NetworkSpec_CNM:
		_ = b.EncodeVarint(8<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.CNM); err != nil {
			return err
		}
	case nil:
	default:
		return fmt.Errorf("NetworkSpec.Backend has unexpected type %T", x)
	}
	return nil
}
...
func _NetworkSpec_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	...
	case 8: // backend.cnm
		...
		msg := new(CNMNetworkSpec)
		err := b.DecodeMessage(msg)
		m.Backend = &NetworkSpec_CNM{msg}
		return true, err
	default:
		return false, nil
	}
...
func init() {
	...
	proto.RegisterType((*CNMNetworkSpec)(nil), "docker.swarmkit.v1.CNMNetworkSpec")
...
func (m *CNMNetworkSpec) Copy() *CNMNetworkSpec {
	if m == nil {
		return nil
	}
	o := &CNMNetworkSpec{}
...
func (m *CNMNetworkSpec) CopyFrom(src interface{}) {

	o := src.(*CNMNetworkSpec)
	*m = *o
...
func (m *NetworkSpec) CopyFrom(src interface{}) {
	...
	*m = *o
	github_com_docker_swarmkit_api_deepcopy.Copy(&m.Annotations, &o.Annotations)
	if o.CNMCompatDriverConfig != nil {
		m.CNMCompatDriverConfig = &Driver{}
		github_com_docker_swarmkit_api_deepcopy.Copy(m.CNMCompatDriverConfig, o.CNMCompatDriverConfig)
	}
	if o.CNMCompatIPAM != nil {
		m.CNMCompatIPAM = &IPAMOptions{}
		github_com_docker_swarmkit_api_deepcopy.Copy(m.CNMCompatIPAM, o.CNMCompatIPAM)
	}
	if o.Backend != nil {
		...
		case *NetworkSpec_CNM:
			...
			github_com_docker_swarmkit_api_deepcopy.Copy(v.CNM, o.GetCNM())
			m.Backend = &v
		}
	}
...
func (m *CNMNetworkSpec) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *CNMNetworkSpec) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *NetworkSpec) MarshalTo(dAtA []byte) (int, error) {
	...
	i += n26
	if m.CNMCompatDriverConfig != nil {
		dAtA[i] = 0x12
		i++
		i = encodeVarintSpecs(dAtA, i, uint64(m.CNMCompatDriverConfig.Size()))
		n27, err := m.CNMCompatDriverConfig.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n27
	}
	if m.CNMCompatIpv6Enabled {
		dAtA[i] = 0x18
		i++
		if m.CNMCompatIpv6Enabled {
			dAtA[i] = 1
	...
	if m.CNMCompatIPAM != nil {
		dAtA[i] = 0x2a
		i++
		i = encodeVarintSpecs(dAtA, i, uint64(m.CNMCompatIPAM.Size()))
		n28, err := m.CNMCompatIPAM.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n28
	}
	if m.CNMCompatAttachable {
		dAtA[i] = 0x30
		i++
		if m.CNMCompatAttachable {
			dAtA[i] = 1
	...
	if m.Backend != nil {
		nn29, err := m.Backend.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += nn29
...
func (m *NetworkSpec_CNM) MarshalTo(dAtA []byte) (int, error) {
	i := 0
	if m.CNM != nil {
		dAtA[i] = 0x42
		i++
		i = encodeVarintSpecs(dAtA, i, uint64(m.CNM.Size()))
		n30, err := m.CNM.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n30
...
func (m *CNMNetworkSpec) Size() (n int) {
	var l int
	_ = l
	if m.DriverConfig != nil {
...
func (m *NetworkSpec) Size() (n int) {
	...
	n += 1 + l + sovSpecs(uint64(l))
	if m.CNMCompatDriverConfig != nil {
		l = m.CNMCompatDriverConfig.Size()
		n += 1 + l + sovSpecs(uint64(l))
	}
	if m.CNMCompatIpv6Enabled {
		n += 2
...
func (m *NetworkSpec_CNM) Size() (n int) {
	var l int
	_ = l
	if m.CNM != nil {
		l = m.CNM.Size()
...
func (this *CNMNetworkSpec) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&CNMNetworkSpec{`,
...
func (this *NetworkSpec) String() string {
	...
	s := strings.Join([]string{`&NetworkSpec{`,
		`Annotations:` + strings.Replace(strings.Replace(this.Annotations.String(), "Annotations", "Annotations", 1), `&`, ``, 1) + `,`,
		`CNMCompatDriverConfig:` + strings.Replace(fmt.Sprintf("%v", this.CNMCompatDriverConfig), "Driver", "Driver", 1) + `,`,
		`CNMCompatIpv6Enabled:` + fmt.Sprintf("%v", this.CNMCompatIpv6Enabled) + `,`,
		`CNMCompatInternal:` + fmt.Sprintf("%v", this.CNMCompatInternal) + `,`,
		`CNMCompatIPAM:` + strings.Replace(fmt.Sprintf("%v", this.CNMCompatIPAM), "IPAMOptions", "IPAMOptions", 1) + `,`,
		`CNMCompatAttachable:` + fmt.Sprintf("%v", this.CNMCompatAttachable) + `,`,
		`CNMCompatIngress:` + fmt.Sprintf("%v", this.CNMCompatIngress) + `,`,
		`Backend:` + fmt.Sprintf("%v", this.Backend) + `,`,
		`}`,
	}, "")
	return s
}
func (this *NetworkSpec_CNM) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&NetworkSpec_CNM{`,
		`CNM:` + strings.Replace(fmt.Sprintf("%v", this.CNM), "CNMNetworkSpec", "CNMNetworkSpec", 1) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *CNMNetworkSpec) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: CNMNetworkSpec: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: CNMNetworkSpec: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *NetworkSpec) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field CNMCompatDriverConfig", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.CNMCompatDriverConfig.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 3:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field CNMCompatIpv6Enabled", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.CNMCompatIpv6Enabled = bool(v != 0)
		case 4:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field CNMCompatInternal", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.CNMCompatInternal = bool(v != 0)
		case 5:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field CNMCompatIPAM", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.CNMCompatIPAM.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 6:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field CNMCompatAttachable", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.CNMCompatAttachable = bool(v != 0)
		case 7:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field CNMCompatIngress", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.CNMCompatIngress = bool(v != 0)
		case 8:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field CNM", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
...
var fileDescriptorSpecs = []byte{
	...
	,
}
