...
// BasicSecretSpec specifies a user-provided secret.
type BasicSecretSpec struct {
	Annotations Annotations `protobuf:"bytes,1,opt,name=annotations" json:"annotations"`
...
func (m *BasicSecretSpec) Reset()                    { *m = BasicSecretSpec{} }
func (*BasicSecretSpec) ProtoMessage()               {}
func (*BasicSecretSpec) Descriptor() ([]byte, []int) { return fileDescriptorSpecs, []int{12} }
...
type PKISpec struct {
	Annotations Annotations `protobuf:"bytes,1,opt,name=annotations" json:"annotations"`
	// CAConfig specifies how we want the CA configured
	CAConfig CAConfig `protobuf:"bytes,2,opt,name=ca_config,json=caConfig" json:"ca_config"`
}

func (m *PKISpec) Reset()                    { *m = PKISpec{} }
func (*PKISpec) ProtoMessage()               {}
func (*PKISpec) Descriptor() ([]byte, []int) { return fileDescriptorSpecs, []int{14} }

type ServiceIdentitySpec struct {
	Annotations Annotations `protobuf:"bytes,1,opt,name=annotations" json:"annotations"`
	// Issuer must contain a reference to a PKI secret used to issue TLS certificates
	Issuer SecretReference `protobuf:"bytes,2,opt,name=issuer" json:"issuer"`
}

func (m *ServiceIdentitySpec) Reset()                    { *m = ServiceIdentitySpec{} }
func (*ServiceIdentitySpec) ProtoMessage()               {}
func (*ServiceIdentitySpec) Descriptor() ([]byte, []int) { return fileDescriptorSpecs, []int{15} }
...
func init() {
	...
	proto.RegisterType((*BasicSecretSpec)(nil), "docker.swarmkit.v1.BasicSecretSpec")
	proto.RegisterType((*ConfigSpec)(nil), "docker.swarmkit.v1.ConfigSpec")
	proto.RegisterType((*PKISpec)(nil), "docker.swarmkit.v1.PKISpec")
	proto.RegisterType((*ServiceIdentitySpec)(nil), "docker.swarmkit.v1.ServiceIdentitySpec")
...
func (m *BasicSecretSpec) Copy() *BasicSecretSpec {
	if m == nil {
		return nil
	}
	o := &BasicSecretSpec{}
...
func (m *BasicSecretSpec) CopyFrom(src interface{}) {

	o := src.(*BasicSecretSpec)
	*m = *o
	github_com_docker_swarmkit_api_deepcopy.Copy(&m.Annotations, &o.Annotations)
	if o.Data != nil {
...
func (m *PKISpec) CopyFrom(src interface{}) {
...
func (m *ServiceIdentitySpec) Copy() *ServiceIdentitySpec {
	if m == nil {
		return nil
	}
	o := &ServiceIdentitySpec{}
	o.CopyFrom(m)
	return o
}

func (m *ServiceIdentitySpec) CopyFrom(src interface{}) {

	o := src.(*ServiceIdentitySpec)
	*m = *o
	github_com_docker_swarmkit_api_deepcopy.Copy(&m.Annotations, &o.Annotations)
	github_com_docker_swarmkit_api_deepcopy.Copy(&m.Issuer, &o.Issuer)
}
...
func (m *BasicSecretSpec) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *BasicSecretSpec) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *PKISpec) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *PKISpec) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	...
	i++
	i = encodeVarintSpecs(dAtA, i, uint64(m.CAConfig.Size()))
	n42, err := m.CAConfig.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n42
...
func (m *ServiceIdentitySpec) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *ServiceIdentitySpec) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	...
	dAtA[i] = 0x12
	i++
	i = encodeVarintSpecs(dAtA, i, uint64(m.Issuer.Size()))
	n44, err := m.Issuer.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n44
...
func (m *BasicSecretSpec) Size() (n int) {
	var l int
	_ = l
	l = m.Annotations.Size()
	n += 1 + l + sovSpecs(uint64(l))
...
func (m *ServiceIdentitySpec) Size() (n int) {
	var l int
	_ = l
	l = m.Annotations.Size()
	n += 1 + l + sovSpecs(uint64(l))
...
func (this *BasicSecretSpec) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&BasicSecretSpec{`,
		`Annotations:` + strings.Replace(strings.Replace(this.Annotations.String(), "Annotations", "Annotations", 1), `&`, ``, 1) + `,`,
...
func (this *PKISpec) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&PKISpec{`,
		`Annotations:` + strings.Replace(strings.Replace(this.Annotations.String(), "Annotations", "Annotations", 1), `&`, ``, 1) + `,`,
		`CAConfig:` + strings.Replace(strings.Replace(this.CAConfig.String(), "CAConfig", "CAConfig", 1), `&`, ``, 1) + `,`,
		`}`,
	}, "")
...
func (this *ServiceIdentitySpec) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&ServiceIdentitySpec{`,
		`Annotations:` + strings.Replace(strings.Replace(this.Annotations.String(), "Annotations", "Annotations", 1), `&`, ``, 1) + `,`,
		`Issuer:` + strings.Replace(strings.Replace(this.Issuer.String(), "SecretReference", "SecretReference", 1), `&`, ``, 1) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *BasicSecretSpec) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: BasicSecretSpec: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: BasicSecretSpec: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *PKISpec) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: PKISpec: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: PKISpec: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *ServiceIdentitySpec) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ServiceIdentitySpec: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ServiceIdentitySpec: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
var fileDescriptorSpecs = []byte{
	...
	,
}
