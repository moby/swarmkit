...
type ClusterSpec struct {
	...
	// SecretConfig specifies cluster-level secret configuration settings, such as
	// maximum number of secrets.
	Secrets SecretsConfig `protobuf:"bytes,8,opt,name=secrets" json:"secrets"`
}
...
// SecretValueSpec specifies a user-provided secret.
type SecretValueSpec struct {
	Annotations Annotations `protobuf:"bytes,1,opt,name=annotations" json:"annotations"`
	// Secret payload.
	Data []byte `protobuf:"bytes,2,opt,name=data,proto3" json:"data,omitempty"`
	// When this secret-spec should expire and no longer be available
	Expiry *docker_swarmkit_v1.Timestamp `protobuf:"bytes,3,opt,name=expiry" json:"expiry,omitempty"`
}

func (m *SecretValueSpec) Reset()                    { *m = SecretValueSpec{} }
func (*SecretValueSpec) ProtoMessage()               {}
func (*SecretValueSpec) Descriptor() ([]byte, []int) { return fileDescriptorSpecs, []int{10} }
...
func init() {
	...
	proto.RegisterType((*SecretValueSpec)(nil), "docker.swarmkit.v1.SecretValueSpec")
...
func (m *ClusterSpec) Copy() *ClusterSpec {
	...
	o := &ClusterSpec{
		...
		Secrets:          *m.Secrets.Copy(),
	}

	return o
}

func (m *SecretValueSpec) Copy() *SecretValueSpec {
	if m == nil {
		return nil
	}
...
func (this *SecretValueSpec) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 7)
	s = append(s, "&api.SecretValueSpec{")
	s = append(s, "Annotations: "+strings.Replace(this.Annotations.GoString(), `&`, ``, 1)+",\n")
...
func (m *ClusterSpec) MarshalTo(data []byte) (int, error) {
	...
	data[i] = 0x42
	i++
	i = encodeVarintSpecs(data, i, uint64(m.Secrets.Size()))
	n28, err := m.Secrets.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n28
...
func (m *SecretValueSpec) Marshal() (data []byte, err error) {
	size := m.Size()
	data = make([]byte, size)
	n, err := m.MarshalTo(data)
	if err != nil {
...
func (m *SecretValueSpec) MarshalTo(data []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	...
	if m.Expiry != nil {
		data[i] = 0x1a
		i++
		i = encodeVarintSpecs(data, i, uint64(m.Expiry.Size()))
...
func (m *SecretValueSpec) Size() (n int) {
	var l int
	_ = l
	l = m.Annotations.Size()
	n += 1 + l + sovSpecs(uint64(l))
...
func (this *ClusterSpec) String() string {
	...
	s := strings.Join([]string{`&ClusterSpec{`,
		...
		`Secrets:` + strings.Replace(strings.Replace(this.Secrets.String(), "SecretsConfig", "SecretsConfig", 1), `&`, ``, 1) + `,`,
		`}`,
	}, "")
	return s
}
func (this *SecretValueSpec) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&SecretValueSpec{`,
		`Annotations:` + strings.Replace(strings.Replace(this.Annotations.String(), "Annotations", "Annotations", 1), `&`, ``, 1) + `,`,
...
func (m *SecretValueSpec) Unmarshal(data []byte) error {
	l := len(data)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
...
var fileDescriptorSpecs = []byte{
	...
	,
}
