...
type SecretValueSpec struct {
	Annotations Annotations `protobuf:"bytes,1,opt,name=annotations" json:"annotations"`
	// Type distinguishes the different kinds of secrets in the system (such as container vs node vs swarm-specific)
	...
	Expiry *docker_swarmkit_v1.Timestamp `protobuf:"bytes,4,opt,name=expiry" json:"expiry,omitempty"`
}
...
func (m *SecretValueSpec) MarshalTo(data []byte) (int, error) {
	...
	if m.Expiry != nil {
		...
		n29, err := m.Expiry.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n29
...
var fileDescriptorSpecs = []byte{
	...
	,
}
