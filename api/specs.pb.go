...
type Annotations struct {
	...
	// Labels define zero or more labels associated with the containing
	// message. By convention, these are usually '=' separated, with the key on
	// the right and value on the left.
...
type ContainerSpec struct {
	...
	StopGracePeriod time.Duration `protobuf:"varint,11,opt,name=stop_grace_period,json=stopGracePeriod,proto3,customtype=time.Duration" json:"stop_grace_period"`
}
...
type RegisteredCertificateSpec struct {
	Annotations  Annotations   `protobuf:"bytes,1,opt,name=annotations" json:"annotations"`
	DesiredState IssuanceState `protobuf:"varint,2,opt,name=desired_state,json=desiredState,proto3,enum=docker.cluster.api.IssuanceState" json:"desired_state,omitempty"`
}
...
func (m *RegisteredCertificateSpec) MarshalTo(data []byte) (int, error) {
	...
	if m.DesiredState != 0 {
		data[i] = 0x10
		i++
		i = encodeVarintSpecs(data, i, uint64(m.DesiredState))
	}
	return i, nil
}
...
func (m *RegisteredCertificateSpec) Size() (n int) {
	...
	n += 1 + l + sovSpecs(uint64(l))
	if m.DesiredState != 0 {
		n += 1 + sovSpecs(uint64(m.DesiredState))
	}
	return n
}
	...
	for iNdEx < l {
		...
		case 2:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := data[iNdEx]
				iNdEx++
				m.DesiredState |= (IssuanceState(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
var fileDescriptorSpecs = []byte{
	...
	,
}
