...
type ServiceSpec struct {
	...
	Endpoint *Endpoint `protobuf:"bytes,7,opt,name=endpoint" json:"endpoint,omitempty"`
}
...
func (m *TaskSpec) MarshalTo(data []byte) (int, error) {
	...
	_ = l
	if m.Runtime != nil {
		nn6, err := m.Runtime.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += nn6
...
func (m *VolumeSpec) MarshalTo(data []byte) (int, error) {
	...
	i++
	i = encodeVarintSpecs(data, i, uint64(m.Annotations.Size()))
	n8, err := m.Annotations.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n8
...
func (m *NetworkSpec) MarshalTo(data []byte) (int, error) {
	...
	if m.IPAM != nil {
		...
		n12, err := m.IPAM.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n12
...
var fileDescriptorSpecs = []byte{
	...
	,
}
