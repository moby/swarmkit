...
type TaskSpec struct {
	...
	// Entitlements are the high-level permissions to give to a service
	Entitlements []string `protobuf:"bytes,12,rep,name=entitlements" json:"entitlements,omitempty"`
}
...
type Entitlement struct {
	FullName []string `protobuf:"bytes,1,rep,name=full_name,json=fullName" json:"full_name,omitempty"`
}

func (m *Entitlement) Reset()                    { *m = Entitlement{} }
func (*Entitlement) ProtoMessage()               {}
func (*Entitlement) Descriptor() ([]byte, []int) { return fileDescriptorSpecs, []int{5} }
...
func init() {
	...
	proto.RegisterType((*Entitlement)(nil), "docker.swarmkit.v1.Entitlement")
...
func (m *TaskSpec) CopyFrom(src interface{}) {
	...
	*m = *o
	...
	if o.Entitlements != nil {
		m.Entitlements = make([]string, len(o.Entitlements))
		copy(m.Entitlements, o.Entitlements)
	}
...
func (m *Entitlement) Copy() *Entitlement {
	if m == nil {
		return nil
	}
	o := &Entitlement{}
...
func (m *Entitlement) CopyFrom(src interface{}) {

	o := src.(*Entitlement)
	*m = *o
	if o.FullName != nil {
		m.FullName = make([]string, len(o.FullName))
		copy(m.FullName, o.FullName)
	}
...
func (this *TaskSpec) String() string {
	...
	s := strings.Join([]string{`&TaskSpec{`,
		...
		`Entitlements:` + fmt.Sprintf("%v", this.Entitlements) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *Entitlement) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.FullName = append(m.FullName, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipSpecs(dAtA[iNdEx:])
...
var fileDescriptorSpecs = []byte{
	...
	,
}
