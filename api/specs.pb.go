...
func (*ServiceSpec_NetworkAttachment) Descriptor() ([]byte, []int) {
	return fileDescriptorSpecs, []int{2, 0}
}
...
func (*ReplicatedService) Descriptor() ([]byte, []int) { return fileDescriptorSpecs, []int{3} }
...
func (*GlobalService) Descriptor() ([]byte, []int) { return fileDescriptorSpecs, []int{4} }
...
var fileDescriptorSpecs = []byte{
	...
	,
}
