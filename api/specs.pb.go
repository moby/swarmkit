...
type ContainerSpec struct {
	...
	// HealthCheck stores args to be used in container's healthcheck
	HealthCheck *HealthConfig `protobuf:"bytes,10,opt,name=health_check,json=healthCheck" json:"health_check,omitempty"`
}
...
// HealthConfig defines args will be used in healthcheck
...
func (m *HealthConfig) MarshalTo(data []byte) (int, error) {
	...
	if m.Interval != nil {
		data[i] = 0x12
		i++
		i = encodeVarintSpecs(data, i, uint64(m.Interval.Size()))
		n16, err := m.Interval.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n16
	...
	if m.Timeout != nil {
		data[i] = 0x1a
		i++
		i = encodeVarintSpecs(data, i, uint64(m.Timeout.Size()))
...
var fileDescriptorSpecs = []byte{
	...
	,
}
