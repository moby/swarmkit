...
type NodeSpec struct {
	...
	// may run on this node. For a task to be runnable on the node, all
	// selected security profiles must be present in this list.
	//
	// An empty list allows only the "default" security profile to run on this
	// node.
	//
	// TODO(stevvooe): Consider making a more expressive type here.
	AllowedSecurityProfiles []string `protobuf:"bytes,5,rep,name=allowed_security_profiles,json=allowedSecurityProfiles" json:"allowed_security_profiles,omitempty"`
}
...
type ContainerSpec struct {
	...
	// Security allows one to define further isolation of a container runtime,
	// via profiles or other extension in the SecurityConfig.
	Security *SecurityConfig `protobuf:"bytes,17,opt,name=security" json:"security,omitempty"`
}
...
func (m *NodeSpec) Copy() *NodeSpec {
	...
	if m.AllowedSecurityProfiles != nil {
		o.AllowedSecurityProfiles = make([]string, 0, len(m.AllowedSecurityProfiles))
		o.AllowedSecurityProfiles = append(o.AllowedSecurityProfiles, m.AllowedSecurityProfiles...)
	}
...
func (this *NodeSpec) GoString() string {
	...
	s = append(s, "AllowedSecurityProfiles: "+fmt.Sprintf("%#v", this.AllowedSecurityProfiles)+",\n")
	s = append(s, "}")
...
func (m *NodeSpec) MarshalTo(data []byte) (int, error) {
	...
	if len(m.AllowedSecurityProfiles) > 0 {
		for _, s := range m.AllowedSecurityProfiles {
			data[i] = 0x2a
			i++
			l = len(s)
			for l >= 1<<7 {
...
func (m *ContainerSpec) MarshalTo(data []byte) (int, error) {
	...
	if m.Security != nil {
		...
		data[i] = 0x1
		i++
		i = encodeVarintSpecs(data, i, uint64(m.Security.Size()))
		n20, err := m.Security.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n20
...
func (this *NodeSpec) String() string {
	...
	s := strings.Join([]string{`&NodeSpec{`,
		...
		`AllowedSecurityProfiles:` + fmt.Sprintf("%v", this.AllowedSecurityProfiles) + `,`,
		`}`,
	}, "")
	return s
}
...
func (this *ContainerSpec) String() string {
	...
	s := strings.Join([]string{`&ContainerSpec{`,
		...
		`Security:` + strings.Replace(fmt.Sprintf("%v", this.Security), "SecurityConfig", "SecurityConfig", 1) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *NodeSpec) Unmarshal(data []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field AllowedSecurityProfiles", wireType)
			}
			...
			m.AllowedSecurityProfiles = append(m.AllowedSecurityProfiles, string(data[iNdEx:postIndex]))
			iNdEx = postIndex
		default:
			iNdEx = preIndex
...
var fileDescriptorSpecs = []byte{
	...
	,
}
