...
type ContainerSpec struct {
	...
	// PrivilegeProfiles specifies per-architecture security options required by the container
	SecurityProfiles *PrivilegeProfiles `protobuf:"bytes,21,opt,name=security_profiles,json=securityProfiles" json:"security_profiles,omitempty"`
}
...
type PluginSpec struct {
	...
	Image string `protobuf:"bytes,1,opt,name=image,proto3" json:"image,omitempty"`
	// PrivilegeProfiles specifies per-architecture security options required by the container
	SecurityProfiles *PrivilegeProfiles `protobuf:"bytes,2,opt,name=security_profiles,json=securityProfiles" json:"security_profiles,omitempty"`
}
...
func (m *ContainerSpec) CopyFrom(src interface{}) {
	...
	*m = *o
	...
	if o.SecurityProfiles != nil {
		m.SecurityProfiles = &PrivilegeProfiles{}
		github_com_docker_swarmkit_api_deepcopy.Copy(m.SecurityProfiles, o.SecurityProfiles)
	}
}
...
func (m *ContainerSpec) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.SecurityProfiles != nil {
		dAtA[i] = 0xaa
		i++
		dAtA[i] = 0x1
		i++
		i = encodeVarintSpecs(dAtA, i, uint64(m.SecurityProfiles.Size()))
		n22, err := m.SecurityProfiles.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n22
...
func (m *PluginSpec) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.SecurityProfiles != nil {
		...
		i++
		i = encodeVarintSpecs(dAtA, i, uint64(m.SecurityProfiles.Size()))
		n23, err := m.SecurityProfiles.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n23
...
func (this *ContainerSpec) String() string {
	...
	s := strings.Join([]string{`&ContainerSpec{`,
		...
		`SecurityProfiles:` + strings.Replace(fmt.Sprintf("%v", this.SecurityProfiles), "PrivilegeProfiles", "PrivilegeProfiles", 1) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *ContainerSpec) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 21:
			...
			if err := m.SecurityProfiles.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
var fileDescriptorSpecs = []byte{
	...
	,
}
