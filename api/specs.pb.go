...
type NetworkSpec struct {
	...
	// ManuallyAttachable allows external(to swarm) entities to
	// manually attach to this network. With this flag enabled,
	// external entities such as containers running in an worker
	// node in the cluster can manually attach to this network and
	// access the services attached to this network. If this flag
	// is not enabled(default case) no manual attachment to this
	// network can happen.
	ManuallyAttachable bool `protobuf:"varint,6,opt,name=manually_attachable,json=manuallyAttachable,proto3" json:"manually_attachable,omitempty"`
}
...
func (m *NetworkSpec) Copy() *NetworkSpec {
	...
	o := &NetworkSpec{
		...
		Internal:           m.Internal,
		IPAM:               m.IPAM.Copy(),
		ManuallyAttachable: m.ManuallyAttachable,
	}
...
func (this *NetworkSpec) GoString() string {
	...
	s = append(s, "ManuallyAttachable: "+fmt.Sprintf("%#v", this.ManuallyAttachable)+",\n")
	s = append(s, "}")
	return strings.Join(s, "")
}
...
func (this *NetworkSpec) String() string {
	...
	s := strings.Join([]string{`&NetworkSpec{`,
		...
		`ManuallyAttachable:` + fmt.Sprintf("%v", this.ManuallyAttachable) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *NetworkSpec) Unmarshal(data []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field ManuallyAttachable", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
...
var fileDescriptorSpecs = []byte{
	...
	,
	...
	,
}
