...
type TaskSpec struct {
	...
	// ContainerHostConfigSpec specifies hostconfig for container.
	Hostconfig *ContainerHostConfigSpec `protobuf:"bytes,2,opt,name=hostconfig" json:"hostconfig,omitempty"`
...
type ContainerHostConfigSpec struct {
	// LogConfig specifies the log driver for container
	Logconfig *ContainerHostConfigSpec_LogConfig `protobuf:"bytes,1,opt,name=logconfig" json:"logconfig,omitempty"`
}

func (m *ContainerHostConfigSpec) Reset()                    { *m = ContainerHostConfigSpec{} }
func (*ContainerHostConfigSpec) ProtoMessage()               {}
func (*ContainerHostConfigSpec) Descriptor() ([]byte, []int) { return fileDescriptorSpecs, []int{6} }

// LogConfig log driver for container
type ContainerHostConfigSpec_LogConfig struct {
	// driver type
...
func (m *ContainerHostConfigSpec_LogConfig) Reset()      { *m = ContainerHostConfigSpec_LogConfig{} }
func (*ContainerHostConfigSpec_LogConfig) ProtoMessage() {}
func (*ContainerHostConfigSpec_LogConfig) Descriptor() ([]byte, []int) {
...
func init() {
	...
	proto.RegisterType((*ContainerHostConfigSpec)(nil), "docker.swarmkit.v1.ContainerHostConfigSpec")
	proto.RegisterType((*ContainerHostConfigSpec_LogConfig)(nil), "docker.swarmkit.v1.ContainerHostConfigSpec.LogConfig")
...
func (m *ContainerHostConfigSpec) Copy() *ContainerHostConfigSpec {
	if m == nil {
		return nil
	}

	o := &ContainerHostConfigSpec{
		Logconfig: m.Logconfig.Copy(),
	}

	return o
}

func (m *ContainerHostConfigSpec_LogConfig) Copy() *ContainerHostConfigSpec_LogConfig {
	if m == nil {
		return nil
	}

	o := &ContainerHostConfigSpec_LogConfig{
		Type: m.Type,
	}

	if m.Config != nil {
		o.Config = make(map[string]string)
...
func (this *TaskSpec) GoString() string {
	...
	if this.Hostconfig != nil {
		s = append(s, "Hostconfig: "+fmt.Sprintf("%#v", this.Hostconfig)+",\n")
	}
...
func (this *ContainerHostConfigSpec) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 5)
	s = append(s, "&api.ContainerHostConfigSpec{")
	if this.Logconfig != nil {
		s = append(s, "Logconfig: "+fmt.Sprintf("%#v", this.Logconfig)+",\n")
	}
	s = append(s, "}")
	return strings.Join(s, "")
}
func (this *ContainerHostConfigSpec_LogConfig) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 6)
	s = append(s, "&api.ContainerHostConfigSpec_LogConfig{")
...
func (m *TaskSpec) MarshalTo(data []byte) (int, error) {
	...
	if m.Hostconfig != nil {
		data[i] = 0x12
		i++
		i = encodeVarintSpecs(data, i, uint64(m.Hostconfig.Size()))
		n10, err := m.Hostconfig.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n10
...
func (m *ContainerHostConfigSpec) Marshal() (data []byte, err error) {
	size := m.Size()
	data = make([]byte, size)
	n, err := m.MarshalTo(data)
	if err != nil {
...
func (m *ContainerHostConfigSpec) MarshalTo(data []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	if m.Logconfig != nil {
		data[i] = 0xa
		i++
		i = encodeVarintSpecs(data, i, uint64(m.Logconfig.Size()))
		n17, err := m.Logconfig.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n17
...
func (m *ContainerHostConfigSpec_LogConfig) Marshal() (data []byte, err error) {
	size := m.Size()
	data = make([]byte, size)
	n, err := m.MarshalTo(data)
	if err != nil {
...
func (m *ContainerHostConfigSpec_LogConfig) MarshalTo(data []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *ContainerHostConfigSpec) Size() (n int) {
	var l int
	_ = l
	if m.Logconfig != nil {
		l = m.Logconfig.Size()
...
func (m *ContainerHostConfigSpec_LogConfig) Size() (n int) {
	var l int
	_ = l
	l = len(m.Type)
	if l > 0 {
...
func (this *TaskSpec) String() string {
	...
	s := strings.Join([]string{`&TaskSpec{`,
		...
		`Hostconfig:` + strings.Replace(fmt.Sprintf("%v", this.Hostconfig), "ContainerHostConfigSpec", "ContainerHostConfigSpec", 1) + `,`,
...
func (this *ContainerHostConfigSpec) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&ContainerHostConfigSpec{`,
		`Logconfig:` + strings.Replace(fmt.Sprintf("%v", this.Logconfig), "ContainerHostConfigSpec_LogConfig", "ContainerHostConfigSpec_LogConfig", 1) + `,`,
		`}`,
	}, "")
	return s
}
func (this *ContainerHostConfigSpec_LogConfig) String() string {
	if this == nil {
		return "nil"
	}
	keysForConfig := make([]string, 0, len(this.Config))
	...
	mapStringForConfig += "}"
	s := strings.Join([]string{`&ContainerHostConfigSpec_LogConfig{`,
...
func (m *TaskSpec) Unmarshal(data []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			if m.Hostconfig == nil {
				m.Hostconfig = &ContainerHostConfigSpec{}
			}
...
func (m *ContainerHostConfigSpec) Unmarshal(data []byte) error {
	l := len(data)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ContainerHostConfigSpec: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ContainerHostConfigSpec: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
			...
			if m.Logconfig == nil {
				m.Logconfig = &ContainerHostConfigSpec_LogConfig{}
			}
...
func (m *ContainerHostConfigSpec_LogConfig) Unmarshal(data []byte) error {
	l := len(data)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
...
var fileDescriptorSpecs = []byte{
	...
	,
}
