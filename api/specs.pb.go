...
type TaskSpec struct {
	...
	Networks  []*TaskSpec_NetworkAttachmentConfig `protobuf:"bytes,7,rep,name=networks" json:"networks,omitempty"`
}
...
// NetworkAttachmentConfig specifies how a task should be attached to a particular network.
//
...
// network.
type TaskSpec_NetworkAttachmentConfig struct {
...
func (m *TaskSpec_NetworkAttachmentConfig) Reset()      { *m = TaskSpec_NetworkAttachmentConfig{} }
func (*TaskSpec_NetworkAttachmentConfig) ProtoMessage() {}
func (*TaskSpec_NetworkAttachmentConfig) Descriptor() ([]byte, []int) {
...
func init() {
	...
	proto.RegisterType((*TaskSpec_NetworkAttachmentConfig)(nil), "docker.swarmkit.v1.TaskSpec.NetworkAttachmentConfig")
...
func (m *TaskSpec) Copy() *TaskSpec {
	...
	if m.Networks != nil {
		o.Networks = make([]*TaskSpec_NetworkAttachmentConfig, 0, len(m.Networks))
...
func (m *TaskSpec_NetworkAttachmentConfig) Copy() *TaskSpec_NetworkAttachmentConfig {
	if m == nil {
		return nil
	}

	o := &TaskSpec_NetworkAttachmentConfig{
		Target: m.Target,
	}
...
func (this *TaskSpec_NetworkAttachmentConfig) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 6)
	s = append(s, "&api.TaskSpec_NetworkAttachmentConfig{")
...
func (m *TaskSpec_NetworkAttachmentConfig) Marshal() (data []byte, err error) {
	size := m.Size()
	data = make([]byte, size)
	n, err := m.MarshalTo(data)
	if err != nil {
...
func (m *TaskSpec_NetworkAttachmentConfig) MarshalTo(data []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *TaskSpec_NetworkAttachmentConfig) Size() (n int) {
	var l int
	_ = l
	l = len(m.Target)
	if l > 0 {
...
func (this *TaskSpec) String() string {
	...
	s := strings.Join([]string{`&TaskSpec{`,
		...
		`Networks:` + strings.Replace(fmt.Sprintf("%v", this.Networks), "TaskSpec_NetworkAttachmentConfig", "TaskSpec_NetworkAttachmentConfig", 1) + `,`,
		`}`,
	}, "")
	return s
}
...
func (this *TaskSpec_NetworkAttachmentConfig) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&TaskSpec_NetworkAttachmentConfig{`,
...
func (m *TaskSpec) Unmarshal(data []byte) error {
	...
	for iNdEx < l {
		...
		case 7:
			...
			m.Networks = append(m.Networks, &TaskSpec_NetworkAttachmentConfig{})
...
func (m *TaskSpec_NetworkAttachmentConfig) Unmarshal(data []byte) error {
	l := len(data)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
...
var fileDescriptorSpecs = []byte{
	...
	,
}
