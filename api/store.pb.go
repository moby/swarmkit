...
func (*GetObjectRequest) Descriptor() ([]byte, []int) { return fileDescriptorStore, []int{4} }
...
type FindObjectsRequest struct {
	...
	Selectors []*SelectBy `protobuf:"bytes,2,rep,name=selectors" json:"selectors,omitempty"`
}

func (m *FindObjectsRequest) Reset()                    { *m = FindObjectsRequest{} }
func (*FindObjectsRequest) ProtoMessage()               {}
func (*FindObjectsRequest) Descriptor() ([]byte, []int) { return fileDescriptorStore, []int{5} }
...
func (*FindObjectsResponse) Descriptor() ([]byte, []int) { return fileDescriptorStore, []int{6} }

type UpdateObjectsRequest struct {
	Objects []*Object `protobuf:"bytes,1,rep,name=objects" json:"objects,omitempty"`
}

func (m *UpdateObjectsRequest) Reset()                    { *m = UpdateObjectsRequest{} }
func (*UpdateObjectsRequest) ProtoMessage()               {}
func (*UpdateObjectsRequest) Descriptor() ([]byte, []int) { return fileDescriptorStore, []int{7} }
...
func (m *UpdateObjectsResponse) Reset()                    { *m = UpdateObjectsResponse{} }
func (*UpdateObjectsResponse) ProtoMessage()               {}
func (*UpdateObjectsResponse) Descriptor() ([]byte, []int) { return fileDescriptorStore, []int{8} }
...
func (*WatchRequest) Descriptor() ([]byte, []int) { return fileDescriptorStore, []int{9} }
...
type WatchRequest_WatchEntry struct {
	...
	Action StoreActionKind `protobuf:"varint,2,opt,name=action,proto3,enum=docker.swarmkit.v1.StoreActionKind" json:"action,omitempty"`
...
func (*WatchRequest_WatchEntry) Descriptor() ([]byte, []int) { return fileDescriptorStore, []int{9, 0} }
...
func (*WatchMessage) Descriptor() ([]byte, []int) { return fileDescriptorStore, []int{10} }
...
func (*WatchMessage_Event) Descriptor() ([]byte, []int) { return fileDescriptorStore, []int{10, 0} }
...
func init() {
	...
	proto.RegisterType((*GetObjectRequest)(nil), "docker.swarmkit.v1.GetObjectRequest")
	proto.RegisterType((*FindObjectsRequest)(nil), "docker.swarmkit.v1.FindObjectsRequest")
	proto.RegisterType((*FindObjectsResponse)(nil), "docker.swarmkit.v1.FindObjectsResponse")
	proto.RegisterType((*UpdateObjectsRequest)(nil), "docker.swarmkit.v1.UpdateObjectsRequest")
	proto.RegisterType((*UpdateObjectsResponse)(nil), "docker.swarmkit.v1.UpdateObjectsResponse")
...
func (p *authenticatedWrapperStoreServer) GetObject(ctx context.Context, r *GetObjectRequest) (*Object, error) {

	if err := p.authorize(ctx, []string{"swarm-manager"}); err != nil {
		return nil, err
	}
	return p.local.GetObject(ctx, r)
}

func (p *authenticatedWrapperStoreServer) FindObjects(ctx context.Context, r *FindObjectsRequest) (*FindObjectsResponse, error) {

	if err := p.authorize(ctx, []string{"swarm-manager"}); err != nil {
		return nil, err
	}
	return p.local.FindObjects(ctx, r)
}

func (p *authenticatedWrapperStoreServer) CreateObject(ctx context.Context, r *Object) (*Object, error) {

	if err := p.authorize(ctx, []string{"swarm-manager"}); err != nil {
		return nil, err
	}
	return p.local.CreateObject(ctx, r)
}

func (p *authenticatedWrapperStoreServer) UpdateObjects(ctx context.Context, r *UpdateObjectsRequest) (*UpdateObjectsResponse, error) {

	if err := p.authorize(ctx, []string{"swarm-manager"}); err != nil {
		return nil, err
	}
	return p.local.UpdateObjects(ctx, r)
}
...
func (m *GetObjectRequest) Copy() *GetObjectRequest {
	if m == nil {
		return nil
	}
	o := &GetObjectRequest{}
...
func (m *GetObjectRequest) CopyFrom(src interface{}) {

	o := src.(*GetObjectRequest)
	*m = *o
}

func (m *FindObjectsRequest) Copy() *FindObjectsRequest {
	if m == nil {
		return nil
	}
	o := &FindObjectsRequest{}
	o.CopyFrom(m)
	return o
}

func (m *FindObjectsRequest) CopyFrom(src interface{}) {

	o := src.(*FindObjectsRequest)
	*m = *o
	if o.Selectors != nil {
		m.Selectors = make([]*SelectBy, len(o.Selectors))
		for i := range m.Selectors {
			m.Selectors[i] = &SelectBy{}
			github_com_docker_swarmkit_api_deepcopy.Copy(m.Selectors[i], o.Selectors[i])
		}
	}

}

func (m *FindObjectsResponse) Copy() *FindObjectsResponse {
	if m == nil {
		return nil
	}
	o := &FindObjectsResponse{}
	o.CopyFrom(m)
	return o
}

func (m *FindObjectsResponse) CopyFrom(src interface{}) {

	o := src.(*FindObjectsResponse)
	*m = *o
	if o.Results != nil {
		m.Results = make([]*Object, len(o.Results))
		for i := range m.Results {
			m.Results[i] = &Object{}
			github_com_docker_swarmkit_api_deepcopy.Copy(m.Results[i], o.Results[i])
		}
	}

}

func (m *UpdateObjectsRequest) Copy() *UpdateObjectsRequest {
	if m == nil {
		return nil
	}
	o := &UpdateObjectsRequest{}
	o.CopyFrom(m)
	return o
}

func (m *UpdateObjectsRequest) CopyFrom(src interface{}) {

	o := src.(*UpdateObjectsRequest)
	*m = *o
	if o.Objects != nil {
		m.Objects = make([]*Object, len(o.Objects))
		for i := range m.Objects {
			m.Objects[i] = &Object{}
			github_com_docker_swarmkit_api_deepcopy.Copy(m.Objects[i], o.Objects[i])
		}
	}

}

func (m *UpdateObjectsResponse) Copy() *UpdateObjectsResponse {
	if m == nil {
		return nil
	}
	o := &UpdateObjectsResponse{}
	o.CopyFrom(m)
	return o
}

func (m *UpdateObjectsResponse) CopyFrom(src interface{}) {

	o := src.(*UpdateObjectsResponse)
	*m = *o
	if o.Objects != nil {
		m.Objects = make([]*Object, len(o.Objects))
		for i := range m.Objects {
...
type StoreClient interface {
	...
	UpdateObjects(ctx context.Context, in *UpdateObjectsRequest, opts ...grpc.CallOption) (*UpdateObjectsResponse, error)
...
func (c *storeClient) GetObject(ctx context.Context, in *GetObjectRequest, opts ...grpc.CallOption) (*Object, error) {
	out := new(Object)
	err := grpc.Invoke(ctx, "/docker.swarmkit.v1.Store/GetObject", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *storeClient) FindObjects(ctx context.Context, in *FindObjectsRequest, opts ...grpc.CallOption) (*FindObjectsResponse, error) {
	out := new(FindObjectsResponse)
	err := grpc.Invoke(ctx, "/docker.swarmkit.v1.Store/FindObjects", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *storeClient) CreateObject(ctx context.Context, in *Object, opts ...grpc.CallOption) (*Object, error) {
	out := new(Object)
	err := grpc.Invoke(ctx, "/docker.swarmkit.v1.Store/CreateObject", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *storeClient) UpdateObjects(ctx context.Context, in *UpdateObjectsRequest, opts ...grpc.CallOption) (*UpdateObjectsResponse, error) {
	out := new(UpdateObjectsResponse)
	err := grpc.Invoke(ctx, "/docker.swarmkit.v1.Store/UpdateObjects", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type StoreServer interface {
	...
	// - Returns `FailedPrecondition` and does not commit any changes if
	//   any of the objects have changed since they were retrieved.
	UpdateObjects(context.Context, *UpdateObjectsRequest) (*UpdateObjectsResponse, error)
	// Watch starts a stream that returns any changes to objects that match
	// the specified selectors. When the stream begins, it immediately sends
	// an empty message back to the client. It is important to wait for
	// this message before taking any actions that depend on an established
...
func _Store_GetObject_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetObjectRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(StoreServer).GetObject(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/docker.swarmkit.v1.Store/GetObject",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(StoreServer).GetObject(ctx, req.(*GetObjectRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Store_FindObjects_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(FindObjectsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(StoreServer).FindObjects(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/docker.swarmkit.v1.Store/FindObjects",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(StoreServer).FindObjects(ctx, req.(*FindObjectsRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Store_CreateObject_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Object)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(StoreServer).CreateObject(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/docker.swarmkit.v1.Store/CreateObject",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(StoreServer).CreateObject(ctx, req.(*Object))
	}
	return interceptor(ctx, in, info, handler)
}

func _Store_UpdateObjects_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UpdateObjectsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(StoreServer).UpdateObjects(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/docker.swarmkit.v1.Store/UpdateObjects",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(StoreServer).UpdateObjects(ctx, req.(*UpdateObjectsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _Store_GetObject_Handler,
		},
		{
			MethodName: "FindObjects",
			Handler:    _Store_FindObjects_Handler,
		},
		{
			MethodName: "CreateObject",
			Handler:    _Store_CreateObject_Handler,
		},
		{
			MethodName: "UpdateObjects",
			Handler:    _Store_UpdateObjects_Handler,
		},
	},
...
func (m *GetObjectRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.ObjectID) > 0 {
		dAtA[i] = 0x12
		i++
		i = encodeVarintStore(dAtA, i, uint64(len(m.ObjectID)))
		i += copy(dAtA[i:], m.ObjectID)
	}
	return i, nil
}

func (m *FindObjectsRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *FindObjectsRequest) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *FindObjectsResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *FindObjectsResponse) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *UpdateObjectsRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *UpdateObjectsRequest) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *UpdateObjectsResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *UpdateObjectsResponse) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (p *raftProxyStoreServer) GetObject(ctx context.Context, r *GetObjectRequest) (*Object, error) {
	...
	resp, err := NewStoreClient(conn).GetObject(modCtx, r)
	if err != nil {
		...
		return NewStoreClient(conn).GetObject(modCtx, r)
	}
	return resp, err
}

func (p *raftProxyStoreServer) FindObjects(ctx context.Context, r *FindObjectsRequest) (*FindObjectsResponse, error) {
	...
	resp, err := NewStoreClient(conn).FindObjects(modCtx, r)
	if err != nil {
		if !strings.Contains(err.Error(), "is closing") && !strings.Contains(err.Error(), "the connection is unavailable") && !strings.Contains(err.Error(), "connection error") {
			return resp, err
		}
		...
		return NewStoreClient(conn).FindObjects(modCtx, r)
	}
	return resp, err
}

func (p *raftProxyStoreServer) CreateObject(ctx context.Context, r *Object) (*Object, error) {
	...
	resp, err := NewStoreClient(conn).CreateObject(modCtx, r)
	if err != nil {
		if !strings.Contains(err.Error(), "is closing") && !strings.Contains(err.Error(), "the connection is unavailable") && !strings.Contains(err.Error(), "connection error") {
			return resp, err
		}
		...
		return NewStoreClient(conn).CreateObject(modCtx, r)
	}
	return resp, err
}

func (p *raftProxyStoreServer) UpdateObjects(ctx context.Context, r *UpdateObjectsRequest) (*UpdateObjectsResponse, error) {
	...
	resp, err := NewStoreClient(conn).UpdateObjects(modCtx, r)
	if err != nil {
		if !strings.Contains(err.Error(), "is closing") && !strings.Contains(err.Error(), "the connection is unavailable") && !strings.Contains(err.Error(), "connection error") {
			return resp, err
		}
		...
		return NewStoreClient(conn).UpdateObjects(modCtx, r)
	}
	return resp, err
}
...
func (m *FindObjectsRequest) Size() (n int) {
	var l int
	_ = l
	l = len(m.Kind)
	if l > 0 {
...
func (m *FindObjectsResponse) Size() (n int) {
	var l int
	_ = l
	if len(m.Results) > 0 {
...
func (m *UpdateObjectsRequest) Size() (n int) {
	var l int
	_ = l
	if len(m.Objects) > 0 {
...
func (m *UpdateObjectsResponse) Size() (n int) {
	var l int
	_ = l
	if len(m.Objects) > 0 {
		for _, e := range m.Objects {
...
func (this *FindObjectsRequest) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&FindObjectsRequest{`,
		`Kind:` + fmt.Sprintf("%v", this.Kind) + `,`,
		`Selectors:` + strings.Replace(fmt.Sprintf("%v", this.Selectors), "SelectBy", "SelectBy", 1) + `,`,
		`}`,
	}, "")
	return s
}
func (this *FindObjectsResponse) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&FindObjectsResponse{`,
		`Results:` + strings.Replace(fmt.Sprintf("%v", this.Results), "Object", "Object", 1) + `,`,
		`}`,
	}, "")
	return s
}
func (this *UpdateObjectsRequest) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&UpdateObjectsRequest{`,
		`Objects:` + strings.Replace(fmt.Sprintf("%v", this.Objects), "Object", "Object", 1) + `,`,
		`}`,
	}, "")
	return s
}
func (this *UpdateObjectsResponse) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&UpdateObjectsResponse{`,
		`Objects:` + strings.Replace(fmt.Sprintf("%v", this.Objects), "Object", "Object", 1) + `,`,
		`}`,
	}, "")
	return s
...
func (m *FindObjectsRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: FindObjectsRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: FindObjectsRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 2:
			...
			m.Selectors = append(m.Selectors, &SelectBy{})
...
func (m *FindObjectsResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: FindObjectsResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: FindObjectsResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
			...
			m.Results = append(m.Results, &Object{})
...
func (m *UpdateObjectsRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: UpdateObjectsRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: UpdateObjectsRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *UpdateObjectsResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: UpdateObjectsResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: UpdateObjectsResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
var fileDescriptorStore = []byte{
	...
	,
}
