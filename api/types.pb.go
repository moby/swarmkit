...
// ServiceIdentitySecret contains extra information for a secret that is required by
// service identities, namely a reference to the issuing PKI secret.  Service identity
// secrets are generated, and cannot be modified by users.
type ServiceIdentitySecret struct {
	// Reference to the PKI secret that issued it
	PKI SecretReference `protobuf:"bytes,1,opt,name=pki" json:"pki"`
	// Expiry specifies when the certificate will expire (and hence when it needs
	// to be rotated.)
	Expiry *google_protobuf.Timestamp `protobuf:"bytes,2,opt,name=expiry" json:"expiry,omitempty"`
	// ServiceID is a reference to the service for which this secret was generated.
	// Only the service for which it was created can reference this secret, and the
	// secret can be deleted once the referenced service is deleted.
	ServiceID string `protobuf:"bytes,3,opt,name=service_id,json=serviceId,proto3" json:"service_id,omitempty"`
}

func (m *ServiceIdentitySecret) Reset()                    { *m = ServiceIdentitySecret{} }
func (*ServiceIdentitySecret) ProtoMessage()               {}
func (*ServiceIdentitySecret) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{55} }

type PKISecret struct {
	// RootCA stores the current root CA and future root CA (if a rotation is pending)
	// for CA type secrets
	RootCA RootCA `protobuf:"bytes,1,opt,name=root_ca,json=rootCa" json:"root_ca"`
	// Expiry specifies when the root certificate will expire (and hence when it needs
	// to be rotated.)
	Expiry *google_protobuf.Timestamp `protobuf:"bytes,2,opt,name=expiry" json:"expiry,omitempty"`
}

func (m *PKISecret) Reset()                    { *m = PKISecret{} }
func (*PKISecret) ProtoMessage()               {}
func (*PKISecret) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{56} }
...
func init() {
	...
	proto.RegisterType((*ServiceIdentitySecret)(nil), "docker.swarmkit.v1.ServiceIdentitySecret")
	proto.RegisterType((*PKISecret)(nil), "docker.swarmkit.v1.PKISecret")
...
func (m *ServiceIdentitySecret) Copy() *ServiceIdentitySecret {
	if m == nil {
		return nil
	}
	o := &ServiceIdentitySecret{}
	o.CopyFrom(m)
	return o
}

func (m *ServiceIdentitySecret) CopyFrom(src interface{}) {

	o := src.(*ServiceIdentitySecret)
	*m = *o
	github_com_docker_swarmkit_api_deepcopy.Copy(&m.PKI, &o.PKI)
	if o.Expiry != nil {
		m.Expiry = &google_protobuf.Timestamp{}
		github_com_docker_swarmkit_api_deepcopy.Copy(m.Expiry, o.Expiry)
	}
...
func (m *PKISecret) Copy() *PKISecret {
	if m == nil {
		return nil
	}
	o := &PKISecret{}
...
func (m *PKISecret) CopyFrom(src interface{}) {
...
func (m *ServiceIdentitySecret) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *ServiceIdentitySecret) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	dAtA[i] = 0xa
	i++
	i = encodeVarintTypes(dAtA, i, uint64(m.PKI.Size()))
	n47, err := m.PKI.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n47
	if m.Expiry != nil {
		...
		i++
		i = encodeVarintTypes(dAtA, i, uint64(m.Expiry.Size()))
		n48, err := m.Expiry.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n48
...
func (m *PKISecret) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *PKISecret) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	dAtA[i] = 0xa
	i++
	i = encodeVarintTypes(dAtA, i, uint64(m.RootCA.Size()))
	n49, err := m.RootCA.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n49
	if m.Expiry != nil {
		...
		i++
		i = encodeVarintTypes(dAtA, i, uint64(m.Expiry.Size()))
		n50, err := m.Expiry.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n50
...
func (m *ServiceIdentitySecret) Size() (n int) {
	var l int
	_ = l
	l = m.PKI.Size()
	n += 1 + l + sovTypes(uint64(l))
...
func (this *ServiceIdentitySecret) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&ServiceIdentitySecret{`,
		`PKI:` + strings.Replace(strings.Replace(this.PKI.String(), "SecretReference", "SecretReference", 1), `&`, ``, 1) + `,`,
		`Expiry:` + strings.Replace(fmt.Sprintf("%v", this.Expiry), "Timestamp", "google_protobuf.Timestamp", 1) + `,`,
...
func (this *PKISecret) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&PKISecret{`,
...
func (m *ServiceIdentitySecret) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ServiceIdentitySecret: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ServiceIdentitySecret: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field PKI", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.PKI.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 2:
...
func (m *PKISecret) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: PKISecret: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: PKISecret: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
var fileDescriptorTypes = []byte{
	...
	,
	...
	,
	...
	,
	...
	0xf4, 0x36, 0x3b, 0xb1, 0x74, 0x93, 0x3a, 0xf6, 0x98, 0xef, 0xa1, 0x9c, 0x38, 0x96, 0x30, 0xd1,
	...
	,
	...
	,
	...
	0xa1, 0x68, 0xeb, 0x03, 0x7e, 0x81, 0xe4, 0x5b, 0x03, 0x31, 0x8e, 0x34, 0x2e, 0x48, 0x5a, 0xcf,
	0x1a, 0x10, 0x55, 0x85, 0x7c, 0xa8, 0x0c, 0x2d, 0x41, 0xa1, 0xd2, 0xe8, 0x6a, 0xf7, 0xee, 0x3f,
	0xd4, 0x1e, 0xd5, 0x76, 0x94, 0x39, 0x99, 0x9b, 0xfe, 0x65, 0x02, 0x16, 0x64, 0x38, 0x92, 0xf9,
	0xfe, 0x1b, 0x30, 0xef, 0xea, 0xfb, 0x7e, 0x50, 0x91, 0xa4, 0xc5, 0xaa, 0x66, 0x11, 0x9e, 0x55,
	0x24, 0x8c, 0x15, 0x5f, 0x91, 0x44, 0xde, 0xec, 0x53, 0x97, 0xbe, 0xd9, 0xa7, 0x7f, 0x26, 0x6f,
	...
	,
}
