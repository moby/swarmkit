...
// SecurityConfig allows configuration of a containers security-oriented
// isolation measures.
type SecurityConfig struct {
	// profile specifies the security profile to use when running the container.
	//
	// Profiles are selected by name. The two current profiles available are
	// 'default' and 'privileged', which map to running containers today with
	// or without the `--privileged` flag.
	//
	// Multiple security profiles may be selected. The resulting security
	// context is union of isolation features in the two profiles. If features
	// conflict in the two profiles, the earlier item in this list is applied.
	Profiles []string `protobuf:"bytes,1,rep,name=profiles" json:"profiles,omitempty"`
}

func (m *SecurityConfig) Reset()                    { *m = SecurityConfig{} }
func (*SecurityConfig) ProtoMessage()               {}
func (*SecurityConfig) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{43} }
...
func init() {
	...
	proto.RegisterType((*SecurityConfig)(nil), "docker.swarmkit.v1.SecurityConfig")
...
func (m *SecurityConfig) Copy() *SecurityConfig {
	if m == nil {
		return nil
	}
	...
	if m.Profiles != nil {
		o.Profiles = make([]string, 0, len(m.Profiles))
		o.Profiles = append(o.Profiles, m.Profiles...)
	}
...
func (this *SecurityConfig) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 5)
	s = append(s, "&api.SecurityConfig{")
...
func (this *SecurityConfig) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&SecurityConfig{`,
		`Profiles:` + fmt.Sprintf("%v", this.Profiles) + `,`,
		`}`,
	}, "")
	return s
}
...
var fileDescriptorTypes = []byte{
	...
	0x77, 0x3c, 0x5e, 0x87, 0x63, 0x6b, 0x7e, 0xe0, 0x1d, 0x27, 0xeb, 0x69, 0xfe, 0xc8, 0xe2, 0x5a,
	...
	,
	...
	0x48, 0x5d, 0x16, 0xa0, 0x4f, 0x20, 0xeb, 0xd8, 0x43, 0x9b, 0xc9, 0x36, 0x0a, 0x1b, 0xef, 0xcc,
	...
	,
	...
	,
	...
	0x51, 0x25, 0x74, 0x0b, 0x72, 0x3e, 0x25, 0x96, 0xe7, 0x3a, 0x13, 0xe1, 0x66, 0x39, 0x79, 0xf4,
	...
	,
	...
	0xf2, 0x80, 0xfb, 0x73, 0xf3, 0xea, 0xe7, 0xf4, 0x2a, 0xd8, 0x73, 0xa8, 0x61, 0x0d, 0xed, 0x20,
	0xe0, 0xd1, 0xbb, 0x90, 0xe1, 0xc8, 0x52, 0xe9, 0xe7, 0x09, 0xb8, 0x3c, 0x07, 0x81, 0xee, 0x42,
	...
	0x9f, 0x86, 0x84, 0xf1, 0xe1, 0x2f, 0xda, 0xfb, 0x4a, 0x57, 0x98, 0xc1, 0xca, 0x5c, 0xa9, 0x02,
	...
	,
}
