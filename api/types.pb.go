...
// This is needed below because map<string, repeated string> is not valid
type RoleAuthorizations struct {
	Authorizations []string `protobuf:"bytes,1,rep,name=authorizations" json:"authorizations,omitempty"`
}

func (m *RoleAuthorizations) Reset()                    { *m = RoleAuthorizations{} }
func (*RoleAuthorizations) ProtoMessage()               {}
func (*RoleAuthorizations) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{35} }
...
type RootCA struct {
	...
	RoleAuthorizations map[string]RoleAuthorizations `protobuf:"bytes,5,rep,name=role_authorizations,json=roleAuthorizations" json:"role_authorizations" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value"`
}
...
func init() {
	...
	proto.RegisterType((*RoleAuthorizations)(nil), "docker.swarmkit.v1.RoleAuthorizations")
...
func (m *RoleAuthorizations) Copy() *RoleAuthorizations {
	if m == nil {
		return nil
	}

	o := &RoleAuthorizations{}

	if m.Authorizations != nil {
		o.Authorizations = make([]string, 0, len(m.Authorizations))
		o.Authorizations = append(o.Authorizations, m.Authorizations...)
	}
...
func (m *RootCA) Copy() *RootCA {
	...
	if m.RoleAuthorizations != nil {
		o.RoleAuthorizations = make(map[string]RoleAuthorizations)
		for k, v := range m.RoleAuthorizations {
			o.RoleAuthorizations[k] = *v.Copy()
		}
	}
...
func (this *RoleAuthorizations) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 5)
	s = append(s, "&api.RoleAuthorizations{")
...
func (this *RootCA) GoString() string {
	...
	keysForRoleAuthorizations := make([]string, 0, len(this.RoleAuthorizations))
	for k, _ := range this.RoleAuthorizations {
		keysForRoleAuthorizations = append(keysForRoleAuthorizations, k)
	}
	github_com_gogo_protobuf_sortkeys.Strings(keysForRoleAuthorizations)
	mapStringForRoleAuthorizations := "map[string]RoleAuthorizations{"
	for _, k := range keysForRoleAuthorizations {
		mapStringForRoleAuthorizations += fmt.Sprintf("%#v: %#v,", k, this.RoleAuthorizations[k])
	}
	mapStringForRoleAuthorizations += "}"
	if this.RoleAuthorizations != nil {
		s = append(s, "RoleAuthorizations: "+mapStringForRoleAuthorizations+",\n")
	}
	s = append(s, "}")
	return strings.Join(s, "")
}
...
func (m *RoleAuthorizations) Marshal() (data []byte, err error) {
	size := m.Size()
	data = make([]byte, size)
	n, err := m.MarshalTo(data)
	if err != nil {
...
func (m *RoleAuthorizations) MarshalTo(data []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	if len(m.Authorizations) > 0 {
		for _, s := range m.Authorizations {
			data[i] = 0xa
			i++
			l = len(s)
			for l >= 1<<7 {
...
func (m *RootCA) MarshalTo(data []byte) (int, error) {
	...
	if len(m.RoleAuthorizations) > 0 {
		for k, _ := range m.RoleAuthorizations {
			data[i] = 0x2a
			i++
			v := m.RoleAuthorizations[k]
			msgSize := 0
			if (&v) != nil {
				msgSize = (&v).Size()
...
func (m *SecretReference) MarshalTo(data []byte) (int, error) {
	...
	if m.Target != nil {
		nn29, err := m.Target.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += nn29
...
func (m *SecretReference_File) MarshalTo(data []byte) (int, error) {
	...
	if m.File != nil {
		...
		n30, err := m.File.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n30
...
func (m *BlacklistedCertificate) MarshalTo(data []byte) (int, error) {
	...
	if m.Expiry != nil {
		...
		n31, err := m.Expiry.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n31
...
func (m *HealthConfig) MarshalTo(data []byte) (int, error) {
	...
	if m.Interval != nil {
		...
		n32, err := m.Interval.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n32
	...
	if m.Timeout != nil {
		...
		n33, err := m.Timeout.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n33
...
func (m *RoleAuthorizations) Size() (n int) {
	var l int
	_ = l
	if len(m.Authorizations) > 0 {
		for _, s := range m.Authorizations {
...
func (this *RoleAuthorizations) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&RoleAuthorizations{`,
...
func (this *RootCA) String() string {
	...
	s := strings.Join([]string{`&RootCA{`,
		...
		`RoleAuthorizations:` + mapStringForRoleAuthorizations + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *RoleAuthorizations) Unmarshal(data []byte) error {
	l := len(data)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: RoleAuthorizations: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: RoleAuthorizations: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
			...
			m.Authorizations = append(m.Authorizations, string(data[iNdEx:postIndex]))
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipTypes(data[iNdEx:])
...
func (m *RootCA) Unmarshal(data []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			...
			iNdEx = postStringIndexmapkey
			if m.RoleAuthorizations == nil {
				m.RoleAuthorizations = make(map[string]RoleAuthorizations)
			}
			if iNdEx < postIndex {
				var valuekey uint64
				for shift := uint(0); ; shift += 7 {
				...
				mapvalue := &RoleAuthorizations{}
				if err := mapvalue.Unmarshal(data[iNdEx:postmsgIndex]); err != nil {
					return err
				}
				iNdEx = postmsgIndex
				m.RoleAuthorizations[mapkey] = *mapvalue
			} else {
				var mapvalue RoleAuthorizations
				m.RoleAuthorizations[mapkey] = mapvalue
			}
			iNdEx = postIndex
		default:
...
var fileDescriptorTypes = []byte{
	...
	,
}
