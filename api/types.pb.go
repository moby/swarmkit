...
type ContainerStatus struct {
	...
	Health      *HealthStatus `protobuf:"bytes,4,opt,name=health" json:"health,omitempty"`
}
...
// HealthStatus stores information about the container's healthcheck results.
...
func (*HealthStatus) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{15} }

// HealthcheckResult stores information about a single run of a healthcheck probe.
type HealthcheckResult struct {
	Start    *docker_swarmkit_v1.Timestamp `protobuf:"bytes,1,opt,name=start" json:"start,omitempty"`
	End      *docker_swarmkit_v1.Timestamp `protobuf:"bytes,2,opt,name=end" json:"end,omitempty"`
	ExitCode int32                         `protobuf:"varint,3,opt,name=exit_code,json=exitCode,proto3" json:"exit_code,omitempty"`
...
func (*HealthcheckResult) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{16} }
...
func init() {
	...
	proto.RegisterType((*HealthStatus)(nil), "docker.swarmkit.v1.HealthStatus")
	proto.RegisterType((*HealthcheckResult)(nil), "docker.swarmkit.v1.HealthcheckResult")
...
func (m *ContainerStatus) Copy() *ContainerStatus {
	...
	o := &ContainerStatus{
		...
		PID:         m.PID,
		ExitCode:    m.ExitCode,
		Health:      m.Health.Copy(),
	}

	return o
}

func (m *HealthStatus) Copy() *HealthStatus {
	if m == nil {
		return nil
	}
	...
	o := &HealthStatus{
		Status:        m.Status,
		FailingStreak: m.FailingStreak,
	}

	if m.Log != nil {
		o.Log = make([]*HealthcheckResult, 0, len(m.Log))
		for _, v := range m.Log {
			o.Log = append(o.Log, v.Copy())
		}
	}
...
func (m *HealthcheckResult) Copy() *HealthcheckResult {
	if m == nil {
		return nil
	}
...
func (this *HealthStatus) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 7)
	s = append(s, "&api.HealthStatus{")
	s = append(s, "Status: "+fmt.Sprintf("%#v", this.Status)+",\n")
	s = append(s, "FailingStreak: "+fmt.Sprintf("%#v", this.FailingStreak)+",\n")
	if this.Log != nil {
...
func (this *HealthcheckResult) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 8)
	s = append(s, "&api.HealthcheckResult{")
	if this.Start != nil {
...
func (m *ContainerStatus) MarshalTo(data []byte) (int, error) {
	...
	if m.Health != nil {
		data[i] = 0x22
		i++
		i = encodeVarintTypes(data, i, uint64(m.Health.Size()))
...
func (m *HealthStatus) MarshalTo(data []byte) (int, error) {
	...
	if m.FailingStreak != 0 {
		data[i] = 0x10
		i++
		i = encodeVarintTypes(data, i, uint64(m.FailingStreak))
	}
	if len(m.Log) > 0 {
...
func (m *HealthcheckResult) MarshalTo(data []byte) (int, error) {
	...
	if m.Start != nil {
		data[i] = 0xa
		i++
		i = encodeVarintTypes(data, i, uint64(m.Start.Size()))
	...
	if m.End != nil {
		data[i] = 0x12
		i++
		i = encodeVarintTypes(data, i, uint64(m.End.Size()))
...
func (m *HealthStatus) Size() (n int) {
	...
	if m.FailingStreak != 0 {
		n += 1 + sovTypes(uint64(m.FailingStreak))
	}
	if len(m.Log) > 0 {
		for _, e := range m.Log {
			l = e.Size()
...
func (this *HealthStatus) String() string {
	...
	s := strings.Join([]string{`&HealthStatus{`,
		...
		`FailingStreak:` + fmt.Sprintf("%v", this.FailingStreak) + `,`,
		`Log:` + strings.Replace(fmt.Sprintf("%v", this.Log), "HealthcheckResult", "HealthcheckResult", 1) + `,`,
		`}`,
	}, "")
	return s
}
func (this *HealthcheckResult) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&HealthcheckResult{`,
		`Start:` + strings.Replace(fmt.Sprintf("%v", this.Start), "Timestamp", "docker_swarmkit_v1.Timestamp", 1) + `,`,
		`End:` + strings.Replace(fmt.Sprintf("%v", this.End), "Timestamp", "docker_swarmkit_v1.Timestamp", 1) + `,`,
		`ExitCode:` + fmt.Sprintf("%v", this.ExitCode) + `,`,
...
func (m *HealthcheckResult) Unmarshal(data []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if m.Start == nil {
				m.Start = &docker_swarmkit_v1.Timestamp{}
			}
		...
		case 2:
			...
			if m.End == nil {
				m.End = &docker_swarmkit_v1.Timestamp{}
			}
...
var fileDescriptorTypes = []byte{
	...
	,
}
