...
func (m *Annotations) Equal(other interface{}) bool {
	...
	remainingIndices := make(map[int]struct{})
	for i := range o.Indices {
		remainingIndices[i] = struct{}{}
	}
outerIndices:
	for i := range m.Indices {
		for j := range remainingIndices {
			if github_com_docker_swarmkit_api_deepcompare.Equal(&m.Indices[i], &o.Indices[j]) {
				delete(remainingIndices, j)
				continue outerIndices
			}
		}
		return false
	}
...
func (m *EngineDescription) Equal(other interface{}) bool {
	...
	remainingPlugins := make(map[int]struct{})
	for i := range o.Plugins {
		remainingPlugins[i] = struct{}{}
	}
outerPlugins:
	for i := range m.Plugins {
		for j := range remainingPlugins {
			if github_com_docker_swarmkit_api_deepcompare.Equal(&m.Plugins[i], &o.Plugins[j]) {
				delete(remainingPlugins, j)
				continue outerPlugins
			}
		}
		return false
	}
...
func (m *Placement) Equal(other interface{}) bool {
	...
	remainingConstraints := make(map[int]struct{})
	for i := range o.Constraints {
		remainingConstraints[i] = struct{}{}
	}
outerConstraints:
	for i := range m.Constraints {
		for j := range remainingConstraints {
			if m.Constraints[i] != o.Constraints[j] {
				delete(remainingConstraints, j)
...
var fileDescriptorTypes = []byte{
	...
	,
}
