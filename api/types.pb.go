...
type RestartPolicy struct {
	...
	// Note: If backoff is non null then Delay will be added to the calculated
	// exponential backoff.
	...
	// Defines the backoff policy used when restarting this task.
	// The calculated backoff will be a random value from 0 to
	// min(Backoff.Max, Delay + Backoff.Factor * (2 ** failures))
	Backoff *BackoffPolicy `protobuf:"bytes,5,opt,name=backoff" json:"backoff,omitempty"`
}
...
type BackoffPolicy struct {
	// Amount backoff grows per failure
	Factor *google_protobuf1.Duration `protobuf:"bytes,1,opt,name=factor" json:"factor,omitempty"`
	// Maximum duration for a single delay to last
	Max *google_protobuf1.Duration `protobuf:"bytes,2,opt,name=max" json:"max,omitempty"`
	// Monitor indicates how long a task must run before it is considred
	// to have started successfully. If it is restarted within Monitor of
	// its creation this is counted as a failure.  If it fails after Monitor,
	// it does not.  Defaults to 5 seconds.
	// Note: can't use stdduration because this field needs to be nullable.
	Monitor *google_protobuf1.Duration `protobuf:"bytes,3,opt,name=monitor" json:"monitor,omitempty"`
}

func (m *BackoffPolicy) Reset()                    { *m = BackoffPolicy{} }
func (*BackoffPolicy) ProtoMessage()               {}
func (*BackoffPolicy) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{18} }
...
func init() {
	...
	proto.RegisterType((*BackoffPolicy)(nil), "docker.swarmkit.v1.BackoffPolicy")
...
func (m *RestartPolicy) CopyFrom(src interface{}) {
	...
	*m = *o
	...
	if o.Backoff != nil {
		m.Backoff = &BackoffPolicy{}
		github_com_docker_swarmkit_api_deepcopy.Copy(m.Backoff, o.Backoff)
	}
}

func (m *BackoffPolicy) Copy() *BackoffPolicy {
	if m == nil {
		return nil
	}
	o := &BackoffPolicy{}
...
func (m *BackoffPolicy) CopyFrom(src interface{}) {

	o := src.(*BackoffPolicy)
	*m = *o
	if o.Factor != nil {
		m.Factor = &google_protobuf1.Duration{}
		github_com_docker_swarmkit_api_deepcopy.Copy(m.Factor, o.Factor)
	}
	if o.Max != nil {
		m.Max = &google_protobuf1.Duration{}
		github_com_docker_swarmkit_api_deepcopy.Copy(m.Max, o.Max)
	}
	if o.Monitor != nil {
...
func (m *RestartPolicy) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Backoff != nil {
		...
		n16, err := m.Backoff.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n16
...
func (m *BackoffPolicy) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *BackoffPolicy) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	if m.Factor != nil {
		dAtA[i] = 0xa
		i++
		i = encodeVarintTypes(dAtA, i, uint64(m.Factor.Size()))
		n17, err := m.Factor.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n17
...
func (m *UpdateConfig) MarshalTo(dAtA []byte) (int, error) {
	...
	n20, err := github_com_gogo_protobuf_types.StdDurationMarshalTo(m.Delay, dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n20
...
func (m *TaskStatus) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.RuntimeStatus != nil {
		nn25, err := m.RuntimeStatus.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += nn25
	...
	if m.PortStatus != nil {
		...
		n26, err := m.PortStatus.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n26
	...
	if m.AppliedAt != nil {
		...
		n27, err := m.AppliedAt.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n27
...
func (m *CAConfig) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.NodeCertExpiry != nil {
		...
		n32, err := m.NodeCertExpiry.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n32
...
func (m *TaskDefaults) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.LogDriver != nil {
		...
		n33, err := m.LogDriver.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n33
...
func (m *DispatcherConfig) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.HeartbeatPeriod != nil {
		...
		n34, err := m.HeartbeatPeriod.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n34
...
func (m *PlacementPreference) MarshalTo(dAtA []byte) (int, error) {
	...
	_ = l
	if m.Preference != nil {
		nn35, err := m.Preference.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += nn35
...
func (m *PlacementPreference_Spread) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Spread != nil {
		...
		n36, err := m.Spread.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n36
...
func (m *RootCA) MarshalTo(dAtA []byte) (int, error) {
	...
	n37, err := m.JoinTokens.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n37
	if m.RootRotation != nil {
		...
		n38, err := m.RootRotation.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n38
...
func (m *BackoffPolicy) Size() (n int) {
	var l int
	_ = l
	if m.Factor != nil {
		l = m.Factor.Size()
...
func (this *RestartPolicy) String() string {
	...
	s := strings.Join([]string{`&RestartPolicy{`,
		...
		`Backoff:` + strings.Replace(fmt.Sprintf("%v", this.Backoff), "BackoffPolicy", "BackoffPolicy", 1) + `,`,
		`}`,
	}, "")
	return s
}
func (this *BackoffPolicy) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&BackoffPolicy{`,
		`Factor:` + strings.Replace(fmt.Sprintf("%v", this.Factor), "Duration", "google_protobuf1.Duration", 1) + `,`,
		`Max:` + strings.Replace(fmt.Sprintf("%v", this.Max), "Duration", "google_protobuf1.Duration", 1) + `,`,
...
func (m *BackoffPolicy) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: BackoffPolicy: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: BackoffPolicy: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
var fileDescriptorTypes = []byte{
	...
	,
}
