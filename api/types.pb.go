...
type PredefinedResources int32

const (
	// Amount of CPU cores
	CPUs PredefinedResources = 0
	// Amount of NanoCPUs (e.g. 2000000000 = 2 CPU cores)
	NanoCPUs PredefinedResources = 1
	// Memory in mb
	Memory PredefinedResources = 2
	// Memory in bytes
	MemoryBytes PredefinedResources = 3
)

var PredefinedResources_name = map[int32]string{
	0: "cpu",
	1: "nanocpu",
	2: "memory",
	3: "memorybytes",
}
var PredefinedResources_value = map[string]int32{
	"cpu":         0,
	"nanocpu":     1,
	"memory":      2,
	"memorybytes": 3,
...
func (x PredefinedResources) String() string {
	return proto.EnumName(PredefinedResources_name, int32(x))
}
func (PredefinedResources) EnumDescriptor() ([]byte, []int) { return fileDescriptorTypes, []int{0} }
...
type Resources struct {
	ScalarResources map[string]float64 `protobuf:"bytes,1,rep,name=ScalarResources,json=scalarResources" json:"ScalarResources,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"fixed64,2,opt,name=value,proto3"`
}
...
func init() {
	...
	proto.RegisterEnum("docker.cluster.api.PredefinedResources", PredefinedResources_name, PredefinedResources_value)
...
func (m *Resources) Copy() *Resources {
	...
	if m.ScalarResources != nil {
		o.ScalarResources = make(map[string]float64)
		for k, v := range m.ScalarResources {
			o.ScalarResources[k] = v
		}
	}
...
func (this *Resources) GoString() string {
	...
	for k, _ := range this.ScalarResources {
		keysForScalarResources = append(keysForScalarResources, k)
	}
	github_com_gogo_protobuf_sortkeys.Strings(keysForScalarResources)
	mapStringForScalarResources := "map[string]float64{"
	for _, k := range keysForScalarResources {
		mapStringForScalarResources += fmt.Sprintf("%#v: %#v,", k, this.ScalarResources[k])
	}
	mapStringForScalarResources += "}"
	if this.ScalarResources != nil {
		s = append(s, "ScalarResources: "+mapStringForScalarResources+",\n")
	}
	s = append(s, "}")
	return strings.Join(s, "")
}
...
func (m *Resources) MarshalTo(data []byte) (int, error) {
	...
	if len(m.ScalarResources) > 0 {
		for k, _ := range m.ScalarResources {
			data[i] = 0xa
			i++
			v := m.ScalarResources[k]
			...
			data[i] = 0x11
			i++
			i = encodeFixed64Types(data, i, uint64(math.Float64bits(float64(v))))
		}
	}
	return i, nil
}
...
func (m *Resources) Unmarshal(data []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if m.ScalarResources == nil {
				m.ScalarResources = make(map[string]float64)
			}
			m.ScalarResources[mapkey] = mapvalue
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipTypes(data[iNdEx:])
...
var fileDescriptorTypes = []byte{
	...
	,
}
