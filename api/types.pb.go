...
type CAConfig struct {
	...
	// ExternalCAURLs is a list of URLs to which a manager node will make
	// certificate signing requests for node certificates.
	ExternalCAURLs []string `protobuf:"bytes,2,rep,name=external_ca_urls,json=externalCaUrls" json:"external_ca_urls,omitempty"`
}
...
func (m *CAConfig) Copy() *CAConfig {
	...
	if m.ExternalCAURLs != nil {
		o.ExternalCAURLs = make([]string, 0, len(m.ExternalCAURLs))
		for _, v := range m.ExternalCAURLs {
			o.ExternalCAURLs = append(o.ExternalCAURLs, v)
		}
	}
...
func (this *CAConfig) GoString() string {
	...
	s = append(s, "ExternalCAURLs: "+fmt.Sprintf("%#v", this.ExternalCAURLs)+",\n")
	s = append(s, "}")
	return strings.Join(s, "")
}
...
func (m *CAConfig) MarshalTo(data []byte) (int, error) {
	...
	if len(m.ExternalCAURLs) > 0 {
		for _, s := range m.ExternalCAURLs {
			data[i] = 0x12
			i++
			l = len(s)
			for l >= 1<<7 {
...
func (this *CAConfig) String() string {
	...
	s := strings.Join([]string{`&CAConfig{`,
		...
		`ExternalCAURLs:` + fmt.Sprintf("%v", this.ExternalCAURLs) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *CAConfig) Unmarshal(data []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ExternalCAURLs", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ExternalCAURLs = append(m.ExternalCAURLs, string(data[iNdEx:postIndex]))
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipTypes(data[iNdEx:])
...
var fileDescriptorTypes = []byte{
	...
	,
}
