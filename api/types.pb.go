...
const (
	...
	TaskStatePending   TaskState = 2
	TaskStateAssigned  TaskState = 3
	TaskStateAccepted  TaskState = 4
	TaskStatePreparing TaskState = 5
	TaskStateReady     TaskState = 6
	TaskStateStarting  TaskState = 7
	TaskStateRunning   TaskState = 8
	TaskStateShutdown  TaskState = 9
	TaskStateCompleted TaskState = 10
	TaskStateFailed    TaskState = 11
	TaskStateRejected  TaskState = 12
	TaskStateFinalize  TaskState = 13
	TaskStateDead      TaskState = 14
)
...
func (Endpoint_Protocol) EnumDescriptor() ([]byte, []int) { return fileDescriptorTypes, []int{10, 0} }
...
type TaskStatus struct {
	...
	// Msg reports a message for the task status. This should provide a human
	// readable message that can point to how the task actually arrived at a
	// current state.
	//
	...
	// field.
	//
	// We abbreviate to avoid common collisions with protobuf names using
	// `Message`.
...
func (*Endpoint) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{10} }
...
func (*Driver) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{11} }
...
func (*IPAMOptions) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{12} }
...
func (*WeightedPeer) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{13} }
...
var fileDescriptorTypes = []byte{
	...
	,
}
