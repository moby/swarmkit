...
func (NodeStatus_State) EnumDescriptor() ([]byte, []int) { return fileDescriptorTypes, []int{13, 0} }
...
func (Mount_MountType) EnumDescriptor() ([]byte, []int) { return fileDescriptorTypes, []int{15, 0} }
...
func (Mount_BindOptions_MountPropagation) EnumDescriptor() ([]byte, []int) {
	return fileDescriptorTypes, []int{15, 0, 0}
}
...
func (UpdateConfig_UpdateOrder) EnumDescriptor() ([]byte, []int) {
	return fileDescriptorTypes, []int{17, 1}
}
...
func (PortConfig_Protocol) EnumDescriptor() ([]byte, []int) { return fileDescriptorTypes, []int{24, 0} }
...
func (PortConfig_PublishMode) EnumDescriptor() ([]byte, []int) {
	return fileDescriptorTypes, []int{24, 1}
}
...
func (IssuanceStatus_State) EnumDescriptor() ([]byte, []int) { return fileDescriptorTypes, []int{29, 0} }
...
type Set struct {
	Val map[string]*Set_Void `protobuf:"bytes,1,rep,name=val" json:"val,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value"`
}

func (m *Set) Reset()                    { *m = Set{} }
func (*Set) ProtoMessage()               {}
func (*Set) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{3} }

type Set_Void struct {
}

func (m *Set_Void) Reset()                    { *m = Set_Void{} }
func (*Set_Void) ProtoMessage()               {}
func (*Set_Void) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{3, 0} }
...
type ThirdPartyResource struct {
	...
	//	*ThirdPartyResource_Integer
	//	*ThirdPartyResource_Set
	Resource isThirdPartyResource_Resource `protobuf_oneof:"resource"`
}

func (m *ThirdPartyResource) Reset()                    { *m = ThirdPartyResource{} }
func (*ThirdPartyResource) ProtoMessage()               {}
func (*ThirdPartyResource) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{5} }

type isThirdPartyResource_Resource interface {
	isThirdPartyResource_Resource()
	MarshalTo([]byte) (int, error)
	Size() int
}

type ThirdPartyResource_Integer struct {
	Integer *Integer `protobuf:"bytes,1,opt,name=integer,oneof"`
}
type ThirdPartyResource_Set struct {
	Set *Set `protobuf:"bytes,2,opt,name=set,oneof"`
}

func (*ThirdPartyResource_Integer) isThirdPartyResource_Resource() {}
func (*ThirdPartyResource_Set) isThirdPartyResource_Resource()     {}

func (m *ThirdPartyResource) GetResource() isThirdPartyResource_Resource {
	if m != nil {
		return m.Resource
	}
	return nil
...
func (m *ThirdPartyResource) GetInteger() *Integer {
	if x, ok := m.GetResource().(*ThirdPartyResource_Integer); ok {
		return x.Integer
	}
	return nil
}

func (m *ThirdPartyResource) GetSet() *Set {
	if x, ok := m.GetResource().(*ThirdPartyResource_Set); ok {
		return x.Set
	}
	return nil
}
...
func (*ThirdPartyResource) XXX_OneofFuncs() (func(msg proto.Message, b *proto.Buffer) error, func(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error), func(msg proto.Message) (n int), []interface{}) {
	return _ThirdPartyResource_OneofMarshaler, _ThirdPartyResource_OneofUnmarshaler, _ThirdPartyResource_OneofSizer, []interface{}{
		(*ThirdPartyResource_Integer)(nil),
		(*ThirdPartyResource_Set)(nil),
	}
}

func _ThirdPartyResource_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	m := msg.(*ThirdPartyResource)
	// resource
	switch x := m.Resource.(type) {
	case *ThirdPartyResource_Integer:
		_ = b.EncodeVarint(1<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.Integer); err != nil {
			return err
		}
	case *ThirdPartyResource_Set:
	...
	case nil:
	default:
		return fmt.Errorf("ThirdPartyResource.Resource has unexpected type %T", x)
	}
	return nil
}

func _ThirdPartyResource_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	m := msg.(*ThirdPartyResource)
	switch tag {
	case 1: // resource.integer
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(Integer)
		err := b.DecodeMessage(msg)
		m.Resource = &ThirdPartyResource_Integer{msg}
		return true, err
	case 2: // resource.set
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		...
		msg := new(Set)
		err := b.DecodeMessage(msg)
		m.Resource = &ThirdPartyResource_Set{msg}
		return true, err
	default:
		return false, nil
	}
...
func _ThirdPartyResource_OneofSizer(msg proto.Message) (n int) {
	m := msg.(*ThirdPartyResource)
	// resource
	switch x := m.Resource.(type) {
	case *ThirdPartyResource_Integer:
...
type Resources struct {
	...
	ThirdParty map[string]*ThirdPartyResource `protobuf:"bytes,3,rep,name=third_party,json=thirdParty" json:"third_party,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value"`
}
...
func (*RaftMemberStatus) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{12} }
...
func (*NodeStatus) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{13} }
...
func (*Image) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{14} }
...
func (*Mount) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{15} }
...
func (*Mount_BindOptions) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{15, 0} }
...
func (*Mount_VolumeOptions) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{15, 1} }
...
func (*Mount_TmpfsOptions) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{15, 2} }
...
func (*RestartPolicy) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{16} }
...
func (*UpdateConfig) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{17} }
...
func (*UpdateStatus) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{18} }
...
func (*ContainerStatus) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{19} }
...
func (*PortStatus) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{20} }
...
func (*TaskStatus) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{21} }
...
func (*NetworkAttachmentConfig) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{22} }
...
func (*IPAMConfig) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{23} }
...
func (*PortConfig) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{24} }
...
func (*Driver) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{25} }
...
func (*IPAMOptions) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{26} }
...
func (*Peer) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{27} }
...
func (*WeightedPeer) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{28} }
...
func (*IssuanceStatus) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{29} }
...
func (*AcceptancePolicy) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{30} }
...
func (*AcceptancePolicy_RoleAdmissionPolicy_Secret) Descriptor() ([]byte, []int) {
	return fileDescriptorTypes, []int{30, 0, 0}
}
...
func (*ExternalCA) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{31} }
...
func (*CAConfig) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{32} }
...
func (*OrchestrationConfig) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{33} }
...
func (*TaskDefaults) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{34} }
...
func (*DispatcherConfig) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{35} }
...
func (*RaftConfig) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{36} }
...
func (*EncryptionConfig) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{37} }
...
func (*SpreadOver) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{38} }
...
func (*PlacementPreference) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{39} }
...
func (*Placement) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{40} }
...
func (*JoinTokens) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{41} }
...
func (*RootCA) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{42} }
...
func (*Certificate) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{43} }
...
func (*EncryptionKey) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{44} }
...
func (*ManagerStatus) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{45} }
...
func (*SecretReference) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{46} }
...
func init() {
	...
	proto.RegisterType((*Set)(nil), "docker.swarmkit.v1.Set")
	proto.RegisterType((*Set_Void)(nil), "docker.swarmkit.v1.Set.Void")
	proto.RegisterType((*Integer)(nil), "docker.swarmkit.v1.Integer")
	proto.RegisterType((*ThirdPartyResource)(nil), "docker.swarmkit.v1.ThirdPartyResource")
...
func (m *Set) CopyFrom(src interface{}) {

	o := src.(*Set)
	*m = *o
	if o.Val != nil {
		m.Val = make(map[string]*Set_Void, len(o.Val))
		for k, v := range o.Val {
			m.Val[k] = &Set_Void{}
			github_com_docker_swarmkit_api_deepcopy.Copy(m.Val[k], v)
		}
	}

}

func (m *Set_Void) Copy() *Set_Void {
	if m == nil {
		return nil
	}
	o := &Set_Void{}
...
func (m *Set_Void) CopyFrom(src interface{}) {}
func (m *Integer) Copy() *Integer {
	if m == nil {
		return nil
	}
	o := &Integer{}
...
func (m *Integer) CopyFrom(src interface{}) {

	o := src.(*Integer)
	*m = *o
}

func (m *ThirdPartyResource) Copy() *ThirdPartyResource {
	if m == nil {
		return nil
	}
	o := &ThirdPartyResource{}
	o.CopyFrom(m)
	return o
}

func (m *ThirdPartyResource) CopyFrom(src interface{}) {

	o := src.(*ThirdPartyResource)
	*m = *o
	if o.Resource != nil {
		switch o.Resource.(type) {
		case *ThirdPartyResource_Integer:
			v := ThirdPartyResource_Integer{
				Integer: &Integer{},
			}
			github_com_docker_swarmkit_api_deepcopy.Copy(v.Integer, o.GetInteger())
			m.Resource = &v
		case *ThirdPartyResource_Set:
			v := ThirdPartyResource_Set{
				Set: &Set{},
			}
...
func (m *Resources) CopyFrom(src interface{}) {
	...
	*m = *o
	if o.ThirdParty != nil {
		m.ThirdParty = make(map[string]*ThirdPartyResource, len(o.ThirdParty))
		for k, v := range o.ThirdParty {
			m.ThirdParty[k] = &ThirdPartyResource{}
			github_com_docker_swarmkit_api_deepcopy.Copy(m.ThirdParty[k], v)
		}
	}
...
func (m *Set_Void) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *Set_Void) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *ThirdPartyResource) MarshalTo(dAtA []byte) (int, error) {
	...
	_ = l
	if m.Resource != nil {
		nn2, err := m.Resource.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += nn2
...
func (m *ThirdPartyResource_Integer) MarshalTo(dAtA []byte) (int, error) {
	i := 0
	if m.Integer != nil {
		dAtA[i] = 0xa
		i++
		i = encodeVarintTypes(dAtA, i, uint64(m.Integer.Size()))
		n3, err := m.Integer.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n3
...
func (m *ThirdPartyResource_Set) MarshalTo(dAtA []byte) (int, error) {
	i := 0
	if m.Set != nil {
		dAtA[i] = 0x12
		i++
		i = encodeVarintTypes(dAtA, i, uint64(m.Set.Size()))
...
func (m *ResourceRequirements) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Limits != nil {
		...
		n6, err := m.Limits.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n6
	...
	if m.Reservations != nil {
		...
		n7, err := m.Reservations.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n7
...
func (m *Mount) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.BindOptions != nil {
		...
		n11, err := m.BindOptions.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n11
	...
	if m.VolumeOptions != nil {
		...
		n12, err := m.VolumeOptions.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n12
	...
	if m.TmpfsOptions != nil {
		...
		n13, err := m.TmpfsOptions.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n13
...
func (m *Mount_VolumeOptions) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.DriverConfig != nil {
		...
		n14, err := m.DriverConfig.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n14
...
func (m *RestartPolicy) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Delay != nil {
		...
		n15, err := m.Delay.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n15
	...
	if m.Window != nil {
		...
		n16, err := m.Window.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n16
...
func (m *UpdateConfig) MarshalTo(dAtA []byte) (int, error) {
	...
	n17, err := github_com_gogo_protobuf_types.StdDurationMarshalTo(m.Delay, dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n17
	...
	if m.Monitor != nil {
		...
		n18, err := m.Monitor.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n18
...
func (m *UpdateStatus) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.CompletedAt != nil {
		...
		n20, err := m.CompletedAt.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n20
...
func (m *BlacklistedCertificate) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Expiry != nil {
		...
		n38, err := m.Expiry.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n38
...
func (m *HealthConfig) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Timeout != nil {
		...
		n40, err := m.Timeout.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n40
	...
	if m.StartPeriod != nil {
		...
		n41, err := m.StartPeriod.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n41
...
func (m *ThirdPartyResource_Integer) Size() (n int) {
	var l int
	_ = l
	if m.Integer != nil {
		l = m.Integer.Size()
...
func (m *ThirdPartyResource_Set) Size() (n int) {
	var l int
	_ = l
	if m.Set != nil {
		l = m.Set.Size()
...
func (this *Set) String() string {
	...
	keysForVal := make([]string, 0, len(this.Val))
	for k, _ := range this.Val {
		keysForVal = append(keysForVal, k)
	}
	github_com_gogo_protobuf_sortkeys.Strings(keysForVal)
	mapStringForVal := "map[string]*Set_Void{"
	for _, k := range keysForVal {
		mapStringForVal += fmt.Sprintf("%v: %v,", k, this.Val[k])
	}
	mapStringForVal += "}"
...
func (this *Set_Void) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&Set_Void{`,
		`}`,
	}, "")
	return s
}
...
func (this *ThirdPartyResource_Integer) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&ThirdPartyResource_Integer{`,
		`Integer:` + strings.Replace(fmt.Sprintf("%v", this.Integer), "Integer", "Integer", 1) + `,`,
		`}`,
	}, "")
	return s
}
func (this *ThirdPartyResource_Set) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&ThirdPartyResource_Set{`,
		`Set:` + strings.Replace(fmt.Sprintf("%v", this.Set), "Set", "Set", 1) + `,`,
		`}`,
	}, "")
	return s
}
func (this *Resources) String() string {
	...
	keysForThirdParty := make([]string, 0, len(this.ThirdParty))
	for k, _ := range this.ThirdParty {
		keysForThirdParty = append(keysForThirdParty, k)
	}
	github_com_gogo_protobuf_sortkeys.Strings(keysForThirdParty)
	mapStringForThirdParty := "map[string]*ThirdPartyResource{"
	for _, k := range keysForThirdParty {
		mapStringForThirdParty += fmt.Sprintf("%v: %v,", k, this.ThirdParty[k])
	}
	mapStringForThirdParty += "}"
	s := strings.Join([]string{`&Resources{`,
		`NanoCPUs:` + fmt.Sprintf("%v", this.NanoCPUs) + `,`,
		`MemoryBytes:` + fmt.Sprintf("%v", this.MemoryBytes) + `,`,
		`ThirdParty:` + mapStringForThirdParty + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *Set) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			iNdEx = postStringIndexmapkey
			if m.Val == nil {
				m.Val = make(map[string]*Set_Void)
			}
			if iNdEx < postIndex {
				var valuekey uint64
				for shift := uint(0); ; shift += 7 {
				...
				iNdEx = postmsgIndex
				m.Val[mapkey] = mapvalue
			} else {
				var mapvalue *Set_Void
				m.Val[mapkey] = mapvalue
			}
			iNdEx = postIndex
		default:
...
func (m *Set_Void) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
...
func (m *ThirdPartyResource) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.Resource = &ThirdPartyResource_Integer{v}
			iNdEx = postIndex
		case 2:
			if wireType != 2 {
			...
			m.Resource = &ThirdPartyResource_Set{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipTypes(dAtA[iNdEx:])
...
func (m *Resources) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			iNdEx = postStringIndexmapkey
			if m.ThirdParty == nil {
				m.ThirdParty = make(map[string]*ThirdPartyResource)
			}
			if iNdEx < postIndex {
				var valuekey uint64
				for shift := uint(0); ; shift += 7 {
				...
				mapvalue := &ThirdPartyResource{}
				if err := mapvalue.Unmarshal(dAtA[iNdEx:postmsgIndex]); err != nil {
					return err
				}
				iNdEx = postmsgIndex
				m.ThirdParty[mapkey] = mapvalue
			} else {
				var mapvalue *ThirdPartyResource
				m.ThirdParty[mapkey] = mapvalue
			}
			iNdEx = postIndex
		default:
...
var fileDescriptorTypes = []byte{
	...
	,
}
