...
type UpdateConfig struct {
	...
	// MonitoringPeriod indicates how long to monitor a task for failure
	// after it is created. If the task fails by ending up in one of the
	// states REJECTED, COMPLETED, or FAILED, within MonitoringPeriod
	...
	MonitoringPeriod *docker_swarmkit_v11.Duration `protobuf:"bytes,4,opt,name=monitoring_period,json=monitoringPeriod" json:"monitoring_period,omitempty"`
	// AllowedFailureFraction is the fraction of tasks that may fail during
	// an update before the failure action is invoked. Any task created by
	// the current update which ends up in one of the states REJECTED,
	// COMPLETED or FAILED within MonitoringPeriod from its creation counts
	// as a failure. The number of failures is divided by the number of
	// tasks being updated, and if this fraction is greater than
...
type UpdateStatus struct {
	...
	RollbackStartedAt *docker_swarmkit_v1.Timestamp `protobuf:"bytes,5,opt,name=rollback_started_at,json=rollbackStartedAt" json:"rollback_started_at,omitempty"`
...
func (m *UpdateConfig) Copy() *UpdateConfig {
	...
	o := &UpdateConfig{
		...
		MonitoringPeriod:       m.MonitoringPeriod.Copy(),
...
func (m *UpdateStatus) Copy() *UpdateStatus {
	...
	o := &UpdateStatus{
		...
		RollbackStartedAt: m.RollbackStartedAt.Copy(),
		Message:           m.Message,
	}
...
func (this *UpdateConfig) GoString() string {
	...
	if this.MonitoringPeriod != nil {
		s = append(s, "MonitoringPeriod: "+fmt.Sprintf("%#v", this.MonitoringPeriod)+",\n")
	}
...
func (this *UpdateStatus) GoString() string {
	...
	if this.RollbackStartedAt != nil {
		s = append(s, "RollbackStartedAt: "+fmt.Sprintf("%#v", this.RollbackStartedAt)+",\n")
	}
	s = append(s, "Message: "+fmt.Sprintf("%#v", this.Message)+",\n")
	s = append(s, "}")
	return strings.Join(s, "")
...
func (m *UpdateConfig) MarshalTo(data []byte) (int, error) {
	...
	if m.MonitoringPeriod != nil {
		data[i] = 0x22
		i++
		i = encodeVarintTypes(data, i, uint64(m.MonitoringPeriod.Size()))
		n13, err := m.MonitoringPeriod.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n13
...
func (m *UpdateStatus) MarshalTo(data []byte) (int, error) {
	...
	if m.RollbackStartedAt != nil {
		data[i] = 0x2a
		i++
		i = encodeVarintTypes(data, i, uint64(m.RollbackStartedAt.Size()))
		n16, err := m.RollbackStartedAt.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n16
...
func (this *UpdateConfig) String() string {
	...
	s := strings.Join([]string{`&UpdateConfig{`,
		...
		`MonitoringPeriod:` + strings.Replace(fmt.Sprintf("%v", this.MonitoringPeriod), "Duration", "docker_swarmkit_v11.Duration", 1) + `,`,
...
func (this *UpdateStatus) String() string {
	...
	s := strings.Join([]string{`&UpdateStatus{`,
		...
		`Message:` + fmt.Sprintf("%v", this.Message) + `,`,
		`RollbackStartedAt:` + strings.Replace(fmt.Sprintf("%v", this.RollbackStartedAt), "Timestamp", "docker_swarmkit_v1.Timestamp", 1) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *UpdateConfig) Unmarshal(data []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field MonitoringPeriod", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.MonitoringPeriod == nil {
				m.MonitoringPeriod = &docker_swarmkit_v11.Duration{}
			}
			if err := m.MonitoringPeriod.Unmarshal(data[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 5:
...
func (m *UpdateStatus) Unmarshal(data []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field RollbackStartedAt", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.RollbackStartedAt == nil {
				m.RollbackStartedAt = &docker_swarmkit_v1.Timestamp{}
			}
			if err := m.RollbackStartedAt.Unmarshal(data[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
var fileDescriptorTypes = []byte{
	...
	,
}
