...
// SecretsConfig specifies cluster-level secrets settings.
type SecretsConfig struct {
	// MaxSecrets specifies how many user-specified secrets there can be.  A value
	// of 0 will be interpreted as the default maximum value.
	MaxSecrets uint32 `protobuf:"varint,1,opt,name=max_secrets,json=maxSecrets,proto3" json:"max_secrets,omitempty"`
	// MaxSecretRevisions specifies how many revisions of a secret there can be.  A
	// value of 0 will be interpreted as the default maximum value.
	// If this value is decreased, there will be no change to existing secrets
	// until the next update, after which extra revisions will be culled.
	MaxSecretRevisions uint32 `protobuf:"varint,2,opt,name=max_secret_revisions,json=maxSecretRevisions,proto3" json:"max_secret_revisions,omitempty"`
}

func (m *SecretsConfig) Reset()                    { *m = SecretsConfig{} }
func (*SecretsConfig) ProtoMessage()               {}
func (*SecretsConfig) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{32} }
...
type SecretReference struct {
	...
	Name string `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty"`
	// SecretValueID represents the ID of the specific Secret version that we're
	// referencing. This identifier exists so that SecretReferences don't leak
	// any information about the secret contents.
	SecretValueID string `protobuf:"bytes,2,opt,name=secret_value_id,json=secretValueId,proto3" json:"secret_value_id,omitempty"`
...
func init() {
	...
	proto.RegisterType((*SecretsConfig)(nil), "docker.swarmkit.v1.SecretsConfig")
...
func (m *SecretsConfig) Copy() *SecretsConfig {
	if m == nil {
		return nil
	}

	o := &SecretsConfig{
		MaxSecrets:         m.MaxSecrets,
		MaxSecretRevisions: m.MaxSecretRevisions,
	}
...
func (this *SecretsConfig) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 6)
	s = append(s, "&api.SecretsConfig{")
	s = append(s, "MaxSecrets: "+fmt.Sprintf("%#v", this.MaxSecrets)+",\n")
...
func (m *SecretsConfig) Marshal() (data []byte, err error) {
	size := m.Size()
	data = make([]byte, size)
	n, err := m.MarshalTo(data)
	if err != nil {
...
func (m *SecretsConfig) MarshalTo(data []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	if m.MaxSecrets != 0 {
		data[i] = 0x8
		i++
		i = encodeVarintTypes(data, i, uint64(m.MaxSecrets))
	}
	if m.MaxSecretRevisions != 0 {
		data[i] = 0x10
		i++
		i = encodeVarintTypes(data, i, uint64(m.MaxSecretRevisions))
	}
	return i, nil
}
...
func (m *SecretReference) MarshalTo(data []byte) (int, error) {
	...
	if len(m.SecretValueID) > 0 {
		data[i] = 0x12
		i++
		i = encodeVarintTypes(data, i, uint64(len(m.SecretValueID)))
		i += copy(data[i:], m.SecretValueID)
	}
	if m.Mode != 0 {
		data[i] = 0x18
		i++
...
func (m *SecretsConfig) Size() (n int) {
	var l int
	_ = l
	if m.MaxSecrets != 0 {
		n += 1 + sovTypes(uint64(m.MaxSecrets))
	}
	if m.MaxSecretRevisions != 0 {
		n += 1 + sovTypes(uint64(m.MaxSecretRevisions))
	}
	return n
}
...
func (this *SecretsConfig) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&SecretsConfig{`,
		`MaxSecrets:` + fmt.Sprintf("%v", this.MaxSecrets) + `,`,
		`MaxSecretRevisions:` + fmt.Sprintf("%v", this.MaxSecretRevisions) + `,`,
		`}`,
	}, "")
	return s
}
...
func (this *SecretReference) String() string {
	...
	s := strings.Join([]string{`&SecretReference{`,
		`Name:` + fmt.Sprintf("%v", this.Name) + `,`,
		`SecretValueID:` + fmt.Sprintf("%v", this.SecretValueID) + `,`,
		`Mode:` + fmt.Sprintf("%v", this.Mode) + `,`,
		`Target:` + fmt.Sprintf("%v", this.Target) + `,`,
		`}`,
	}, "")
...
func (m *SecretsConfig) Unmarshal(data []byte) error {
	l := len(data)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: SecretsConfig: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: SecretsConfig: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field MaxSecrets", wireType)
			}
			m.MaxSecrets = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := data[iNdEx]
				iNdEx++
				m.MaxSecrets |= (uint32(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 2:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field MaxSecretRevisions", wireType)
			}
			m.MaxSecretRevisions = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowTypes
				}
				...
				b := data[iNdEx]
				iNdEx++
				m.MaxSecretRevisions |= (uint32(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *SecretReference) Unmarshal(data []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field SecretValueID", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.SecretValueID = string(data[iNdEx:postIndex])
			iNdEx = postIndex
		case 3:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field Mode", wireType)
...
var fileDescriptorTypes = []byte{
	...
	,
}
