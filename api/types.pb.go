...
type RaftMemberStatus_State int32

const (
	// Unknown indicates that the manager state cannot be resolved
	RaftMemberStatus_UNKNOWN RaftMemberStatus_State = 0
	// Unreachable indicates that the node cannot be contacted by other
	// raft cluster members.
	RaftMemberStatus_UNREACHABLE RaftMemberStatus_State = 1
	// Reachable indicates that the node is healthy and reachable
	// by other members.
	RaftMemberStatus_REACHABLE RaftMemberStatus_State = 2
)

var RaftMemberStatus_State_name = map[int32]string{
	0: "UNKNOWN",
	1: "UNREACHABLE",
	2: "REACHABLE",
}
var RaftMemberStatus_State_value = map[string]int32{
	"UNKNOWN":     0,
	"UNREACHABLE": 1,
	"REACHABLE":   2,
}

func (x RaftMemberStatus_State) String() string {
	return proto.EnumName(RaftMemberStatus_State_name, int32(x))
}
func (RaftMemberStatus_State) EnumDescriptor() ([]byte, []int) {
...
type RaftMemberStatus struct {
	...
	State   RaftMemberStatus_State `protobuf:"varint,2,opt,name=state,proto3,enum=docker.cluster.api.RaftMemberStatus_State" json:"state,omitempty"`
...
func (*Manager) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{25} }
...
type RaftMember struct {
	...
	// NodeID is the ID attached to the certificate.
...
func init() {
	...
	proto.RegisterEnum("docker.cluster.api.RaftMemberStatus_State", RaftMemberStatus_State_name, RaftMemberStatus_State_value)
...
func (m *Manager) MarshalTo(data []byte) (int, error) {
	...
	n10, err := m.Raft.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n10
	...
	for iNdEx < l {
		...
		case 2:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := data[iNdEx]
				iNdEx++
				m.State |= (RaftMemberStatus_State(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
var fileDescriptorTypes = []byte{
	...
	,
}
