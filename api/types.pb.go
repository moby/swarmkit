...
func (Placement_Strategy) EnumDescriptor() ([]byte, []int) { return fileDescriptorTypes, []int{27, 0} }
...
// NodePortRangeConfig specifies the range from which node ports have
// to be allocated for exposed ports in services.
type NodePortRangeConfig struct {
	// Port range for protocol UDP
	UdpRange *NodePortRangeConfig_PortRange `protobuf:"bytes,1,opt,name=udp_range,json=udpRange" json:"udp_range,omitempty"`
	TcpRange *NodePortRangeConfig_PortRange `protobuf:"bytes,2,opt,name=tcp_range,json=tcpRange" json:"tcp_range,omitempty"`
}

func (m *NodePortRangeConfig) Reset()                    { *m = NodePortRangeConfig{} }
func (*NodePortRangeConfig) ProtoMessage()               {}
func (*NodePortRangeConfig) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{17} }

// PortRange specifies the range interval. Both start and end
// are inclusive.
type NodePortRangeConfig_PortRange struct {
	Start uint32 `protobuf:"varint,1,opt,name=start,proto3" json:"start,omitempty"`
	End   uint32 `protobuf:"varint,2,opt,name=end,proto3" json:"end,omitempty"`
}

func (m *NodePortRangeConfig_PortRange) Reset()      { *m = NodePortRangeConfig_PortRange{} }
func (*NodePortRangeConfig_PortRange) ProtoMessage() {}
func (*NodePortRangeConfig_PortRange) Descriptor() ([]byte, []int) {
...
func init() {
	...
	proto.RegisterType((*NodePortRangeConfig)(nil), "docker.cluster.api.NodePortRangeConfig")
	proto.RegisterType((*NodePortRangeConfig_PortRange)(nil), "docker.cluster.api.NodePortRangeConfig.PortRange")
...
func (m *NodePortRangeConfig) Copy() *NodePortRangeConfig {
	if m == nil {
		return nil
	}

	o := &NodePortRangeConfig{
		UdpRange: m.UdpRange.Copy(),
		TcpRange: m.TcpRange.Copy(),
	}

	return o
}

func (m *NodePortRangeConfig_PortRange) Copy() *NodePortRangeConfig_PortRange {
	if m == nil {
		return nil
	}

	o := &NodePortRangeConfig_PortRange{
		Start: m.Start,
		End:   m.End,
	}
...
func (this *NodePortRangeConfig) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 6)
	s = append(s, "&api.NodePortRangeConfig{")
	if this.UdpRange != nil {
		s = append(s, "UdpRange: "+fmt.Sprintf("%#v", this.UdpRange)+",\n")
	}
	if this.TcpRange != nil {
		s = append(s, "TcpRange: "+fmt.Sprintf("%#v", this.TcpRange)+",\n")
	}
	s = append(s, "}")
	return strings.Join(s, "")
}
func (this *NodePortRangeConfig_PortRange) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 6)
	s = append(s, "&api.NodePortRangeConfig_PortRange{")
...
func (m *NodePortRangeConfig) Marshal() (data []byte, err error) {
	size := m.Size()
	data = make([]byte, size)
	n, err := m.MarshalTo(data)
	if err != nil {
...
func (m *NodePortRangeConfig) MarshalTo(data []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	if m.UdpRange != nil {
		data[i] = 0xa
		i++
		i = encodeVarintTypes(data, i, uint64(m.UdpRange.Size()))
		n9, err := m.UdpRange.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n9
	...
	if m.TcpRange != nil {
		data[i] = 0x12
		i++
		i = encodeVarintTypes(data, i, uint64(m.TcpRange.Size()))
		n10, err := m.TcpRange.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n10
...
func (m *NodePortRangeConfig_PortRange) Marshal() (data []byte, err error) {
	size := m.Size()
	data = make([]byte, size)
	n, err := m.MarshalTo(data)
	if err != nil {
...
func (m *NodePortRangeConfig_PortRange) MarshalTo(data []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *NodePortRangeConfig) Size() (n int) {
	var l int
	_ = l
	if m.UdpRange != nil {
		l = m.UdpRange.Size()
...
func (m *NodePortRangeConfig_PortRange) Size() (n int) {
	var l int
	_ = l
	if m.Start != 0 {
...
func (this *NodePortRangeConfig) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&NodePortRangeConfig{`,
		`UdpRange:` + strings.Replace(fmt.Sprintf("%v", this.UdpRange), "NodePortRangeConfig_PortRange", "NodePortRangeConfig_PortRange", 1) + `,`,
		`TcpRange:` + strings.Replace(fmt.Sprintf("%v", this.TcpRange), "NodePortRangeConfig_PortRange", "NodePortRangeConfig_PortRange", 1) + `,`,
		`}`,
	}, "")
	return s
}
func (this *NodePortRangeConfig_PortRange) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&NodePortRangeConfig_PortRange{`,
...
func (m *NodePortRangeConfig) Unmarshal(data []byte) error {
	l := len(data)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: NodePortRangeConfig: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: NodePortRangeConfig: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field UdpRange", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.UdpRange == nil {
				m.UdpRange = &NodePortRangeConfig_PortRange{}
			}
			if err := m.UdpRange.Unmarshal(data[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field TcpRange", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.TcpRange == nil {
				m.TcpRange = &NodePortRangeConfig_PortRange{}
			}
			if err := m.TcpRange.Unmarshal(data[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *NodePortRangeConfig_PortRange) Unmarshal(data []byte) error {
	l := len(data)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
...
var fileDescriptorTypes = []byte{
	...
	,
}
