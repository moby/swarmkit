...
import (
	...
	"github.com/docker/libswarm/cmd/swarmctl/cluster"
	"github.com/docker/libswarm/cmd/swarmctl/network"
	"github.com/docker/libswarm/cmd/swarmctl/node"
	"github.com/docker/libswarm/cmd/swarmctl/root"
	"github.com/docker/libswarm/cmd/swarmctl/service"
