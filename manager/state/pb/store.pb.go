...
type StoreSnapshot struct {
	...
	Jobs     []*docker_cluster_api2.Job     `protobuf:"bytes,2,rep,name=jobs" json:"jobs,omitempty"`
...
func (this *StoreSnapshot) String() string {
	...
	s := strings.Join([]string{`&StoreSnapshot{`,
		...
		`Jobs:` + strings.Replace(fmt.Sprintf("%v", this.Jobs), "Job", "docker_cluster_api2.Job", 1) + `,`,
...
func (m *StoreSnapshot) Unmarshal(data []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			m.Jobs = append(m.Jobs, &docker_cluster_api2.Job{})
...
var fileDescriptorStore = []byte{
	...
	,
}
