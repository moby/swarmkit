...
type StoreSnapshot struct {
	Nodes    []*docker_cluster_api.Node    `protobuf:"bytes,1,rep,name=nodes" json:"nodes,omitempty"`
	Jobs     []*docker_cluster_api.Job     `protobuf:"bytes,2,rep,name=jobs" json:"jobs,omitempty"`
	Networks []*docker_cluster_api.Network `protobuf:"bytes,3,rep,name=networks" json:"networks,omitempty"`
	Tasks    []*docker_cluster_api.Task    `protobuf:"bytes,4,rep,name=tasks" json:"tasks,omitempty"`
	Volumes  []*docker_cluster_api.Volume  `protobuf:"bytes,5,rep,name=volumes" json:"volumes,omitempty"`
}
...
var fileDescriptorStore = []byte{
	...
	,
}
