...
type GetNodeResponse struct {
	Node *docker_cluster_objects.Node `protobuf:"bytes,1,opt,name=node" json:"node,omitempty"`
}
...
type UpdateNodeRequest struct {
	NodeID string                         `protobuf:"bytes,1,opt,name=node_id,json=nodeId,proto3" json:"node_id,omitempty"`
	Spec   *docker_cluster_specs.NodeSpec `protobuf:"bytes,2,opt,name=spec" json:"spec,omitempty"`
}
...
type CreateTaskRequest struct {
	Spec *docker_cluster_specs.JobSpec `protobuf:"bytes,1,opt,name=spec" json:"spec,omitempty"`
}
...
type CreateTaskResponse struct {
	Task *docker_cluster_objects.Task `protobuf:"bytes,1,opt,name=task" json:"task,omitempty"`
}
...
type CreateJobResponse struct {
	Job *docker_cluster_objects.Job `protobuf:"bytes,1,opt,name=job" json:"job,omitempty"`
}
...
type UpdateJobRequest struct {
	JobID string                        `protobuf:"bytes,1,opt,name=job_id,json=jobId,proto3" json:"job_id,omitempty"`
	Spec  *docker_cluster_specs.JobSpec `protobuf:"bytes,2,opt,name=spec" json:"spec,omitempty"`
}
...
type ListJobsResponse struct {
	Jobs []*docker_cluster_objects.Job `protobuf:"bytes,1,rep,name=jobs" json:"jobs,omitempty"`
}
...
type CreateNetworkRequest struct {
	Spec *docker_cluster_specs.NetworkSpec `protobuf:"bytes,1,opt,name=spec" json:"spec,omitempty"`
}
...
type CreateNetworkResponse struct {
	Network *docker_cluster_objects.Network `protobuf:"bytes,1,opt,name=network" json:"network,omitempty"`
}
...
type ListNetworksResponse struct {
	Networks []*docker_cluster_objects.Network `protobuf:"bytes,1,rep,name=networks" json:"networks,omitempty"`
}
...
type CreateVolumeRequest struct {
	Spec *docker_cluster_specs.VolumeSpec `protobuf:"bytes,1,opt,name=spec" json:"spec,omitempty"`
}
...
type CreateVolumeResponse struct {
	Volume *docker_cluster_objects.Volume `protobuf:"bytes,1,opt,name=volume" json:"volume,omitempty"`
}
...
type ListVolumesResponse struct {
	Volumes []*docker_cluster_objects.Volume `protobuf:"bytes,1,rep,name=volumes" json:"volumes,omitempty"`
}
...
func (m *ListNodesResponse) Copy() *ListNodesResponse {
	...
	if m.Nodes != nil {
		o.Nodes = make([]*docker_cluster_objects.Node, 0, len(m.Nodes))
...
func (m *ListJobsResponse) Copy() *ListJobsResponse {
	...
	if m.Jobs != nil {
		o.Jobs = make([]*docker_cluster_objects.Job, 0, len(m.Jobs))
...
func (m *ListNetworksResponse) Copy() *ListNetworksResponse {
	...
	if m.Networks != nil {
		o.Networks = make([]*docker_cluster_objects.Network, 0, len(m.Networks))
...
func (m *ListVolumesResponse) Copy() *ListVolumesResponse {
	...
	if m.Volumes != nil {
		o.Volumes = make([]*docker_cluster_objects.Volume, 0, len(m.Volumes))
...
func (m *GetNodeResponse) Unmarshal(data []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if m.Node == nil {
				m.Node = &docker_cluster_objects.Node{}
			}
...
func (m *CreateTaskResponse) Unmarshal(data []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if m.Task == nil {
				m.Task = &docker_cluster_objects.Task{}
			}
...
func (m *CreateJobResponse) Unmarshal(data []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if m.Job == nil {
				m.Job = &docker_cluster_objects.Job{}
			}
...
func (m *CreateNetworkResponse) Unmarshal(data []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if m.Network == nil {
				m.Network = &docker_cluster_objects.Network{}
			}
...
func (m *CreateVolumeResponse) Unmarshal(data []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if m.Volume == nil {
				m.Volume = &docker_cluster_objects.Volume{}
			}
...
var fileDescriptorCluster = []byte{
	...
	,
}
