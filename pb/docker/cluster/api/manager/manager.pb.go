...
func init() {
	proto.RegisterType((*JoinRequest)(nil), "docker.cluster.api.manager.JoinRequest")
	proto.RegisterType((*JoinResponse)(nil), "docker.cluster.api.manager.JoinResponse")
	proto.RegisterType((*LeaveRequest)(nil), "docker.cluster.api.manager.LeaveRequest")
	proto.RegisterType((*LeaveResponse)(nil), "docker.cluster.api.manager.LeaveResponse")
	proto.RegisterType((*ProcessRaftMessageRequest)(nil), "docker.cluster.api.manager.ProcessRaftMessageRequest")
	proto.RegisterType((*ProcessRaftMessageResponse)(nil), "docker.cluster.api.manager.ProcessRaftMessageResponse")
	proto.RegisterType((*RaftNode)(nil), "docker.cluster.api.manager.RaftNode")
	proto.RegisterType((*Pair)(nil), "docker.cluster.api.manager.Pair")
	proto.RegisterType((*NodeCountRequest)(nil), "docker.cluster.api.manager.NodeCountRequest")
	proto.RegisterType((*NodeCountResponse)(nil), "docker.cluster.api.manager.NodeCountResponse")
}
func (this *JoinRequest) GoString() string {
	...
	s := make([]string, 0, 5)
	s = append(s, "&manager.JoinRequest{")
	if this.Node != nil {
...
func (this *JoinResponse) GoString() string {
	...
	s := make([]string, 0, 5)
	s = append(s, "&manager.JoinResponse{")
	if this.Members != nil {
...
func (this *LeaveRequest) GoString() string {
	...
	s := make([]string, 0, 5)
	s = append(s, "&manager.LeaveRequest{")
	if this.Node != nil {
		s = append(s, "Node: "+fmt.Sprintf("%#v", this.Node)+",\n")
	}
	s = append(s, "}")
...
func (this *LeaveResponse) GoString() string {
	...
	s := make([]string, 0, 4)
	s = append(s, "&manager.LeaveResponse{")
	s = append(s, "}")
	return strings.Join(s, "")
}
func (this *ProcessRaftMessageRequest) GoString() string {
	...
	s := make([]string, 0, 5)
	s = append(s, "&manager.ProcessRaftMessageRequest{")
	if this.Msg != nil {
...
func (this *ProcessRaftMessageResponse) GoString() string {
	...
	s := make([]string, 0, 4)
	s = append(s, "&manager.ProcessRaftMessageResponse{")
	s = append(s, "}")
	return strings.Join(s, "")
}
...
func (this *NodeCountRequest) GoString() string {
	...
	s := make([]string, 0, 4)
	s = append(s, "&manager.NodeCountRequest{")
	s = append(s, "}")
	return strings.Join(s, "")
}
func (this *NodeCountResponse) GoString() string {
	...
	s := make([]string, 0, 5)
	s = append(s, "&manager.NodeCountResponse{")
...
func (c *raftClient) Join(ctx context.Context, in *JoinRequest, opts ...grpc.CallOption) (*JoinResponse, error) {
	...
	err := grpc.Invoke(ctx, "/docker.cluster.api.manager.Raft/Join", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *raftClient) Leave(ctx context.Context, in *LeaveRequest, opts ...grpc.CallOption) (*LeaveResponse, error) {
	...
	err := grpc.Invoke(ctx, "/docker.cluster.api.manager.Raft/Leave", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *raftClient) ProcessRaftMessage(ctx context.Context, in *ProcessRaftMessageRequest, opts ...grpc.CallOption) (*ProcessRaftMessageResponse, error) {
	...
	err := grpc.Invoke(ctx, "/docker.cluster.api.manager.Raft/ProcessRaftMessage", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var _Raft_serviceDesc = grpc.ServiceDesc{
	ServiceName: "docker.cluster.api.manager.Raft",
...
func (c *managerClient) NodeCount(ctx context.Context, in *NodeCountRequest, opts ...grpc.CallOption) (*NodeCountResponse, error) {
	...
	err := grpc.Invoke(ctx, "/docker.cluster.api.manager.Manager/NodeCount", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var _Manager_serviceDesc = grpc.ServiceDesc{
	ServiceName: "docker.cluster.api.manager.Manager",
...
var fileDescriptorManager = []byte{
	...
	,
}
