...
type NodeSpec struct {
	...
	// node.
	Availability NodeSpec_Availability `protobuf:"varint,2,opt,name=availability,proto3,enum=docker.cluster.specs.NodeSpec_Availability" json:"availability,omitempty"`
}
...
type TaskSpec_Container struct {
	Container *docker_cluster_types.Container `protobuf:"bytes,1,opt,name=container,oneof"`
}
...
func (m *TaskSpec) GetContainer() *docker_cluster_types.Container {
...
func _TaskSpec_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	...
	case 1: // runtime.container
		...
		msg := new(docker_cluster_types.Container)
		err := b.DecodeMessage(msg)
...
type VolumeSpec struct {
	...
	DriverConfiguration *docker_cluster_types.Driver `protobuf:"bytes,2,opt,name=driver_configuration,json=driverConfiguration" json:"driver_configuration,omitempty"`
}
...
func init() {
	proto.RegisterType((*Meta)(nil), "docker.cluster.specs.Meta")
	proto.RegisterType((*NodeSpec)(nil), "docker.cluster.specs.NodeSpec")
	proto.RegisterType((*JobSpec)(nil), "docker.cluster.specs.JobSpec")
	proto.RegisterType((*JobSpec_ServiceJob)(nil), "docker.cluster.specs.JobSpec.ServiceJob")
	proto.RegisterType((*JobSpec_BatchJob)(nil), "docker.cluster.specs.JobSpec.BatchJob")
	proto.RegisterType((*JobSpec_GlobalJob)(nil), "docker.cluster.specs.JobSpec.GlobalJob")
	proto.RegisterType((*JobSpec_CronJob)(nil), "docker.cluster.specs.JobSpec.CronJob")
	proto.RegisterType((*TaskSpec)(nil), "docker.cluster.specs.TaskSpec")
	proto.RegisterType((*VolumeSpec)(nil), "docker.cluster.specs.VolumeSpec")
	proto.RegisterType((*NetworkSpec)(nil), "docker.cluster.specs.NetworkSpec")
	proto.RegisterEnum("docker.cluster.specs.NodeSpec_Availability", NodeSpec_Availability_name, NodeSpec_Availability_value)
}
...
func (this *JobSpec_Service) GoString() string {
	...
	s := strings.Join([]string{`&specs.JobSpec_Service{` +
...
func (this *JobSpec_Batch) GoString() string {
	...
	s := strings.Join([]string{`&specs.JobSpec_Batch{` +
...
func (this *JobSpec_Global) GoString() string {
	...
	s := strings.Join([]string{`&specs.JobSpec_Global{` +
...
func (this *JobSpec_Cron) GoString() string {
	...
	s := strings.Join([]string{`&specs.JobSpec_Cron{` +
...
func (this *JobSpec_ServiceJob) GoString() string {
	...
	s := make([]string, 0, 5)
	s = append(s, "&specs.JobSpec_ServiceJob{")
...
func (this *JobSpec_BatchJob) GoString() string {
	...
	s := make([]string, 0, 6)
	s = append(s, "&specs.JobSpec_BatchJob{")
...
func (this *JobSpec_GlobalJob) GoString() string {
	...
	s := make([]string, 0, 4)
	s = append(s, "&specs.JobSpec_GlobalJob{")
	s = append(s, "}")
	return strings.Join(s, "")
}
func (this *JobSpec_CronJob) GoString() string {
	...
	s := make([]string, 0, 4)
	s = append(s, "&specs.JobSpec_CronJob{")
	s = append(s, "}")
	return strings.Join(s, "")
}
...
func (this *TaskSpec_Container) GoString() string {
	...
	s := strings.Join([]string{`&specs.TaskSpec_Container{` +
...
func (this *TaskSpec_Container) String() string {
	...
	s := strings.Join([]string{`&TaskSpec_Container{`,
		`Container:` + strings.Replace(fmt.Sprintf("%v", this.Container), "Container", "docker_cluster_types.Container", 1) + `,`,
		`}`,
	}, "")
	return s
}
func (this *VolumeSpec) String() string {
	...
	s := strings.Join([]string{`&VolumeSpec{`,
		`Meta:` + strings.Replace(strings.Replace(this.Meta.String(), "Meta", "Meta", 1), `&`, ``, 1) + `,`,
		`DriverConfiguration:` + strings.Replace(fmt.Sprintf("%v", this.DriverConfiguration), "Driver", "docker_cluster_types.Driver", 1) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *TaskSpec) Unmarshal(data []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			v := &docker_cluster_types.Container{}
			if err := v.Unmarshal(data[iNdEx:postIndex]); err != nil {
				return err
			}
...
func (m *VolumeSpec) Unmarshal(data []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			if m.DriverConfiguration == nil {
				m.DriverConfiguration = &docker_cluster_types.Driver{}
			}
...
var fileDescriptorSpecs = []byte{
	...
	,
}
