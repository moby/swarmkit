...
func TestBasicScalarEqual(t *testing.T) {
	...
	out = NewPopulatedBasicScalar(popr, true)
	if in.Equal(out) {
		t.Fatalf("%#v == %#v", in, out)
	}
	...
	res := in.Equal(out)
	if res != false {
		t.Fatalf("comparing against nil (method receiver) should return false, returned: %#v", res)
	}
	res = out.Equal(in)
	if res != false {
		t.Fatalf("comparing against nil (method argument) should return false, returned: %#v", res)
	}
}

func TestRepeatedScalarEqual(t *testing.T) {
	popr := math_rand.New(math_rand.NewSource(time.Now().UnixNano()))
	...
	out = NewPopulatedRepeatedScalar(popr, true)
	if in.Equal(out) {
		t.Fatalf("%#v == %#v", in, out)
	}
...
func TestRepeatedScalarPackedEqual(t *testing.T) {
	popr := math_rand.New(math_rand.NewSource(time.Now().UnixNano()))
	...
	out = NewPopulatedRepeatedScalarPacked(popr, true)
	if in.Equal(out) {
		t.Fatalf("%#v == %#v", in, out)
	}
...
func TestExternalStructEqual(t *testing.T) {
	popr := math_rand.New(math_rand.NewSource(time.Now().UnixNano()))
	...
	out = NewPopulatedExternalStruct(popr, true)
	if in.Equal(out) {
		t.Fatalf("%#v == %#v", in, out)
	}
...
func TestRepeatedExternalStructEqual(t *testing.T) {
	popr := math_rand.New(math_rand.NewSource(time.Now().UnixNano()))
	...
	out = NewPopulatedRepeatedExternalStruct(popr, true)
	if in.Equal(out) {
		t.Fatalf("%#v == %#v", in, out)
	}
...
func TestNonNullableExternalStructEqual(t *testing.T) {
	popr := math_rand.New(math_rand.NewSource(time.Now().UnixNano()))
	...
	out = NewPopulatedNonNullableExternalStruct(popr, true)
	if in.Equal(out) {
		t.Fatalf("%#v == %#v", in, out)
	}
...
func TestRepeatedNonNullableExternalStructEqual(t *testing.T) {
	popr := math_rand.New(math_rand.NewSource(time.Now().UnixNano()))
	...
	out = NewPopulatedRepeatedNonNullableExternalStruct(popr, true)
	if in.Equal(out) {
		t.Fatalf("%#v == %#v", in, out)
	}
...
func TestMapStructEqual(t *testing.T) {
	popr := math_rand.New(math_rand.NewSource(time.Now().UnixNano()))
	...
	out = NewPopulatedMapStruct(popr, true)
	if in.Equal(out) {
		t.Fatalf("%#v == %#v", in, out)
	}
...
func TestOneOfEqual(t *testing.T) {
	popr := math_rand.New(math_rand.NewSource(time.Now().UnixNano()))
	...
	out = NewPopulatedOneOf(popr, true)
	if in.Equal(out) {
		t.Fatalf("%#v == %#v", in, out)
	}
