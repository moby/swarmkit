...
func (*BasicScalar) Descriptor() ([]byte, []int) {
	return fileDescriptor_deepcopy_86eae08a6a682c89, []int{0}
}
...
func (dst *BasicScalar) XXX_Merge(src proto.Message) {
	xxx_messageInfo_BasicScalar.Merge(dst, src)
}
...
func (*RepeatedScalar) Descriptor() ([]byte, []int) {
	return fileDescriptor_deepcopy_86eae08a6a682c89, []int{1}
}
...
func (dst *RepeatedScalar) XXX_Merge(src proto.Message) {
	xxx_messageInfo_RepeatedScalar.Merge(dst, src)
}
...
func (*RepeatedScalarPacked) Descriptor() ([]byte, []int) {
	return fileDescriptor_deepcopy_86eae08a6a682c89, []int{2}
}
...
func (dst *RepeatedScalarPacked) XXX_Merge(src proto.Message) {
	xxx_messageInfo_RepeatedScalarPacked.Merge(dst, src)
}
...
func (*ExternalStruct) Descriptor() ([]byte, []int) {
	return fileDescriptor_deepcopy_86eae08a6a682c89, []int{3}
}
...
func (dst *ExternalStruct) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ExternalStruct.Merge(dst, src)
}
...
func (*RepeatedExternalStruct) Descriptor() ([]byte, []int) {
	return fileDescriptor_deepcopy_86eae08a6a682c89, []int{4}
}
...
func (dst *RepeatedExternalStruct) XXX_Merge(src proto.Message) {
	xxx_messageInfo_RepeatedExternalStruct.Merge(dst, src)
}
...
func (*NonNullableExternalStruct) Descriptor() ([]byte, []int) {
	return fileDescriptor_deepcopy_86eae08a6a682c89, []int{5}
}
...
func (dst *NonNullableExternalStruct) XXX_Merge(src proto.Message) {
	xxx_messageInfo_NonNullableExternalStruct.Merge(dst, src)
}
...
func (*RepeatedNonNullableExternalStruct) Descriptor() ([]byte, []int) {
	return fileDescriptor_deepcopy_86eae08a6a682c89, []int{6}
}
...
func (dst *RepeatedNonNullableExternalStruct) XXX_Merge(src proto.Message) {
	xxx_messageInfo_RepeatedNonNullableExternalStruct.Merge(dst, src)
}
...
func (*MapStruct) Descriptor() ([]byte, []int) {
	return fileDescriptor_deepcopy_86eae08a6a682c89, []int{7}
}
...
func (dst *MapStruct) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MapStruct.Merge(dst, src)
}
...
func (*OneOf) Descriptor() ([]byte, []int) {
	return fileDescriptor_deepcopy_86eae08a6a682c89, []int{8}
}
...
func NewPopulatedBasicScalar(r randyDeepcopy, easy bool) *BasicScalar {
	...
	if !easy && r.Intn(10) != 0 {
		this.XXX_unrecognized = randUnrecognizedDeepcopy(r, 16)
	}
	return this
}
...
func NewPopulatedRepeatedScalarPacked(r randyDeepcopy, easy bool) *RepeatedScalarPacked {
	...
	if !easy && r.Intn(10) != 0 {
		this.XXX_unrecognized = randUnrecognizedDeepcopy(r, 14)
	}
	return this
}
...
func NewPopulatedExternalStruct(r randyDeepcopy, easy bool) *ExternalStruct {
	...
	if !easy && r.Intn(10) != 0 {
		this.XXX_unrecognized = randUnrecognizedDeepcopy(r, 4)
	}
	return this
}
...
func NewPopulatedMapStruct(r randyDeepcopy, easy bool) *MapStruct {
	...
	if !easy && r.Intn(10) != 0 {
		this.XXX_unrecognized = randUnrecognizedDeepcopy(r, 3)
	}
	return this
}
...
func NewPopulatedOneOf(r randyDeepcopy, easy bool) *OneOf {
	...
	if !easy && r.Intn(10) != 0 {
		this.XXX_unrecognized = randUnrecognizedDeepcopy(r, 12)
	}
	return this
}
...
func init() {
	proto.RegisterFile("github.com/docker/swarmkit/protobuf/plugin/deepcopy/test/deepcopy.proto", fileDescriptor_deepcopy_86eae08a6a682c89)
}

var fileDescriptor_deepcopy_86eae08a6a682c89 = []byte{
