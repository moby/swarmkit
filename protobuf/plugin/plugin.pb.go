...
func (*WatchSelectors) Descriptor() ([]byte, []int) {
	return fileDescriptor_plugin_9f673da91b3e31a8, []int{0}
}
...
func (dst *WatchSelectors) XXX_Merge(src proto.Message) {
	xxx_messageInfo_WatchSelectors.Merge(dst, src)
}
...
func (*StoreObject) Descriptor() ([]byte, []int) {
	return fileDescriptor_plugin_9f673da91b3e31a8, []int{1}
}
...
func (dst *StoreObject) XXX_Merge(src proto.Message) {
	xxx_messageInfo_StoreObject.Merge(dst, src)
}
...
func (*TLSAuthorization) Descriptor() ([]byte, []int) {
	return fileDescriptor_plugin_9f673da91b3e31a8, []int{2}
}
...
func (dst *TLSAuthorization) XXX_Merge(src proto.Message) {
	xxx_messageInfo_TLSAuthorization.Merge(dst, src)
}
...
func init() {
	proto.RegisterFile("github.com/docker/swarmkit/protobuf/plugin/plugin.proto", fileDescriptor_plugin_9f673da91b3e31a8)
}

var fileDescriptor_plugin_9f673da91b3e31a8 = []byte{
