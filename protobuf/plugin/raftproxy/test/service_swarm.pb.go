...
func (m *Point) CopyFrom(src any) {
	proto.Reset(m)
	proto.Merge(m, src.(*Point))
}
...
func (m *Rectangle) CopyFrom(src any) {
	proto.Reset(m)
	proto.Merge(m, src.(*Rectangle))
}
...
func (m *Feature) CopyFrom(src any) {
	proto.Reset(m)
	proto.Merge(m, src.(*Feature))
}
...
func (m *RouteNote) CopyFrom(src any) {
	proto.Reset(m)
	proto.Merge(m, src.(*RouteNote))
}
...
func (m *RouteSummary) CopyFrom(src any) {
	proto.Reset(m)
	proto.Merge(m, src.(*RouteSummary))
}
...
func (p *raftProxyRouteGuideServer) mustEmbedUnimplementedRouteGuideServer() {}
...
func (p *authenticatedWrapperRouteGuideServer) mustEmbedUnimplementedRouteGuideServer() {}
